...
func NewQIcon2(pixmap *QPixmap) *QIcon {
	g := newQIcon(QIcon_new2(pixmap.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQIcon3(other *QIcon) *QIcon {
	g := newQIcon(QIcon_new3(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQIcon4(fileName string) *QIcon {
	...
	g := newQIcon(QIcon_new4(fileName_ms))
	g.isSubclass = true
	return g
}
...
func NewQIcon5(engine *QIconEngine) *QIcon {
	g := newQIcon(QIcon_new5(engine.cPointer()))
	g.isSubclass = true
	return g
}
