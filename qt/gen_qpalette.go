...
func NewQPalette2(button *QColor) *QPalette {
	g := newQPalette(QPalette_new2(button.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPalette3(button GlobalColor) *QPalette {
	g := newQPalette(QPalette_new3((int)(button)))
	g.isSubclass = true
	return g
}
...
func NewQPalette4(button *QColor, window *QColor) *QPalette {
	g := newQPalette(QPalette_new4(button.cPointer(), window.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPalette5(windowText *QBrush, button *QBrush, light *QBrush, dark *QBrush, mid *QBrush, text *QBrush, bright_text *QBrush, base *QBrush, window *QBrush) *QPalette {
	g := newQPalette(QPalette_new5(windowText.cPointer(), button.cPointer(), light.cPointer(), dark.cPointer(), mid.cPointer(), text.cPointer(), bright_text.cPointer(), base.cPointer(), window.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPalette6(windowText *QColor, window *QColor, light *QColor, dark *QColor, mid *QColor, text *QColor, base *QColor) *QPalette {
	g := newQPalette(QPalette_new6(windowText.cPointer(), window.cPointer(), light.cPointer(), dark.cPointer(), mid.cPointer(), text.cPointer(), base.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPalette7(palette *QPalette) *QPalette {
	g := newQPalette(QPalette_new7(palette.cPointer()))
	g.isSubclass = true
	return g
}
