...
func NewQGraphicsEffect() *QGraphicsEffect {
	g := newQGraphicsEffect(QGraphicsEffect_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsEffect2(parent *QObject) *QGraphicsEffect {
	g := newQGraphicsEffect(QGraphicsEffect_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsColorizeEffect() *QGraphicsColorizeEffect {
	g := newQGraphicsColorizeEffect(QGraphicsColorizeEffect_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsColorizeEffect2(parent *QObject) *QGraphicsColorizeEffect {
	g := newQGraphicsColorizeEffect(QGraphicsColorizeEffect_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsBlurEffect() *QGraphicsBlurEffect {
	g := newQGraphicsBlurEffect(QGraphicsBlurEffect_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsBlurEffect2(parent *QObject) *QGraphicsBlurEffect {
	g := newQGraphicsBlurEffect(QGraphicsBlurEffect_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsDropShadowEffect() *QGraphicsDropShadowEffect {
	g := newQGraphicsDropShadowEffect(QGraphicsDropShadowEffect_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsDropShadowEffect2(parent *QObject) *QGraphicsDropShadowEffect {
	g := newQGraphicsDropShadowEffect(QGraphicsDropShadowEffect_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsOpacityEffect() *QGraphicsOpacityEffect {
	g := newQGraphicsOpacityEffect(QGraphicsOpacityEffect_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsOpacityEffect2(parent *QObject) *QGraphicsOpacityEffect {
	g := newQGraphicsOpacityEffect(QGraphicsOpacityEffect_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
