...
func NewQTreeWidgetItemIterator(it *QTreeWidgetItemIterator) *QTreeWidgetItemIterator {
	g := newQTreeWidgetItemIterator(QTreeWidgetItemIterator_new(it.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItemIterator2(widget *QTreeWidget) *QTreeWidgetItemIterator {
	g := newQTreeWidgetItemIterator(QTreeWidgetItemIterator_new2(widget.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItemIterator3(item *QTreeWidgetItem) *QTreeWidgetItemIterator {
	g := newQTreeWidgetItemIterator(QTreeWidgetItemIterator_new3(item.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItemIterator4(widget *QTreeWidget, flags IteratorFlags) *QTreeWidgetItemIterator {
	g := newQTreeWidgetItemIterator(QTreeWidgetItemIterator_new4(widget.cPointer(), flags))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItemIterator5(item *QTreeWidgetItem, flags IteratorFlags) *QTreeWidgetItemIterator {
	g := newQTreeWidgetItemIterator(QTreeWidgetItemIterator_new5(item.cPointer(), flags))
	g.isSubclass = true
	return g
}
