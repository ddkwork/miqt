...
func NewQAbstractEventDispatcherV2() *QAbstractEventDispatcherV2 {
	g := newQAbstractEventDispatcherV2(QAbstractEventDispatcherV2_new())
	g.isSubclass = true
	return g
}
...
func NewQAbstractEventDispatcherV22(parent *QObject) *QAbstractEventDispatcherV2 {
	g := newQAbstractEventDispatcherV2(QAbstractEventDispatcherV2_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQAbstractEventDispatcher__TimerInfo(id int, i int, t TimerType) *QAbstractEventDispatcher__TimerInfo {
	g := newQAbstractEventDispatcher__TimerInfo(QAbstractEventDispatcher__TimerInfo_new((int)(id), (int)(i), (int)(t)))
	g.isSubclass = true
	return g
}
...
func NewQAbstractEventDispatcher__TimerInfo2(param1 *TimerInfo) *QAbstractEventDispatcher__TimerInfo {
	g := newQAbstractEventDispatcher__TimerInfo(QAbstractEventDispatcher__TimerInfo_new2(param1))
	g.isSubclass = true
	return g
}
...
func NewQAbstractEventDispatcher__TimerInfoV2() *QAbstractEventDispatcher__TimerInfoV2 {
	g := newQAbstractEventDispatcher__TimerInfoV2(QAbstractEventDispatcher__TimerInfoV2_new())
	g.isSubclass = true
	return g
}
...
func NewQAbstractEventDispatcher__TimerInfoV22(param1 *TimerInfoV2) *QAbstractEventDispatcher__TimerInfoV2 {
	g := newQAbstractEventDispatcher__TimerInfoV2(QAbstractEventDispatcher__TimerInfoV2_new2(param1))
	g.isSubclass = true
	return g
}
