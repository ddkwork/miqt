...
func NewQRegularExpression() *QRegularExpression {
	g := newQRegularExpression(QRegularExpression_new())
	g.isSubclass = true
	return g
}
...
func NewQRegularExpression2(pattern string) *QRegularExpression {
	...
	g := newQRegularExpression(QRegularExpression_new2(pattern_ms))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpression3(re *QRegularExpression) *QRegularExpression {
	g := newQRegularExpression(QRegularExpression_new3(re.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpression4(pattern string, options PatternOptions) *QRegularExpression {
	...
	pattern_ms.len = size_t(len(pattern))
	defer free(unsafe.Pointer(pattern_ms.data))
	g := newQRegularExpression(QRegularExpression_new4(pattern_ms, options))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionMatch() *QRegularExpressionMatch {
	g := newQRegularExpressionMatch(QRegularExpressionMatch_new())
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionMatch2(match *QRegularExpressionMatch) *QRegularExpressionMatch {
	g := newQRegularExpressionMatch(QRegularExpressionMatch_new2(match.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionMatchIterator() *QRegularExpressionMatchIterator {
	g := newQRegularExpressionMatchIterator(QRegularExpressionMatchIterator_new())
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionMatchIterator2(iterator *QRegularExpressionMatchIterator) *QRegularExpressionMatchIterator {
	g := newQRegularExpressionMatchIterator(QRegularExpressionMatchIterator_new2(iterator.cPointer()))
	g.isSubclass = true
	return g
}
