...
func NewQSystemSemaphore(key *QNativeIpcKey) *QSystemSemaphore {
	g := newQSystemSemaphore(QSystemSemaphore_new(key.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSystemSemaphore2(key string) *QSystemSemaphore {
	...
	g := newQSystemSemaphore(QSystemSemaphore_new2(key_ms))
	g.isSubclass = true
	return g
}
...
func NewQSystemSemaphore3(key *QNativeIpcKey, initialValue int) *QSystemSemaphore {
	g := newQSystemSemaphore(QSystemSemaphore_new3(key.cPointer(), (int)(initialValue)))
	g.isSubclass = true
	return g
}
...
func NewQSystemSemaphore4(key *QNativeIpcKey, initialValue int, param3 AccessMode) *QSystemSemaphore {
	g := newQSystemSemaphore(QSystemSemaphore_new4(key.cPointer(), (int)(initialValue), param3))
	g.isSubclass = true
	return g
}
...
func NewQSystemSemaphore5(key string, initialValue int) *QSystemSemaphore {
	...
	key_ms.len = size_t(len(key))
	defer free(unsafe.Pointer(key_ms.data))
	g := newQSystemSemaphore(QSystemSemaphore_new5(key_ms, (int)(initialValue)))
	g.isSubclass = true
	return g
}
...
func NewQSystemSemaphore6(key string, initialValue int, mode AccessMode) *QSystemSemaphore {
	...
	key_ms.len = size_t(len(key))
	defer free(unsafe.Pointer(key_ms.data))
	g := newQSystemSemaphore(QSystemSemaphore_new6(key_ms, (int)(initialValue), mode))
	g.isSubclass = true
	return g
}
