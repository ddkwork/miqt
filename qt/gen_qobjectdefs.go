...
func NewQGenericArgument3(aName string) *QGenericArgument {
	...
	ret := newQGenericArgument(QGenericArgument_new3(aName_Cstring))
	ret.isSubclass = true
	return ret
}
...
func NewQGenericArgument4(aName string, aData unsafe.Pointer) *QGenericArgument {
	...
	ret := newQGenericArgument(QGenericArgument_new4(aName_Cstring, aData))
	ret.isSubclass = true
	return ret
}
...
func NewQGenericReturnArgument3(aName string) *QGenericReturnArgument {
	...
	ret := newQGenericReturnArgument(QGenericReturnArgument_new3(aName_Cstring))
	ret.isSubclass = true
	return ret
}
...
func NewQGenericReturnArgument4(aName string, aData unsafe.Pointer) *QGenericReturnArgument {
	...
	ret := newQGenericReturnArgument(QGenericReturnArgument_new4(aName_Cstring, aData))
	ret.isSubclass = true
	return ret
}
