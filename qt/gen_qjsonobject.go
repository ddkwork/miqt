...
func NewQJsonObject() *QJsonObject {
	g := newQJsonObject(QJsonObject_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonObject2(other *QJsonObject) *QJsonObject {
	g := newQJsonObject(QJsonObject_new2(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__iterator() *QJsonObject__iterator {
	g := newQJsonObject__iterator(QJsonObject__iterator_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__iterator2(obj *QJsonObject, index int64) *QJsonObject__iterator {
	g := newQJsonObject__iterator(QJsonObject__iterator_new2(obj.cPointer(), (ptrdiff_t)(index)))
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__iterator3(other *iterator) *QJsonObject__iterator {
	g := newQJsonObject__iterator(QJsonObject__iterator_new3(other))
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__const_iterator() *QJsonObject__const_iterator {
	g := newQJsonObject__const_iterator(QJsonObject__const_iterator_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__const_iterator2(obj *QJsonObject, index int64) *QJsonObject__const_iterator {
	g := newQJsonObject__const_iterator(QJsonObject__const_iterator_new2(obj.cPointer(), (ptrdiff_t)(index)))
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__const_iterator3(other *iterator) *QJsonObject__const_iterator {
	g := newQJsonObject__const_iterator(QJsonObject__const_iterator_new3(other))
	g.isSubclass = true
	return g
}
...
func NewQJsonObject__const_iterator4(other *const_iterator) *QJsonObject__const_iterator {
	g := newQJsonObject__const_iterator(QJsonObject__const_iterator_new4(other))
	g.isSubclass = true
	return g
}
