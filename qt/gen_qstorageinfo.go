...
func NewQStorageInfo() *QStorageInfo {
	g := newQStorageInfo(QStorageInfo_new())
	g.isSubclass = true
	return g
}
...
func NewQStorageInfo2(path string) *QStorageInfo {
	...
	g := newQStorageInfo(QStorageInfo_new2(path_ms))
	g.isSubclass = true
	return g
}
...
func NewQStorageInfo3(dir *QDir) *QStorageInfo {
	g := newQStorageInfo(QStorageInfo_new3(dir.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQStorageInfo4(other *QStorageInfo) *QStorageInfo {
	g := newQStorageInfo(QStorageInfo_new4(other.cPointer()))
	g.isSubclass = true
	return g
}
