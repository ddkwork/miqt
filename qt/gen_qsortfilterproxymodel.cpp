...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QSortFilterProxyModel_MetaObject(const_cast<MiqtVirtualQSortFilterProxyModel*>(this), handle__MetaObject);
...
void QSortFilterProxyModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQSortFilterProxyModel*>( (QSortFilterProxyModel*)(self) )->handle__MetaObject = slot;
}
...
void QSortFilterProxyModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQSortFilterProxyModel*>( (QSortFilterProxyModel*)(self) )->handle__Metacast = slot;
}
