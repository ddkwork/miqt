...
func NewQPainterPath() *QPainterPath {
	g := newQPainterPath(QPainterPath_new())
	g.isSubclass = true
	return g
}
...
func NewQPainterPath2(startPoint *QPointF) *QPainterPath {
	g := newQPainterPath(QPainterPath_new2(startPoint.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPainterPath3(other *QPainterPath) *QPainterPath {
	g := newQPainterPath(QPainterPath_new3(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPainterPathStroker() *QPainterPathStroker {
	g := newQPainterPathStroker(QPainterPathStroker_new())
	g.isSubclass = true
	return g
}
...
func NewQPainterPathStroker2(pen *QPen) *QPainterPathStroker {
	g := newQPainterPathStroker(QPainterPathStroker_new2(pen.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPainterPath__Element() *QPainterPath__Element {
	g := newQPainterPath__Element(QPainterPath__Element_new())
	g.isSubclass = true
	return g
}
...
func NewQPainterPath__Element2(param1 *Element) *QPainterPath__Element {
	g := newQPainterPath__Element(QPainterPath__Element_new2(param1))
	g.isSubclass = true
	return g
}
