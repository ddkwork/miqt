...
func (this *QSortFilterProxyModel) callVirtualBase_SetSourceModel(sourceModel *QAbstractItemModel) {
	...
	QSortFilterProxyModel_virtualbase_SetSourceModel(unsafe.Pointer(this.h), sourceModel.cPointer())
...
func (this *QSortFilterProxyModel) OnSetSourceModel(slot func(super func(sourceModel *QAbstractItemModel), sourceModel *QAbstractItemModel)) {
	...
	QSortFilterProxyModel_override_virtual_SetSourceModel(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_SetSourceModel
func miqt_exec_callback_QSortFilterProxyModel_SetSourceModel(self QSortFilterProxyModel, cb intptr_t, sourceModel *QAbstractItemModel) {
...
func (this *QSortFilterProxyModel) callVirtualBase_MapToSource(proxyIndex *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QSortFilterProxyModel_virtualbase_MapToSource(unsafe.Pointer(this.h), proxyIndex.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnMapToSource(slot func(super func(proxyIndex *QModelIndex) *QModelIndex, proxyIndex *QModelIndex) *QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_MapToSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_MapToSource
func miqt_exec_callback_QSortFilterProxyModel_MapToSource(self QSortFilterProxyModel, cb intptr_t, proxyIndex *QModelIndex) *QModelIndex {
...
func (this *QSortFilterProxyModel) callVirtualBase_MapFromSource(sourceIndex *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QSortFilterProxyModel_virtualbase_MapFromSource(unsafe.Pointer(this.h), sourceIndex.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnMapFromSource(slot func(super func(sourceIndex *QModelIndex) *QModelIndex, sourceIndex *QModelIndex) *QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_MapFromSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_MapFromSource
func miqt_exec_callback_QSortFilterProxyModel_MapFromSource(self QSortFilterProxyModel, cb intptr_t, sourceIndex *QModelIndex) *QModelIndex {
...
func (this *QSortFilterProxyModel) callVirtualBase_MapSelectionToSource(proxySelection *QItemSelection) *QItemSelection {
	...
	_goptr := newQItemSelection(QSortFilterProxyModel_virtualbase_MapSelectionToSource(unsafe.Pointer(this.h), proxySelection.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnMapSelectionToSource(slot func(super func(proxySelection *QItemSelection) *QItemSelection, proxySelection *QItemSelection) *QItemSelection) {
	...
	QSortFilterProxyModel_override_virtual_MapSelectionToSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_MapSelectionToSource
func miqt_exec_callback_QSortFilterProxyModel_MapSelectionToSource(self QSortFilterProxyModel, cb intptr_t, proxySelection *QItemSelection) *QItemSelection {
...
func (this *QSortFilterProxyModel) callVirtualBase_MapSelectionFromSource(sourceSelection *QItemSelection) *QItemSelection {
	...
	_goptr := newQItemSelection(QSortFilterProxyModel_virtualbase_MapSelectionFromSource(unsafe.Pointer(this.h), sourceSelection.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnMapSelectionFromSource(slot func(super func(sourceSelection *QItemSelection) *QItemSelection, sourceSelection *QItemSelection) *QItemSelection) {
	...
	QSortFilterProxyModel_override_virtual_MapSelectionFromSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_MapSelectionFromSource
func miqt_exec_callback_QSortFilterProxyModel_MapSelectionFromSource(self QSortFilterProxyModel, cb intptr_t, sourceSelection *QItemSelection) *QItemSelection {
...
func (this *QSortFilterProxyModel) callVirtualBase_FilterAcceptsRow(source_row int, source_parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_FilterAcceptsRow(unsafe.Pointer(this.h), (int)(source_row), source_parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnFilterAcceptsRow(slot func(super func(source_row int, source_parent *QModelIndex) bool, source_row int, source_parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_FilterAcceptsRow(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_FilterAcceptsRow
func miqt_exec_callback_QSortFilterProxyModel_FilterAcceptsRow(self QSortFilterProxyModel, cb intptr_t, source_row int, source_parent *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_FilterAcceptsColumn(source_column int, source_parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_FilterAcceptsColumn(unsafe.Pointer(this.h), (int)(source_column), source_parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnFilterAcceptsColumn(slot func(super func(source_column int, source_parent *QModelIndex) bool, source_column int, source_parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_FilterAcceptsColumn(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_FilterAcceptsColumn
func miqt_exec_callback_QSortFilterProxyModel_FilterAcceptsColumn(self QSortFilterProxyModel, cb intptr_t, source_column int, source_parent *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_LessThan(source_left *QModelIndex, source_right *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_LessThan(unsafe.Pointer(this.h), source_left.cPointer(), source_right.cPointer()))
...
func (this *QSortFilterProxyModel) OnLessThan(slot func(super func(source_left *QModelIndex, source_right *QModelIndex) bool, source_left *QModelIndex, source_right *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_LessThan(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_LessThan
func miqt_exec_callback_QSortFilterProxyModel_LessThan(self QSortFilterProxyModel, cb intptr_t, source_left *QModelIndex, source_right *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_Index(row int, column int, parent *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QSortFilterProxyModel_virtualbase_Index(unsafe.Pointer(this.h), (int)(row), (int)(column), parent.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnIndex(slot func(super func(row int, column int, parent *QModelIndex) *QModelIndex, row int, column int, parent *QModelIndex) *QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_Index(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Index
func miqt_exec_callback_QSortFilterProxyModel_Index(self QSortFilterProxyModel, cb intptr_t, row int, column int, parent *QModelIndex) *QModelIndex {
...
func (this *QSortFilterProxyModel) callVirtualBase_Parent(child *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QSortFilterProxyModel_virtualbase_Parent(unsafe.Pointer(this.h), child.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnParent(slot func(super func(child *QModelIndex) *QModelIndex, child *QModelIndex) *QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_Parent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Parent
func miqt_exec_callback_QSortFilterProxyModel_Parent(self QSortFilterProxyModel, cb intptr_t, child *QModelIndex) *QModelIndex {
...
func (this *QSortFilterProxyModel) callVirtualBase_Sibling(row int, column int, idx *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QSortFilterProxyModel_virtualbase_Sibling(unsafe.Pointer(this.h), (int)(row), (int)(column), idx.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnSibling(slot func(super func(row int, column int, idx *QModelIndex) *QModelIndex, row int, column int, idx *QModelIndex) *QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_Sibling(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Sibling
func miqt_exec_callback_QSortFilterProxyModel_Sibling(self QSortFilterProxyModel, cb intptr_t, row int, column int, idx *QModelIndex) *QModelIndex {
...
func (this *QSortFilterProxyModel) callVirtualBase_RowCount(parent *QModelIndex) int {
	...
	return (int)(QSortFilterProxyModel_virtualbase_RowCount(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnRowCount(slot func(super func(parent *QModelIndex) int, parent *QModelIndex) int) {
	...
	QSortFilterProxyModel_override_virtual_RowCount(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_RowCount
func miqt_exec_callback_QSortFilterProxyModel_RowCount(self QSortFilterProxyModel, cb intptr_t, parent *QModelIndex) int {
...
func (this *QSortFilterProxyModel) callVirtualBase_ColumnCount(parent *QModelIndex) int {
	...
	return (int)(QSortFilterProxyModel_virtualbase_ColumnCount(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnColumnCount(slot func(super func(parent *QModelIndex) int, parent *QModelIndex) int) {
	...
	QSortFilterProxyModel_override_virtual_ColumnCount(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_ColumnCount
func miqt_exec_callback_QSortFilterProxyModel_ColumnCount(self QSortFilterProxyModel, cb intptr_t, parent *QModelIndex) int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(parent *QModelIndex) int, parent *QModelIndex) int)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QSortFilterProxyModel) callVirtualBase_HasChildren(parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_HasChildren(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnHasChildren(slot func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_HasChildren(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_HasChildren
func miqt_exec_callback_QSortFilterProxyModel_HasChildren(self QSortFilterProxyModel, cb intptr_t, parent *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_Data(index *QModelIndex, role int) *QVariant {
	...
	_goptr := newQVariant(QSortFilterProxyModel_virtualbase_Data(unsafe.Pointer(this.h), index.cPointer(), (int)(role)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnData(slot func(super func(index *QModelIndex, role int) *QVariant, index *QModelIndex, role int) *QVariant) {
	...
	QSortFilterProxyModel_override_virtual_Data(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Data
func miqt_exec_callback_QSortFilterProxyModel_Data(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex, role int) *QVariant {
...
func (this *QSortFilterProxyModel) callVirtualBase_SetData(index *QModelIndex, value *QVariant, role int) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_SetData(unsafe.Pointer(this.h), index.cPointer(), value.cPointer(), (int)(role)))
...
func (this *QSortFilterProxyModel) OnSetData(slot func(super func(index *QModelIndex, value *QVariant, role int) bool, index *QModelIndex, value *QVariant, role int) bool) {
	...
	QSortFilterProxyModel_override_virtual_SetData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_SetData
func miqt_exec_callback_QSortFilterProxyModel_SetData(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex, value *QVariant, role int) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_HeaderData(section int, orientation Orientation, role int) *QVariant {
	...
	_goptr := newQVariant(QSortFilterProxyModel_virtualbase_HeaderData(unsafe.Pointer(this.h), (int)(section), (int)(orientation), (int)(role)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnHeaderData(slot func(super func(section int, orientation Orientation, role int) *QVariant, section int, orientation Orientation, role int) *QVariant) {
	...
	QSortFilterProxyModel_override_virtual_HeaderData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_HeaderData
func miqt_exec_callback_QSortFilterProxyModel_HeaderData(self QSortFilterProxyModel, cb intptr_t, section int, orientation int, role int) *QVariant {
...
func (this *QSortFilterProxyModel) callVirtualBase_SetHeaderData(section int, orientation Orientation, value *QVariant, role int) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_SetHeaderData(unsafe.Pointer(this.h), (int)(section), (int)(orientation), value.cPointer(), (int)(role)))
...
func (this *QSortFilterProxyModel) OnSetHeaderData(slot func(super func(section int, orientation Orientation, value *QVariant, role int) bool, section int, orientation Orientation, value *QVariant, role int) bool) {
	...
	QSortFilterProxyModel_override_virtual_SetHeaderData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_SetHeaderData
func miqt_exec_callback_QSortFilterProxyModel_SetHeaderData(self QSortFilterProxyModel, cb intptr_t, section int, orientation int, value *QVariant, role int) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_MimeData(indexes []QModelIndex) *QMimeData {
	...
	return newQMimeData(QSortFilterProxyModel_virtualbase_MimeData(unsafe.Pointer(this.h), indexes_ma))
...
func (this *QSortFilterProxyModel) OnMimeData(slot func(super func(indexes []QModelIndex) *QMimeData, indexes []QModelIndex) *QMimeData) {
	...
	QSortFilterProxyModel_override_virtual_MimeData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_MimeData
func miqt_exec_callback_QSortFilterProxyModel_MimeData(self QSortFilterProxyModel, cb intptr_t, indexes struct_miqt_array) *QMimeData {
...
func (this *QSortFilterProxyModel) callVirtualBase_DropMimeData(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_DropMimeData(unsafe.Pointer(this.h), data.cPointer(), (int)(action), (int)(row), (int)(column), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnDropMimeData(slot func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_DropMimeData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_DropMimeData
func miqt_exec_callback_QSortFilterProxyModel_DropMimeData(self QSortFilterProxyModel, cb intptr_t, data *QMimeData, action int, row int, column int, parent *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_InsertRows(row int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_InsertRows(unsafe.Pointer(this.h), (int)(row), (int)(count), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnInsertRows(slot func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_InsertRows(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_InsertRows
func miqt_exec_callback_QSortFilterProxyModel_InsertRows(self QSortFilterProxyModel, cb intptr_t, row int, count int, parent *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_InsertColumns(column int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_InsertColumns(unsafe.Pointer(this.h), (int)(column), (int)(count), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnInsertColumns(slot func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_InsertColumns(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_InsertColumns
func miqt_exec_callback_QSortFilterProxyModel_InsertColumns(self QSortFilterProxyModel, cb intptr_t, column int, count int, parent *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_RemoveRows(row int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_RemoveRows(unsafe.Pointer(this.h), (int)(row), (int)(count), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnRemoveRows(slot func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_RemoveRows(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_RemoveRows
func miqt_exec_callback_QSortFilterProxyModel_RemoveRows(self QSortFilterProxyModel, cb intptr_t, row int, count int, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QSortFilterProxyModel) callVirtualBase_RemoveColumns(column int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_RemoveColumns(unsafe.Pointer(this.h), (int)(column), (int)(count), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnRemoveColumns(slot func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_RemoveColumns(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_RemoveColumns
func miqt_exec_callback_QSortFilterProxyModel_RemoveColumns(self QSortFilterProxyModel, cb intptr_t, column int, count int, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QSortFilterProxyModel) callVirtualBase_FetchMore(parent *QModelIndex) {
	...
	QSortFilterProxyModel_virtualbase_FetchMore(unsafe.Pointer(this.h), parent.cPointer())
...
func (this *QSortFilterProxyModel) OnFetchMore(slot func(super func(parent *QModelIndex), parent *QModelIndex)) {
	...
	QSortFilterProxyModel_override_virtual_FetchMore(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_FetchMore
func miqt_exec_callback_QSortFilterProxyModel_FetchMore(self QSortFilterProxyModel, cb intptr_t, parent *QModelIndex) {
...
func (this *QSortFilterProxyModel) callVirtualBase_CanFetchMore(parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_CanFetchMore(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnCanFetchMore(slot func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_CanFetchMore(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_CanFetchMore
func miqt_exec_callback_QSortFilterProxyModel_CanFetchMore(self QSortFilterProxyModel, cb intptr_t, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QSortFilterProxyModel) callVirtualBase_Flags(index *QModelIndex) ItemFlag {
	...
	return (ItemFlag)(QSortFilterProxyModel_virtualbase_Flags(unsafe.Pointer(this.h), index.cPointer()))
...
func (this *QSortFilterProxyModel) OnFlags(slot func(super func(index *QModelIndex) ItemFlag, index *QModelIndex) ItemFlag) {
	...
	QSortFilterProxyModel_override_virtual_Flags(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Flags
func miqt_exec_callback_QSortFilterProxyModel_Flags(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex) int {
...
func (this *QSortFilterProxyModel) callVirtualBase_Buddy(index *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QSortFilterProxyModel_virtualbase_Buddy(unsafe.Pointer(this.h), index.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnBuddy(slot func(super func(index *QModelIndex) *QModelIndex, index *QModelIndex) *QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_Buddy(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Buddy
func miqt_exec_callback_QSortFilterProxyModel_Buddy(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex) *QModelIndex {
...
func (this *QSortFilterProxyModel) callVirtualBase_Match(start *QModelIndex, role int, value *QVariant, hits int, flags MatchFlag) []QModelIndex {
	...
	var _ma struct_miqt_array = QSortFilterProxyModel_virtualbase_Match(unsafe.Pointer(this.h), start.cPointer(), (int)(role), value.cPointer(), (int)(hits), (int)(flags))
	_ret := make([]QModelIndex, int(_ma.len))
	_outCast := (*[0xffff]*QModelIndex)(unsafe.Pointer(_ma.data)) // hey ya
	for i := 0; i < int(_ma.len); i++ {
		_lv_goptr := newQModelIndex(_outCast[i])
...
func (this *QSortFilterProxyModel) OnMatch(slot func(super func(start *QModelIndex, role int, value *QVariant, hits int, flags MatchFlag) []QModelIndex, start *QModelIndex, role int, value *QVariant, hits int, flags MatchFlag) []QModelIndex) {
	...
	QSortFilterProxyModel_override_virtual_Match(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Match
func miqt_exec_callback_QSortFilterProxyModel_Match(self QSortFilterProxyModel, cb intptr_t, start *QModelIndex, role int, value *QVariant, hits int, flags int) struct_miqt_array {
...
func (this *QSortFilterProxyModel) callVirtualBase_Span(index *QModelIndex) *QSize {
	...
	_goptr := newQSize(QSortFilterProxyModel_virtualbase_Span(unsafe.Pointer(this.h), index.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSortFilterProxyModel) OnSpan(slot func(super func(index *QModelIndex) *QSize, index *QModelIndex) *QSize) {
	...
	QSortFilterProxyModel_override_virtual_Span(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Span
func miqt_exec_callback_QSortFilterProxyModel_Span(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex) *QSize {
...
func (this *QSortFilterProxyModel) callVirtualBase_Sort(column int, order SortOrder) {
	...
	QSortFilterProxyModel_virtualbase_Sort(unsafe.Pointer(this.h), (int)(column), (int)(order))
...
func (this *QSortFilterProxyModel) OnSort(slot func(super func(column int, order SortOrder), column int, order SortOrder)) {
	...
	QSortFilterProxyModel_override_virtual_Sort(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Sort
func miqt_exec_callback_QSortFilterProxyModel_Sort(self QSortFilterProxyModel, cb intptr_t, column int, order int) {
...
func (this *QSortFilterProxyModel) callVirtualBase_MimeTypes() []string {
	...
	var _ma struct_miqt_array = QSortFilterProxyModel_virtualbase_MimeTypes(unsafe.Pointer(this.h))
	_ret := make([]string, int(_ma.len))
	_outCast := (*[0xffff]struct_miqt_string)(unsafe.Pointer(_ma.data)) // hey ya
	for i := 0; i < int(_ma.len); i++ {
		var _lv_ms struct_miqt_string = _outCast[i]
...
func (this *QSortFilterProxyModel) OnMimeTypes(slot func(super func() []string) []string) {
	...
	QSortFilterProxyModel_override_virtual_MimeTypes(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_MimeTypes
func miqt_exec_callback_QSortFilterProxyModel_MimeTypes(self QSortFilterProxyModel, cb intptr_t) struct_miqt_array {
...
func (this *QSortFilterProxyModel) callVirtualBase_SupportedDropActions() DropAction {
	...
	return (DropAction)(QSortFilterProxyModel_virtualbase_SupportedDropActions(unsafe.Pointer(this.h)))
...
func (this *QSortFilterProxyModel) OnSupportedDropActions(slot func(super func() DropAction) DropAction) {
	...
	QSortFilterProxyModel_override_virtual_SupportedDropActions(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_SupportedDropActions
func miqt_exec_callback_QSortFilterProxyModel_SupportedDropActions(self QSortFilterProxyModel, cb intptr_t) int {
...
func (this *QSortFilterProxyModel) callVirtualBase_Submit() bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_Submit(unsafe.Pointer(this.h)))
...
func (this *QSortFilterProxyModel) OnSubmit(slot func(super func() bool) bool) {
	...
	QSortFilterProxyModel_override_virtual_Submit(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Submit
func miqt_exec_callback_QSortFilterProxyModel_Submit(self QSortFilterProxyModel, cb intptr_t) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_Revert() {
	...
	QSortFilterProxyModel_virtualbase_Revert(unsafe.Pointer(this.h))
...
func (this *QSortFilterProxyModel) OnRevert(slot func(super func())) {
	...
	QSortFilterProxyModel_override_virtual_Revert(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_Revert
func miqt_exec_callback_QSortFilterProxyModel_Revert(self QSortFilterProxyModel, cb intptr_t) {
...
func (this *QSortFilterProxyModel) callVirtualBase_ItemData(index *QModelIndex) map[int]QVariant {
	...
	var _mm struct_miqt_map = QSortFilterProxyModel_virtualbase_ItemData(unsafe.Pointer(this.h), index.cPointer())
...
func (this *QSortFilterProxyModel) OnItemData(slot func(super func(index *QModelIndex) map[int]QVariant, index *QModelIndex) map[int]QVariant) {
	...
	QSortFilterProxyModel_override_virtual_ItemData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_ItemData
func miqt_exec_callback_QSortFilterProxyModel_ItemData(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex) struct_miqt_map {
...
func (this *QSortFilterProxyModel) callVirtualBase_SetItemData(index *QModelIndex, roles map[int]QVariant) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_SetItemData(unsafe.Pointer(this.h), index.cPointer(), roles_mm))
...
func (this *QSortFilterProxyModel) OnSetItemData(slot func(super func(index *QModelIndex, roles map[int]QVariant) bool, index *QModelIndex, roles map[int]QVariant) bool) {
	...
	QSortFilterProxyModel_override_virtual_SetItemData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_SetItemData
func miqt_exec_callback_QSortFilterProxyModel_SetItemData(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex, roles struct_miqt_map) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_ClearItemData(index *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_ClearItemData(unsafe.Pointer(this.h), index.cPointer()))
...
func (this *QSortFilterProxyModel) OnClearItemData(slot func(super func(index *QModelIndex) bool, index *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_ClearItemData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_ClearItemData
func miqt_exec_callback_QSortFilterProxyModel_ClearItemData(self QSortFilterProxyModel, cb intptr_t, index *QModelIndex) bool {
...
func (this *QSortFilterProxyModel) callVirtualBase_CanDropMimeData(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool {
	...
	return (bool)(QSortFilterProxyModel_virtualbase_CanDropMimeData(unsafe.Pointer(this.h), data.cPointer(), (int)(action), (int)(row), (int)(column), parent.cPointer()))
...
func (this *QSortFilterProxyModel) OnCanDropMimeData(slot func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool) {
	...
	QSortFilterProxyModel_override_virtual_CanDropMimeData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_CanDropMimeData
func miqt_exec_callback_QSortFilterProxyModel_CanDropMimeData(self QSortFilterProxyModel, cb intptr_t, data *QMimeData, action int, row int, column int, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QSortFilterProxyModel) callVirtualBase_SupportedDragActions() DropAction {
	...
	return (DropAction)(QSortFilterProxyModel_virtualbase_SupportedDragActions(unsafe.Pointer(this.h)))
...
func (this *QSortFilterProxyModel) OnSupportedDragActions(slot func(super func() DropAction) DropAction) {
	...
	QSortFilterProxyModel_override_virtual_SupportedDragActions(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_SupportedDragActions
func miqt_exec_callback_QSortFilterProxyModel_SupportedDragActions(self QSortFilterProxyModel, cb intptr_t) int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() DropAction) DropAction)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QSortFilterProxyModel) callVirtualBase_RoleNames() map[int][]byte {
	...
	var _mm struct_miqt_map = QSortFilterProxyModel_virtualbase_RoleNames(unsafe.Pointer(this.h))
...
func (this *QSortFilterProxyModel) OnRoleNames(slot func(super func() map[int][]byte) map[int][]byte) {
	...
	QSortFilterProxyModel_override_virtual_RoleNames(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QSortFilterProxyModel_RoleNames
func miqt_exec_callback_QSortFilterProxyModel_RoleNames(self QSortFilterProxyModel, cb intptr_t) struct_miqt_map {
