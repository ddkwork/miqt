...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QGraphicsWidget_MetaObject(const_cast<MiqtVirtualQGraphicsWidget*>(this), handle__MetaObject);
...
void QGraphicsWidget_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsWidget*>( (QGraphicsWidget*)(self) )->handle__MetaObject = slot;
}
...
void QGraphicsWidget_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsWidget*>( (QGraphicsWidget*)(self) )->handle__Metacast = slot;
}
