...
func NewQStringConverterBase(param1 *QStringConverterBase) *QStringConverterBase {
	g := newQStringConverterBase(QStringConverterBase_new(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQStringConverterBase2() *QStringConverterBase {
	g := newQStringConverterBase(QStringConverterBase_new2())
	g.isSubclass = true
	return g
}
...
func NewQStringConverterBase__State() *QStringConverterBase__State {
	g := newQStringConverterBase__State(QStringConverterBase__State_new())
	g.isSubclass = true
	return g
}
...
func NewQStringConverterBase__State2(f Flags) *QStringConverterBase__State {
	g := newQStringConverterBase__State(QStringConverterBase__State_new2(f))
	g.isSubclass = true
	return g
}
