...
func NewQCollatorSortKey(other *QCollatorSortKey) *QCollatorSortKey {
	g := newQCollatorSortKey(QCollatorSortKey_new(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQCollator2(locale *QLocale) *QCollator {
	g := newQCollator(QCollator_new2(locale.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQCollator3(param1 *QCollator) *QCollator {
	g := newQCollator(QCollator_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
