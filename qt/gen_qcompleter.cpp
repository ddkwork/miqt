...
QMetaObject* callback_return_value = miqt_exec_callback_QCompleter_MetaObject(const_cast<MiqtVirtualQCompleter*>(this), handle__MetaObject);
...
void QCompleter_virtbase(QCompleter* src
...
void QCompleter_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQCompleter*>( (QCompleter*)(self) )->handle__MetaObject = slot;
}
...
void QCompleter_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQCompleter*>( (QCompleter*)(self) )->handle__Metacast = slot;
}
