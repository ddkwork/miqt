...
QMetaObject* callback_return_value = miqt_exec_callback_QAbstractTextDocumentLayout_MetaObject(const_cast<MiqtVirtualQAbstractTextDocumentLayout*>(this), handle__MetaObject);
...
void QAbstractTextDocumentLayout_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractTextDocumentLayout*>( (QAbstractTextDocumentLayout*)(self) )->handle__MetaObject = slot;
}
...
void QAbstractTextDocumentLayout_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractTextDocumentLayout*>( (QAbstractTextDocumentLayout*)(self) )->handle__Metacast = slot;
}
