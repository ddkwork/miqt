...
func NewQTextDocumentFragment() *QTextDocumentFragment {
	g := newQTextDocumentFragment(QTextDocumentFragment_new())
	g.isSubclass = true
	return g
}
...
func NewQTextDocumentFragment2(document *QTextDocument) *QTextDocumentFragment {
	g := newQTextDocumentFragment(QTextDocumentFragment_new2(document.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextDocumentFragment3(rangeVal *QTextCursor) *QTextDocumentFragment {
	g := newQTextDocumentFragment(QTextDocumentFragment_new3(rangeVal.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextDocumentFragment4(rhs *QTextDocumentFragment) *QTextDocumentFragment {
	g := newQTextDocumentFragment(QTextDocumentFragment_new4(rhs.cPointer()))
	g.isSubclass = true
	return g
}
