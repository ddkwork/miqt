...
func NewQPushButton(parent *QWidget) *QPushButton {
	g := newQPushButton(QPushButton_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPushButton2() *QPushButton {
	g := newQPushButton(QPushButton_new2())
	g.isSubclass = true
	return g
}
...
func NewQPushButton3(text string) *QPushButton {
	...
	g := newQPushButton(QPushButton_new3(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQPushButton4(icon *QIcon, text string) *QPushButton {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQPushButton(QPushButton_new4(icon.cPointer(), text_ms))
	g.isSubclass = true
	return g
}
...
func NewQPushButton5(text string, parent *QWidget) *QPushButton {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQPushButton(QPushButton_new5(text_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPushButton6(icon *QIcon, text string, parent *QWidget) *QPushButton {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQPushButton(QPushButton_new6(icon.cPointer(), text_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
