...
func NewDisambiguated_t() *Disambiguated_t {
	g := newDisambiguated_t(Disambiguated_t_new())
	g.isSubclass = true
	return g
}
...
func NewDisambiguated_t2(param1 *Disambiguated_t) *Disambiguated_t {
	g := newDisambiguated_t(Disambiguated_t_new2(param1))
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination() *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new())
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination2(modifiers Modifier) *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new2((int)(modifiers)))
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination3(modifiers KeyboardModifier) *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new3((int)(modifiers)))
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination4(param1 *QKeyCombination) *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination5(key Key) *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new5((int)(key)))
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination6(modifiers Modifier, key Key) *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new6((int)(modifiers), (int)(key)))
	g.isSubclass = true
	return g
}
...
func NewQKeyCombination7(modifiers KeyboardModifier, key Key) *QKeyCombination {
	g := newQKeyCombination(QKeyCombination_new7((int)(modifiers), (int)(key)))
	g.isSubclass = true
	return g
}
