...
func (this *QListView) callVirtualBase_VisualRect(index *QModelIndex) *QRect {
	...
	_goptr := newQRect(QListView_virtualbase_VisualRect(unsafe.Pointer(this.h), index.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QListView) OnVisualRect(slot func(super func(index *QModelIndex) *QRect, index *QModelIndex) *QRect) {
	...
	QListView_override_virtual_VisualRect(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_VisualRect
func miqt_exec_callback_QListView_VisualRect(self QListView, cb intptr_t, index *QModelIndex) *QRect {
...
func (this *QListView) callVirtualBase_ScrollTo(index *QModelIndex, hint ScrollHint) {

	QListView_virtualbase_ScrollTo(unsafe.Pointer(this.h), index.cPointer(), hint)

}
func (this *QListView) OnScrollTo(slot func(super func(index *QModelIndex, hint ScrollHint), index *QModelIndex, hint ScrollHint)) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
	QListView_override_virtual_ScrollTo(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_ScrollTo
func miqt_exec_callback_QListView_ScrollTo(self QListView, cb intptr_t, index *QModelIndex, hint ScrollHint) {
...
func (this *QListView) callVirtualBase_IndexAt(p *QPoint) *QModelIndex {
	...
	_goptr := newQModelIndex(QListView_virtualbase_IndexAt(unsafe.Pointer(this.h), p.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QListView) OnIndexAt(slot func(super func(p *QPoint) *QModelIndex, p *QPoint) *QModelIndex) {
	...
	QListView_override_virtual_IndexAt(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_IndexAt
func miqt_exec_callback_QListView_IndexAt(self QListView, cb intptr_t, p *QPoint) *QModelIndex {
...
func (this *QListView) callVirtualBase_DoItemsLayout() {
	...
	QListView_virtualbase_DoItemsLayout(unsafe.Pointer(this.h))
...
func (this *QListView) OnDoItemsLayout(slot func(super func())) {
	...
	QListView_override_virtual_DoItemsLayout(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_DoItemsLayout
func miqt_exec_callback_QListView_DoItemsLayout(self QListView, cb intptr_t) {
...
func (this *QListView) callVirtualBase_Reset() {
	...
	QListView_virtualbase_Reset(unsafe.Pointer(this.h))
...
func (this *QListView) OnReset(slot func(super func())) {
	...
	QListView_override_virtual_Reset(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_Reset
func miqt_exec_callback_QListView_Reset(self QListView, cb intptr_t) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func()))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_SetRootIndex(index *QModelIndex) {
	...
	QListView_virtualbase_SetRootIndex(unsafe.Pointer(this.h), index.cPointer())
...
func (this *QListView) OnSetRootIndex(slot func(super func(index *QModelIndex), index *QModelIndex)) {
	...
	QListView_override_virtual_SetRootIndex(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SetRootIndex
func miqt_exec_callback_QListView_SetRootIndex(self QListView, cb intptr_t, index *QModelIndex) {
...
func (this *QListView) callVirtualBase_Event(e *QEvent) bool {
	...
	return (bool)(QListView_virtualbase_Event(unsafe.Pointer(this.h), e.cPointer()))
...
func (this *QListView) OnEvent(slot func(super func(e *QEvent) bool, e *QEvent) bool) {
	...
	QListView_override_virtual_Event(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_Event
func miqt_exec_callback_QListView_Event(self QListView, cb intptr_t, e *QEvent) bool {
...
func (this *QListView) callVirtualBase_ScrollContentsBy(dx int, dy int) {
	...
	QListView_virtualbase_ScrollContentsBy(unsafe.Pointer(this.h), (int)(dx), (int)(dy))
...
func (this *QListView) OnScrollContentsBy(slot func(super func(dx int, dy int), dx int, dy int)) {
	...
	QListView_override_virtual_ScrollContentsBy(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_ScrollContentsBy
func miqt_exec_callback_QListView_ScrollContentsBy(self QListView, cb intptr_t, dx int, dy int) {
...
func (this *QListView) callVirtualBase_DataChanged(topLeft *QModelIndex, bottomRight *QModelIndex, roles []int) {
	...
	QListView_virtualbase_DataChanged(unsafe.Pointer(this.h), topLeft.cPointer(), bottomRight.cPointer(), roles_ma)
...
func (this *QListView) OnDataChanged(slot func(super func(topLeft *QModelIndex, bottomRight *QModelIndex, roles []int), topLeft *QModelIndex, bottomRight *QModelIndex, roles []int)) {
	...
	QListView_override_virtual_DataChanged(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_DataChanged
func miqt_exec_callback_QListView_DataChanged(self QListView, cb intptr_t, topLeft *QModelIndex, bottomRight *QModelIndex, roles struct_miqt_array) {
...
func (this *QListView) callVirtualBase_RowsInserted(parent *QModelIndex, start int, end int) {
	...
	QListView_virtualbase_RowsInserted(unsafe.Pointer(this.h), parent.cPointer(), (int)(start), (int)(end))
...
func (this *QListView) OnRowsInserted(slot func(super func(parent *QModelIndex, start int, end int), parent *QModelIndex, start int, end int)) {
	...
	QListView_override_virtual_RowsInserted(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_RowsInserted
func miqt_exec_callback_QListView_RowsInserted(self QListView, cb intptr_t, parent *QModelIndex, start int, end int) {
...
func (this *QListView) callVirtualBase_RowsAboutToBeRemoved(parent *QModelIndex, start int, end int) {
	...
	QListView_virtualbase_RowsAboutToBeRemoved(unsafe.Pointer(this.h), parent.cPointer(), (int)(start), (int)(end))
...
func (this *QListView) OnRowsAboutToBeRemoved(slot func(super func(parent *QModelIndex, start int, end int), parent *QModelIndex, start int, end int)) {
	...
	QListView_override_virtual_RowsAboutToBeRemoved(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_RowsAboutToBeRemoved
func miqt_exec_callback_QListView_RowsAboutToBeRemoved(self QListView, cb intptr_t, parent *QModelIndex, start int, end int) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(parent *QModelIndex, start int, end int), parent *QModelIndex, start int, end int))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_MouseMoveEvent(e *QMouseEvent) {
	...
	QListView_virtualbase_MouseMoveEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnMouseMoveEvent(slot func(super func(e *QMouseEvent), e *QMouseEvent)) {
	...
	QListView_override_virtual_MouseMoveEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_MouseMoveEvent
func miqt_exec_callback_QListView_MouseMoveEvent(self QListView, cb intptr_t, e *QMouseEvent) {
...
func (this *QListView) callVirtualBase_MouseReleaseEvent(e *QMouseEvent) {
	...
	QListView_virtualbase_MouseReleaseEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnMouseReleaseEvent(slot func(super func(e *QMouseEvent), e *QMouseEvent)) {
	...
	QListView_override_virtual_MouseReleaseEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_MouseReleaseEvent
func miqt_exec_callback_QListView_MouseReleaseEvent(self QListView, cb intptr_t, e *QMouseEvent) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(e *QMouseEvent), e *QMouseEvent))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_WheelEvent(e *QWheelEvent) {
	...
	QListView_virtualbase_WheelEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnWheelEvent(slot func(super func(e *QWheelEvent), e *QWheelEvent)) {
	...
	QListView_override_virtual_WheelEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_WheelEvent
func miqt_exec_callback_QListView_WheelEvent(self QListView, cb intptr_t, e *QWheelEvent) {
...
func (this *QListView) callVirtualBase_TimerEvent(e *QTimerEvent) {
	...
	QListView_virtualbase_TimerEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnTimerEvent(slot func(super func(e *QTimerEvent), e *QTimerEvent)) {
	...
	QListView_override_virtual_TimerEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_TimerEvent
func miqt_exec_callback_QListView_TimerEvent(self QListView, cb intptr_t, e *QTimerEvent) {
...
func (this *QListView) callVirtualBase_ResizeEvent(e *QResizeEvent) {
	...
	QListView_virtualbase_ResizeEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnResizeEvent(slot func(super func(e *QResizeEvent), e *QResizeEvent)) {
	...
	QListView_override_virtual_ResizeEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_ResizeEvent
func miqt_exec_callback_QListView_ResizeEvent(self QListView, cb intptr_t, e *QResizeEvent) {
...
func (this *QListView) callVirtualBase_DragMoveEvent(e *QDragMoveEvent) {
	...
	QListView_virtualbase_DragMoveEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnDragMoveEvent(slot func(super func(e *QDragMoveEvent), e *QDragMoveEvent)) {
	...
	QListView_override_virtual_DragMoveEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_DragMoveEvent
func miqt_exec_callback_QListView_DragMoveEvent(self QListView, cb intptr_t, e *QDragMoveEvent) {
...
func (this *QListView) callVirtualBase_DragLeaveEvent(e *QDragLeaveEvent) {
	...
	QListView_virtualbase_DragLeaveEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnDragLeaveEvent(slot func(super func(e *QDragLeaveEvent), e *QDragLeaveEvent)) {
	...
	QListView_override_virtual_DragLeaveEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_DragLeaveEvent
func miqt_exec_callback_QListView_DragLeaveEvent(self QListView, cb intptr_t, e *QDragLeaveEvent) {
...
func (this *QListView) callVirtualBase_DropEvent(e *QDropEvent) {
	...
	QListView_virtualbase_DropEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnDropEvent(slot func(super func(e *QDropEvent), e *QDropEvent)) {
	...
	QListView_override_virtual_DropEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_DropEvent
func miqt_exec_callback_QListView_DropEvent(self QListView, cb intptr_t, e *QDropEvent) {
...
func (this *QListView) callVirtualBase_StartDrag(supportedActions DropAction) {
	...
	QListView_virtualbase_StartDrag(unsafe.Pointer(this.h), (int)(supportedActions))
...
func (this *QListView) OnStartDrag(slot func(super func(supportedActions DropAction), supportedActions DropAction)) {
	...
	QListView_override_virtual_StartDrag(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_StartDrag
func miqt_exec_callback_QListView_StartDrag(self QListView, cb intptr_t, supportedActions int) {
...
func (this *QListView) callVirtualBase_InitViewItemOption(option *QStyleOptionViewItem) {
	...
	QListView_virtualbase_InitViewItemOption(unsafe.Pointer(this.h), option.cPointer())
...
func (this *QListView) OnInitViewItemOption(slot func(super func(option *QStyleOptionViewItem), option *QStyleOptionViewItem)) {
	...
	QListView_override_virtual_InitViewItemOption(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_InitViewItemOption
func miqt_exec_callback_QListView_InitViewItemOption(self QListView, cb intptr_t, option *QStyleOptionViewItem) {
...
func (this *QListView) callVirtualBase_PaintEvent(e *QPaintEvent) {
	...
	QListView_virtualbase_PaintEvent(unsafe.Pointer(this.h), e.cPointer())
...
func (this *QListView) OnPaintEvent(slot func(super func(e *QPaintEvent), e *QPaintEvent)) {
	...
	QListView_override_virtual_PaintEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_PaintEvent
func miqt_exec_callback_QListView_PaintEvent(self QListView, cb intptr_t, e *QPaintEvent) {
...
func (this *QListView) callVirtualBase_HorizontalOffset() int {
	...
	return (int)(QListView_virtualbase_HorizontalOffset(unsafe.Pointer(this.h)))
...
func (this *QListView) OnHorizontalOffset(slot func(super func() int) int) {
	...
	QListView_override_virtual_HorizontalOffset(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_HorizontalOffset
func miqt_exec_callback_QListView_HorizontalOffset(self QListView, cb intptr_t) int {
...
func (this *QListView) callVirtualBase_VerticalOffset() int {
	...
	return (int)(QListView_virtualbase_VerticalOffset(unsafe.Pointer(this.h)))
...
func (this *QListView) OnVerticalOffset(slot func(super func() int) int) {
	...
	QListView_override_virtual_VerticalOffset(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_VerticalOffset
func miqt_exec_callback_QListView_VerticalOffset(self QListView, cb intptr_t) int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() int) int)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_MoveCursor(cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex {

	_goptr := newQModelIndex(QListView_virtualbase_MoveCursor(unsafe.Pointer(this.h), cursorAction, (int)(modifiers)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr

}
func (this *QListView) OnMoveCursor(slot func(super func(cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex, cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
	QListView_override_virtual_MoveCursor(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_MoveCursor
func miqt_exec_callback_QListView_MoveCursor(self QListView, cb intptr_t, cursorAction CursorAction, modifiers int) *QModelIndex {
...
func (this *QListView) callVirtualBase_SetSelection(rect *QRect, command SelectionFlag) {

	QListView_virtualbase_SetSelection(unsafe.Pointer(this.h), rect.cPointer(), (int)(command))

}
func (this *QListView) OnSetSelection(slot func(super func(rect *QRect, command SelectionFlag), rect *QRect, command SelectionFlag)) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
	QListView_override_virtual_SetSelection(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SetSelection
func miqt_exec_callback_QListView_SetSelection(self QListView, cb intptr_t, rect *QRect, command int) {
...
func (this *QListView) callVirtualBase_VisualRegionForSelection(selection *QItemSelection) *QRegion {
	...
	_goptr := newQRegion(QListView_virtualbase_VisualRegionForSelection(unsafe.Pointer(this.h), selection.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QListView) OnVisualRegionForSelection(slot func(super func(selection *QItemSelection) *QRegion, selection *QItemSelection) *QRegion) {
	...
	QListView_override_virtual_VisualRegionForSelection(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_VisualRegionForSelection
func miqt_exec_callback_QListView_VisualRegionForSelection(self QListView, cb intptr_t, selection *QItemSelection) *QRegion {
...
func (this *QListView) callVirtualBase_SelectedIndexes() []QModelIndex {
	...
	var _ma struct_miqt_array = QListView_virtualbase_SelectedIndexes(unsafe.Pointer(this.h))
...
func (this *QListView) OnSelectedIndexes(slot func(super func() []QModelIndex) []QModelIndex) {
	...
	QListView_override_virtual_SelectedIndexes(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SelectedIndexes
func miqt_exec_callback_QListView_SelectedIndexes(self QListView, cb intptr_t) struct_miqt_array {
...
func (this *QListView) callVirtualBase_UpdateGeometries() {
	...
	QListView_virtualbase_UpdateGeometries(unsafe.Pointer(this.h))
...
func (this *QListView) OnUpdateGeometries(slot func(super func())) {
	...
	QListView_override_virtual_UpdateGeometries(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_UpdateGeometries
func miqt_exec_callback_QListView_UpdateGeometries(self QListView, cb intptr_t) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func()))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_IsIndexHidden(index *QModelIndex) bool {
	...
	return (bool)(QListView_virtualbase_IsIndexHidden(unsafe.Pointer(this.h), index.cPointer()))
...
func (this *QListView) OnIsIndexHidden(slot func(super func(index *QModelIndex) bool, index *QModelIndex) bool) {
	...
	QListView_override_virtual_IsIndexHidden(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_IsIndexHidden
func miqt_exec_callback_QListView_IsIndexHidden(self QListView, cb intptr_t, index *QModelIndex) bool {
...
func (this *QListView) callVirtualBase_SelectionChanged(selected *QItemSelection, deselected *QItemSelection) {
	...
	QListView_virtualbase_SelectionChanged(unsafe.Pointer(this.h), selected.cPointer(), deselected.cPointer())
...
func (this *QListView) OnSelectionChanged(slot func(super func(selected *QItemSelection, deselected *QItemSelection), selected *QItemSelection, deselected *QItemSelection)) {
	...
	QListView_override_virtual_SelectionChanged(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SelectionChanged
func miqt_exec_callback_QListView_SelectionChanged(self QListView, cb intptr_t, selected *QItemSelection, deselected *QItemSelection) {
...
func (this *QListView) callVirtualBase_CurrentChanged(current *QModelIndex, previous *QModelIndex) {
	...
	QListView_virtualbase_CurrentChanged(unsafe.Pointer(this.h), current.cPointer(), previous.cPointer())
...
func (this *QListView) OnCurrentChanged(slot func(super func(current *QModelIndex, previous *QModelIndex), current *QModelIndex, previous *QModelIndex)) {
	...
	QListView_override_virtual_CurrentChanged(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_CurrentChanged
func miqt_exec_callback_QListView_CurrentChanged(self QListView, cb intptr_t, current *QModelIndex, previous *QModelIndex) {
...
func (this *QListView) callVirtualBase_ViewportSizeHint() *QSize {
	...
	_goptr := newQSize(QListView_virtualbase_ViewportSizeHint(unsafe.Pointer(this.h)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QListView) OnViewportSizeHint(slot func(super func() *QSize) *QSize) {
	...
	QListView_override_virtual_ViewportSizeHint(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_ViewportSizeHint
func miqt_exec_callback_QListView_ViewportSizeHint(self QListView, cb intptr_t) *QSize {
...
func (this *QListView) callVirtualBase_SetModel(model *QAbstractItemModel) {
	...
	QListView_virtualbase_SetModel(unsafe.Pointer(this.h), model.cPointer())
...
func (this *QListView) OnSetModel(slot func(super func(model *QAbstractItemModel), model *QAbstractItemModel)) {
	...
	QListView_override_virtual_SetModel(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SetModel
func miqt_exec_callback_QListView_SetModel(self QListView, cb intptr_t, model *QAbstractItemModel) {
...
func (this *QListView) callVirtualBase_SetSelectionModel(selectionModel *QItemSelectionModel) {
	...
	QListView_virtualbase_SetSelectionModel(unsafe.Pointer(this.h), selectionModel.cPointer())
...
func (this *QListView) OnSetSelectionModel(slot func(super func(selectionModel *QItemSelectionModel), selectionModel *QItemSelectionModel)) {
	...
	QListView_override_virtual_SetSelectionModel(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SetSelectionModel
func miqt_exec_callback_QListView_SetSelectionModel(self QListView, cb intptr_t, selectionModel *QItemSelectionModel) {
...
func (this *QListView) callVirtualBase_KeyboardSearch(search string) {
	...
	QListView_virtualbase_KeyboardSearch(unsafe.Pointer(this.h), search_ms)
...
func (this *QListView) OnKeyboardSearch(slot func(super func(search string), search string)) {
	...
	QListView_override_virtual_KeyboardSearch(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_KeyboardSearch
func miqt_exec_callback_QListView_KeyboardSearch(self QListView, cb intptr_t, search struct_miqt_string) {
...
func (this *QListView) callVirtualBase_SizeHintForRow(row int) int {
	...
	return (int)(QListView_virtualbase_SizeHintForRow(unsafe.Pointer(this.h), (int)(row)))
...
func (this *QListView) OnSizeHintForRow(slot func(super func(row int) int, row int) int) {
	...
	QListView_override_virtual_SizeHintForRow(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SizeHintForRow
func miqt_exec_callback_QListView_SizeHintForRow(self QListView, cb intptr_t, row int) int {
...
func (this *QListView) callVirtualBase_SizeHintForColumn(column int) int {
	...
	return (int)(QListView_virtualbase_SizeHintForColumn(unsafe.Pointer(this.h), (int)(column)))
...
func (this *QListView) OnSizeHintForColumn(slot func(super func(column int) int, column int) int) {
	...
	QListView_override_virtual_SizeHintForColumn(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SizeHintForColumn
func miqt_exec_callback_QListView_SizeHintForColumn(self QListView, cb intptr_t, column int) int {
...
func (this *QListView) callVirtualBase_ItemDelegateForIndex(index *QModelIndex) *QAbstractItemDelegate {
	...
	return newQAbstractItemDelegate(QListView_virtualbase_ItemDelegateForIndex(unsafe.Pointer(this.h), index.cPointer()))
...
func (this *QListView) OnItemDelegateForIndex(slot func(super func(index *QModelIndex) *QAbstractItemDelegate, index *QModelIndex) *QAbstractItemDelegate) {
	...
	QListView_override_virtual_ItemDelegateForIndex(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_ItemDelegateForIndex
func miqt_exec_callback_QListView_ItemDelegateForIndex(self QListView, cb intptr_t, index *QModelIndex) *QAbstractItemDelegate {
...
func (this *QListView) callVirtualBase_InputMethodQuery(query InputMethodQuery) *QVariant {
	...
	_goptr := newQVariant(QListView_virtualbase_InputMethodQuery(unsafe.Pointer(this.h), (int)(query)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QListView) OnInputMethodQuery(slot func(super func(query InputMethodQuery) *QVariant, query InputMethodQuery) *QVariant) {
	...
	QListView_override_virtual_InputMethodQuery(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_InputMethodQuery
func miqt_exec_callback_QListView_InputMethodQuery(self QListView, cb intptr_t, query int) *QVariant {
...
func (this *QListView) callVirtualBase_SelectAll() {
	...
	QListView_virtualbase_SelectAll(unsafe.Pointer(this.h))
...
func (this *QListView) OnSelectAll(slot func(super func())) {
	...
	QListView_override_virtual_SelectAll(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SelectAll
func miqt_exec_callback_QListView_SelectAll(self QListView, cb intptr_t) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func()))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_UpdateEditorData() {
	...
	QListView_virtualbase_UpdateEditorData(unsafe.Pointer(this.h))
...
func (this *QListView) OnUpdateEditorData(slot func(super func())) {
	...
	QListView_override_virtual_UpdateEditorData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_UpdateEditorData
func miqt_exec_callback_QListView_UpdateEditorData(self QListView, cb intptr_t) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func()))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_UpdateEditorGeometries() {
	...
	QListView_virtualbase_UpdateEditorGeometries(unsafe.Pointer(this.h))
...
func (this *QListView) OnUpdateEditorGeometries(slot func(super func())) {
	...
	QListView_override_virtual_UpdateEditorGeometries(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_UpdateEditorGeometries
func miqt_exec_callback_QListView_UpdateEditorGeometries(self QListView, cb intptr_t) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func()))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_VerticalScrollbarAction(action int) {
	...
	QListView_virtualbase_VerticalScrollbarAction(unsafe.Pointer(this.h), (int)(action))
...
func (this *QListView) OnVerticalScrollbarAction(slot func(super func(action int), action int)) {
	...
	QListView_override_virtual_VerticalScrollbarAction(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_VerticalScrollbarAction
func miqt_exec_callback_QListView_VerticalScrollbarAction(self QListView, cb intptr_t, action int) {
...
func (this *QListView) callVirtualBase_HorizontalScrollbarAction(action int) {
	...
	QListView_virtualbase_HorizontalScrollbarAction(unsafe.Pointer(this.h), (int)(action))
...
func (this *QListView) OnHorizontalScrollbarAction(slot func(super func(action int), action int)) {
	...
	QListView_override_virtual_HorizontalScrollbarAction(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_HorizontalScrollbarAction
func miqt_exec_callback_QListView_HorizontalScrollbarAction(self QListView, cb intptr_t, action int) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(action int), action int))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_VerticalScrollbarValueChanged(value int) {
	...
	QListView_virtualbase_VerticalScrollbarValueChanged(unsafe.Pointer(this.h), (int)(value))
...
func (this *QListView) OnVerticalScrollbarValueChanged(slot func(super func(value int), value int)) {
	...
	QListView_override_virtual_VerticalScrollbarValueChanged(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_VerticalScrollbarValueChanged
func miqt_exec_callback_QListView_VerticalScrollbarValueChanged(self QListView, cb intptr_t, value int) {
...
func (this *QListView) callVirtualBase_HorizontalScrollbarValueChanged(value int) {
	...
	QListView_virtualbase_HorizontalScrollbarValueChanged(unsafe.Pointer(this.h), (int)(value))
...
func (this *QListView) OnHorizontalScrollbarValueChanged(slot func(super func(value int), value int)) {
	...
	QListView_override_virtual_HorizontalScrollbarValueChanged(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_HorizontalScrollbarValueChanged
func miqt_exec_callback_QListView_HorizontalScrollbarValueChanged(self QListView, cb intptr_t, value int) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(value int), value int))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_CloseEditor(editor *QWidget, hint QAbstractItemDelegate__EndEditHint) {
	...
	QListView_virtualbase_CloseEditor(unsafe.Pointer(this.h), editor.cPointer(), (int)(hint))
...
func (this *QListView) OnCloseEditor(slot func(super func(editor *QWidget, hint QAbstractItemDelegate__EndEditHint), editor *QWidget, hint QAbstractItemDelegate__EndEditHint)) {
	...
	QListView_override_virtual_CloseEditor(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_CloseEditor
func miqt_exec_callback_QListView_CloseEditor(self QListView, cb intptr_t, editor *QWidget, hint int) {
...
func (this *QListView) callVirtualBase_CommitData(editor *QWidget) {
	...
	QListView_virtualbase_CommitData(unsafe.Pointer(this.h), editor.cPointer())
...
func (this *QListView) OnCommitData(slot func(super func(editor *QWidget), editor *QWidget)) {
	...
	QListView_override_virtual_CommitData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_CommitData
func miqt_exec_callback_QListView_CommitData(self QListView, cb intptr_t, editor *QWidget) {
...
func (this *QListView) callVirtualBase_EditorDestroyed(editor *QObject) {
	...
	QListView_virtualbase_EditorDestroyed(unsafe.Pointer(this.h), editor.cPointer())
...
func (this *QListView) OnEditorDestroyed(slot func(super func(editor *QObject), editor *QObject)) {
	...
	QListView_override_virtual_EditorDestroyed(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_EditorDestroyed
func miqt_exec_callback_QListView_EditorDestroyed(self QListView, cb intptr_t, editor *QObject) {
...
func (this *QListView) callVirtualBase_Edit2(index *QModelIndex, trigger EditTrigger, event *QEvent) bool {

	return (bool)(QListView_virtualbase_Edit2(unsafe.Pointer(this.h), index.cPointer(), trigger, event.cPointer()))

}
func (this *QListView) OnEdit2(slot func(super func(index *QModelIndex, trigger EditTrigger, event *QEvent) bool, index *QModelIndex, trigger EditTrigger, event *QEvent) bool) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
	QListView_override_virtual_Edit2(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_Edit2
func miqt_exec_callback_QListView_Edit2(self QListView, cb intptr_t, index *QModelIndex, trigger EditTrigger, event *QEvent) bool {
...
func (this *QListView) callVirtualBase_SelectionCommand(index *QModelIndex, event *QEvent) SelectionFlag {

	return (SelectionFlag)(QListView_virtualbase_SelectionCommand(unsafe.Pointer(this.h), index.cPointer(), event.cPointer()))

}
func (this *QListView) OnSelectionCommand(slot func(super func(index *QModelIndex, event *QEvent) SelectionFlag, index *QModelIndex, event *QEvent) SelectionFlag) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
	QListView_override_virtual_SelectionCommand(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_SelectionCommand
func miqt_exec_callback_QListView_SelectionCommand(self QListView, cb intptr_t, index *QModelIndex, event *QEvent) int {
...
func (this *QListView) callVirtualBase_FocusNextPrevChild(next bool) bool {
	...
	return (bool)(QListView_virtualbase_FocusNextPrevChild(unsafe.Pointer(this.h), (bool)(next)))
...
func (this *QListView) OnFocusNextPrevChild(slot func(super func(next bool) bool, next bool) bool) {
	...
	QListView_override_virtual_FocusNextPrevChild(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_FocusNextPrevChild
func miqt_exec_callback_QListView_FocusNextPrevChild(self QListView, cb intptr_t, next bool) bool {
...
func (this *QListView) callVirtualBase_ViewportEvent(event *QEvent) bool {
	...
	return (bool)(QListView_virtualbase_ViewportEvent(unsafe.Pointer(this.h), event.cPointer()))
...
func (this *QListView) OnViewportEvent(slot func(super func(event *QEvent) bool, event *QEvent) bool) {
	...
	QListView_override_virtual_ViewportEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_ViewportEvent
func miqt_exec_callback_QListView_ViewportEvent(self QListView, cb intptr_t, event *QEvent) bool {
...
func (this *QListView) callVirtualBase_MousePressEvent(event *QMouseEvent) {
	...
	QListView_virtualbase_MousePressEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnMousePressEvent(slot func(super func(event *QMouseEvent), event *QMouseEvent)) {
	...
	QListView_override_virtual_MousePressEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_MousePressEvent
func miqt_exec_callback_QListView_MousePressEvent(self QListView, cb intptr_t, event *QMouseEvent) {
...
func (this *QListView) callVirtualBase_MouseDoubleClickEvent(event *QMouseEvent) {
	...
	QListView_virtualbase_MouseDoubleClickEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnMouseDoubleClickEvent(slot func(super func(event *QMouseEvent), event *QMouseEvent)) {
	...
	QListView_override_virtual_MouseDoubleClickEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_MouseDoubleClickEvent
func miqt_exec_callback_QListView_MouseDoubleClickEvent(self QListView, cb intptr_t, event *QMouseEvent) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(event *QMouseEvent), event *QMouseEvent))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_DragEnterEvent(event *QDragEnterEvent) {
	...
	QListView_virtualbase_DragEnterEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnDragEnterEvent(slot func(super func(event *QDragEnterEvent), event *QDragEnterEvent)) {
	...
	QListView_override_virtual_DragEnterEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_DragEnterEvent
func miqt_exec_callback_QListView_DragEnterEvent(self QListView, cb intptr_t, event *QDragEnterEvent) {
...
func (this *QListView) callVirtualBase_FocusInEvent(event *QFocusEvent) {
	...
	QListView_virtualbase_FocusInEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnFocusInEvent(slot func(super func(event *QFocusEvent), event *QFocusEvent)) {
	...
	QListView_override_virtual_FocusInEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_FocusInEvent
func miqt_exec_callback_QListView_FocusInEvent(self QListView, cb intptr_t, event *QFocusEvent) {
...
func (this *QListView) callVirtualBase_FocusOutEvent(event *QFocusEvent) {
	...
	QListView_virtualbase_FocusOutEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnFocusOutEvent(slot func(super func(event *QFocusEvent), event *QFocusEvent)) {
	...
	QListView_override_virtual_FocusOutEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_FocusOutEvent
func miqt_exec_callback_QListView_FocusOutEvent(self QListView, cb intptr_t, event *QFocusEvent) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(event *QFocusEvent), event *QFocusEvent))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QListView) callVirtualBase_KeyPressEvent(event *QKeyEvent) {
	...
	QListView_virtualbase_KeyPressEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnKeyPressEvent(slot func(super func(event *QKeyEvent), event *QKeyEvent)) {
	...
	QListView_override_virtual_KeyPressEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_KeyPressEvent
func miqt_exec_callback_QListView_KeyPressEvent(self QListView, cb intptr_t, event *QKeyEvent) {
...
func (this *QListView) callVirtualBase_InputMethodEvent(event *QInputMethodEvent) {
	...
	QListView_virtualbase_InputMethodEvent(unsafe.Pointer(this.h), event.cPointer())
...
func (this *QListView) OnInputMethodEvent(slot func(super func(event *QInputMethodEvent), event *QInputMethodEvent)) {
	...
	QListView_override_virtual_InputMethodEvent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_InputMethodEvent
func miqt_exec_callback_QListView_InputMethodEvent(self QListView, cb intptr_t, event *QInputMethodEvent) {
...
func (this *QListView) callVirtualBase_EventFilter(object *QObject, event *QEvent) bool {
	...
	return (bool)(QListView_virtualbase_EventFilter(unsafe.Pointer(this.h), object.cPointer(), event.cPointer()))
...
func (this *QListView) OnEventFilter(slot func(super func(object *QObject, event *QEvent) bool, object *QObject, event *QEvent) bool) {
	...
	QListView_override_virtual_EventFilter(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QListView_EventFilter
func miqt_exec_callback_QListView_EventFilter(self QListView, cb intptr_t, object *QObject, event *QEvent) bool {
