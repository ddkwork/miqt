...
func NewQQuaternion() *QQuaternion {
	g := newQQuaternion(QQuaternion_new())
	g.isSubclass = true
	return g
}
...
func NewQQuaternion2(param1 Initialization) *QQuaternion {
	g := newQQuaternion(QQuaternion_new2((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQQuaternion3(scalar float32, xpos float32, ypos float32, zpos float32) *QQuaternion {
	g := newQQuaternion(QQuaternion_new3((float)(scalar), (float)(xpos), (float)(ypos), (float)(zpos)))
	g.isSubclass = true
	return g
}
...
func NewQQuaternion4(scalar float32, vector *QVector3D) *QQuaternion {
	g := newQQuaternion(QQuaternion_new4((float)(scalar), vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQQuaternion5(vector *QVector4D) *QQuaternion {
	g := newQQuaternion(QQuaternion_new5(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQQuaternion6(param1 *QQuaternion) *QQuaternion {
	g := newQQuaternion(QQuaternion_new6(param1.cPointer()))
	g.isSubclass = true
	return g
}
