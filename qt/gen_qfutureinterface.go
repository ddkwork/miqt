...
func NewQFutureInterfaceBase() *QFutureInterfaceBase {
	g := newQFutureInterfaceBase(QFutureInterfaceBase_new())
	g.isSubclass = true
	return g
}
...
func NewQFutureInterfaceBase2(other *QFutureInterfaceBase) *QFutureInterfaceBase {
	g := newQFutureInterfaceBase(QFutureInterfaceBase_new2(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFutureInterfaceBase3(initialState State) *QFutureInterfaceBase {
	g := newQFutureInterfaceBase(QFutureInterfaceBase_new3(initialState))
	g.isSubclass = true
	return g
}
