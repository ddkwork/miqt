...
func NewQDate2(y int, m int, d int) *QDate {
	g := newQDate(QDate_new2((int)(y), (int)(m), (int)(d)))
	g.isSubclass = true
	return g
}
...
func NewQDate3(y int, m int, d int, cal QCalendar) *QDate {
	g := newQDate(QDate_new3((int)(y), (int)(m), (int)(d), cal.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDate4(param1 *QDate) *QDate {
	g := newQDate(QDate_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTime2(h int, m int) *QTime {
	g := newQTime(QTime_new2((int)(h), (int)(m)))
	g.isSubclass = true
	return g
}
...
func NewQTime3(param1 *QTime) *QTime {
	g := newQTime(QTime_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTime4(h int, m int, s int) *QTime {
	g := newQTime(QTime_new4((int)(h), (int)(m), (int)(s)))
	g.isSubclass = true
	return g
}
...
func NewQTime5(h int, m int, s int, ms int) *QTime {
	g := newQTime(QTime_new5((int)(h), (int)(m), (int)(s), (int)(ms)))
	g.isSubclass = true
	return g
}
...
func NewQDateTime2(date QDate, time QTime, spec TimeSpec) *QDateTime {
	g := newQDateTime(QDateTime_new2(date.cPointer(), time.cPointer(), (int)(spec)))
	g.isSubclass = true
	return g
}
...
func NewQDateTime3(date QDate, time QTime, timeZone *QTimeZone) *QDateTime {
	g := newQDateTime(QDateTime_new3(date.cPointer(), time.cPointer(), timeZone.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTime4(date QDate, time QTime) *QDateTime {
	g := newQDateTime(QDateTime_new4(date.cPointer(), time.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTime5(other *QDateTime) *QDateTime {
	g := newQDateTime(QDateTime_new5(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTime6(date QDate, time QTime, spec TimeSpec, offsetSeconds int) *QDateTime {
	g := newQDateTime(QDateTime_new6(date.cPointer(), time.cPointer(), (int)(spec), (int)(offsetSeconds)))
	g.isSubclass = true
	return g
}
...
func NewQDateTime7(date QDate, time QTime, timeZone *QTimeZone, resolve TransitionResolution) *QDateTime {
	g := newQDateTime(QDateTime_new7(date.cPointer(), time.cPointer(), timeZone.cPointer(), resolve))
	g.isSubclass = true
	return g
}
...
func NewQDateTime8(date QDate, time QTime, resolve TransitionResolution) *QDateTime {
	g := newQDateTime(QDateTime_new8(date.cPointer(), time.cPointer(), resolve))
	g.isSubclass = true
	return g
}
