...
func NewQDateTimeEdit(parent *QWidget) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit2() *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new2())
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit3(dt *QDateTime) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new3(dt.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit4(d QDate) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new4(d.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit5(t QTime) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new5(t.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit6(dt *QDateTime, parent *QWidget) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new6(dt.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit7(d QDate, parent *QWidget) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new7(d.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateTimeEdit8(t QTime, parent *QWidget) *QDateTimeEdit {
	g := newQDateTimeEdit(QDateTimeEdit_new8(t.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTimeEdit(parent *QWidget) *QTimeEdit {
	g := newQTimeEdit(QTimeEdit_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTimeEdit3(time QTime) *QTimeEdit {
	g := newQTimeEdit(QTimeEdit_new3(time.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTimeEdit4(time QTime, parent *QWidget) *QTimeEdit {
	g := newQTimeEdit(QTimeEdit_new4(time.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateEdit(parent *QWidget) *QDateEdit {
	g := newQDateEdit(QDateEdit_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateEdit3(date QDate) *QDateEdit {
	g := newQDateEdit(QDateEdit_new3(date.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDateEdit4(date QDate, parent *QWidget) *QDateEdit {
	g := newQDateEdit(QDateEdit_new4(date.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
