...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QMediaPlayer_MetaObject(const_cast<MiqtVirtualQMediaPlayer*>(this), handle__MetaObject);
...
void QMediaPlayer_connect_PlayingChanged(QMediaPlayer* self, intptr_t slot) {
	MiqtVirtualQMediaPlayer::connect(self, static_cast<void (QMediaPlayer::*)(bool)>(&QMediaPlayer::playingChanged), self, [=](bool playing) {
...
void QMediaPlayer_connect_AudioBufferOutputChanged(QMediaPlayer* self, intptr_t slot) {
	MiqtVirtualQMediaPlayer::connect(self, static_cast<void (QMediaPlayer::*)()>(&QMediaPlayer::audioBufferOutputChanged), self, [=]() {
...
void QMediaPlayer_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQMediaPlayer*>( (QMediaPlayer*)(self) )->handle__MetaObject = slot;
}
...
void QMediaPlayer_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQMediaPlayer*>( (QMediaPlayer*)(self) )->handle__Metacast = slot;
}
