...
QMetaObject* callback_return_value = miqt_exec_callback_QAudioDecoder_MetaObject(const_cast<MiqtVirtualQAudioDecoder*>(this), handle__MetaObject);
...
void QAudioDecoder_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAudioDecoder*>( (QAudioDecoder*)(self) )->handle__MetaObject = slot;
}
...
void QAudioDecoder_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAudioDecoder*>( (QAudioDecoder*)(self) )->handle__Metacast = slot;
}
