...
QMetaObject* callback_return_value = miqt_exec_callback_QMediaRecorder_MetaObject(const_cast<MiqtVirtualQMediaRecorder*>(this), handle__MetaObject);
...
void QMediaRecorder_connect_RecorderStateChanged(QMediaRecorder* self, intptr_t slot) {
	MiqtVirtualQMediaRecorder::connect(self, static_cast<void (QMediaRecorder::*)(RecorderState)>(&QMediaRecorder::recorderStateChanged), self, [=](RecorderState state) {
		RecorderState sigval1 = state;
...
void QMediaRecorder_ErrorOccurred(QMediaRecorder* self, Error error, struct miqt_string errorString) {
	...
	self->errorOccurred(error, errorString_QString);
}
void QMediaRecorder_connect_ErrorOccurred(QMediaRecorder* self, intptr_t slot) {
	MiqtVirtualQMediaRecorder::connect(self, static_cast<void (QMediaRecorder::*)(Error, const QString&)>(&QMediaRecorder::errorOccurred), self, [=](Error error, const QString& errorString) {
		Error sigval1 = error;
...
void QMediaRecorder_connect_AutoStopChanged(QMediaRecorder* self, intptr_t slot) {
	MiqtVirtualQMediaRecorder::connect(self, static_cast<void (QMediaRecorder::*)()>(&QMediaRecorder::autoStopChanged), self, [=]() {
...
void QMediaRecorder_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQMediaRecorder*>( (QMediaRecorder*)(self) )->handle__MetaObject = slot;
}
...
void QMediaRecorder_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQMediaRecorder*>( (QMediaRecorder*)(self) )->handle__Metacast = slot;
}
