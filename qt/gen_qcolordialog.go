...
func NewQColorDialog(parent *QWidget) *QColorDialog {
	g := newQColorDialog(QColorDialog_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQColorDialog2() *QColorDialog {
	g := newQColorDialog(QColorDialog_new2())
	g.isSubclass = true
	return g
}
...
func NewQColorDialog3(initial *QColor) *QColorDialog {
	g := newQColorDialog(QColorDialog_new3(initial.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQColorDialog4(initial *QColor, parent *QWidget) *QColorDialog {
	g := newQColorDialog(QColorDialog_new4(initial.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
