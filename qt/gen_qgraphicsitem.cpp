...
return new QGraphicsItem(parent);
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QGraphicsObject_MetaObject(const_cast<MiqtVirtualQGraphicsObject*>(this), handle__MetaObject);
...
void QGraphicsObject_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsObject*>( (QGraphicsObject*)(self) )->handle__MetaObject = slot;
}
...
void QGraphicsObject_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsObject*>( (QGraphicsObject*)(self) )->handle__Metacast = slot;
}
...
return new QAbstractGraphicsShapeItem();
}
QAbstractGraphicsShapeItem* QAbstractGraphicsShapeItem_new2(QGraphicsItem* parent) {
return new QAbstractGraphicsShapeItem(parent);
}
...
void QGraphicsPathItem_Delete(QGraphicsPathItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsPathItem*>( self );
	} else {
		delete self;
	}
}
...
void QGraphicsRectItem_Delete(QGraphicsRectItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsRectItem*>( self );
	} else {
		delete self;
	}
}
...
void QGraphicsEllipseItem_Delete(QGraphicsEllipseItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsEllipseItem*>( self );
	} else {
		delete self;
	}
}
...
void QGraphicsPolygonItem_Delete(QGraphicsPolygonItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsPolygonItem*>( self );
	} else {
		delete self;
	}
}
...
void QGraphicsLineItem_Delete(QGraphicsLineItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsLineItem*>( self );
	} else {
		delete self;
	}
}
...
void QGraphicsPixmapItem_Delete(QGraphicsPixmapItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsPixmapItem*>( self );
	} else {
		delete self;
	}
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QGraphicsTextItem_MetaObject(const_cast<MiqtVirtualQGraphicsTextItem*>(this), handle__MetaObject);
...
void QGraphicsTextItem_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsTextItem*>( (QGraphicsTextItem*)(self) )->handle__MetaObject = slot;
}
...
void QGraphicsTextItem_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsTextItem*>( (QGraphicsTextItem*)(self) )->handle__Metacast = slot;
}
...
void QGraphicsSimpleTextItem_Delete(QGraphicsSimpleTextItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsSimpleTextItem*>( self );
	} else {
		delete self;
	}
}
...
void QGraphicsItemGroup_Delete(QGraphicsItemGroup* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QGraphicsItemGroup*>( self );
	} else {
		delete self;
	}
}
