...
func (this *QFileDevice) MetaObject() *QMetaObject {
	return newQMetaObject(QFileDevice_MetaObject(this.h))
}

func (this *QFileDevice) Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := CString(param1)
	defer free(unsafe.Pointer(param1_Cstring))
	return (unsafe.Pointer)(QFileDevice_Metacast(this.h, param1_Cstring))
}

func QFileDevice_Tr(s string) string {
	s_Cstring := CString(s)
	defer free(unsafe.Pointer(s_Cstring))
	var _ms struct_miqt_string = QFileDevice_Tr(s_Cstring)
...
func (this *QFileDevice) UnsetError() {
	QFileDevice_UnsetError(this.h)
}

func (this *QFileDevice) Close() {
	QFileDevice_Close(this.h)
}

func (this *QFileDevice) IsSequential() bool {
	return (bool)(QFileDevice_IsSequential(this.h))
}

func (this *QFileDevice) Handle() int {
	return (int)(QFileDevice_Handle(this.h))
}

func (this *QFileDevice) FileName() string {
	var _ms struct_miqt_string = QFileDevice_FileName(this.h)
	_ret := GoStringN(_ms.data, int(int64(_ms.len)))
	free(unsafe.Pointer(_ms.data))
	return _ret
}
...
func (this *QFileDevice) Pos() int64 {
	return (int64)(QFileDevice_Pos(this.h))
}

func (this *QFileDevice) Seek(offset int64) bool {
	return (bool)(QFileDevice_Seek(this.h, (longlong)(offset)))
}

func (this *QFileDevice) AtEnd() bool {
	return (bool)(QFileDevice_AtEnd(this.h))
}

func (this *QFileDevice) Flush() bool {
	return (bool)(QFileDevice_Flush(this.h))
}

func (this *QFileDevice) Size() int64 {
	return (int64)(QFileDevice_Size(this.h))
}

func (this *QFileDevice) Resize(sz int64) bool {
	return (bool)(QFileDevice_Resize(this.h, (longlong)(sz)))
}
...
func (this *QFileDevice) SetPermissions(permissionSpec Permissions) bool {
	return (bool)(QFileDevice_SetPermissions(this.h, permissionSpec))
}

func (this *QFileDevice) Map(offset int64, size int64) *byte {
	return (*byte)(unsafe.Pointer(QFileDevice_Map(this.h, (longlong)(offset), (longlong)(size))))
}

func (this *QFileDevice) Unmap(address *byte) bool {
	return (bool)(QFileDevice_Unmap(this.h, (*uchar)(unsafe.Pointer(address))))
}

func (this *QFileDevice) FileTime(time QFileDevice__FileTime) *QDateTime {
	_goptr := newQDateTime(QFileDevice_FileTime(this.h, (int)(time)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QFileDevice) SetFileTime(newDate *QDateTime, fileTime QFileDevice__FileTime) bool {
	return (bool)(QFileDevice_SetFileTime(this.h, newDate.cPointer(), (int)(fileTime)))
}
...
func QFileDevice_Tr2(s string, c string) string {
	...
	var _ms struct_miqt_string = QFileDevice_Tr2(s_Cstring, c_Cstring)
	_ret := GoStringN(_ms.data, int(int64(_ms.len)))
	free(unsafe.Pointer(_ms.data))
	return _ret
}
...
func QFileDevice_Tr3(s string, c string, n int) string {
	...
	c_Cstring := CString(c)
	defer free(unsafe.Pointer(c_Cstring))
	var _ms struct_miqt_string = QFileDevice_Tr3(s_Cstring, c_Cstring, (int)(n))
	_ret := GoStringN(_ms.data, int(int64(_ms.len)))
	free(unsafe.Pointer(_ms.data))
	return _ret
}

func (this *QFileDevice) Map3(offset int64, size int64, flags MemoryMapFlags) *byte {
	return (*byte)(unsafe.Pointer(QFileDevice_Map3(this.h, (longlong)(offset), (longlong)(size), flags)))
}
