...
func NewQMargins2(left int, top int, right int, bottom int) *QMargins {
	g := newQMargins(QMargins_new2((int)(left), (int)(top), (int)(right), (int)(bottom)))
	g.isSubclass = true
	return g
}
...
func NewQMargins3(param1 *QMargins) *QMargins {
	g := newQMargins(QMargins_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMarginsF2(left float64, top float64, right float64, bottom float64) *QMarginsF {
	g := newQMarginsF(QMarginsF_new2((double)(left), (double)(top), (double)(right), (double)(bottom)))
	g.isSubclass = true
	return g
}
...
func NewQMarginsF3(margins *QMargins) *QMarginsF {
	g := newQMarginsF(QMarginsF_new3(margins.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMarginsF4(param1 *QMarginsF) *QMarginsF {
	g := newQMarginsF(QMarginsF_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
