...
func NewQJsonArray() *QJsonArray {
	g := newQJsonArray(QJsonArray_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonArray2(other *QJsonArray) *QJsonArray {
	g := newQJsonArray(QJsonArray_new2(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__iterator() *QJsonArray__iterator {
	g := newQJsonArray__iterator(QJsonArray__iterator_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__iterator2(array *QJsonArray, index int64) *QJsonArray__iterator {
	g := newQJsonArray__iterator(QJsonArray__iterator_new2(array.cPointer(), (ptrdiff_t)(index)))
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__iterator3(other *iterator) *QJsonArray__iterator {
	g := newQJsonArray__iterator(QJsonArray__iterator_new3(other))
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__const_iterator() *QJsonArray__const_iterator {
	g := newQJsonArray__const_iterator(QJsonArray__const_iterator_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__const_iterator2(array *QJsonArray, index int64) *QJsonArray__const_iterator {
	g := newQJsonArray__const_iterator(QJsonArray__const_iterator_new2(array.cPointer(), (ptrdiff_t)(index)))
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__const_iterator3(o *iterator) *QJsonArray__const_iterator {
	g := newQJsonArray__const_iterator(QJsonArray__const_iterator_new3(o))
	g.isSubclass = true
	return g
}
...
func NewQJsonArray__const_iterator4(other *const_iterator) *QJsonArray__const_iterator {
	g := newQJsonArray__const_iterator(QJsonArray__const_iterator_new4(other))
	g.isSubclass = true
	return g
}
