...
func NewQVariant2(typeVal QMetaType) *QVariant {
	g := newQVariant(QVariant_new2(typeVal.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant3(other *QVariant) *QVariant {
	g := newQVariant(QVariant_new3(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant4(i int) *QVariant {
	g := newQVariant(QVariant_new4((int)(i)))
	g.isSubclass = true
	return g
}
...
func NewQVariant5(ui uint) *QVariant {
	g := newQVariant(QVariant_new5((uint)(ui)))
	g.isSubclass = true
	return g
}
...
func NewQVariant6(ll int64) *QVariant {
	g := newQVariant(QVariant_new6((longlong)(ll)))
	g.isSubclass = true
	return g
}
...
func NewQVariant7(ull uint64) *QVariant {
	g := newQVariant(QVariant_new7((ulonglong)(ull)))
	g.isSubclass = true
	return g
}
...
func NewQVariant8(b bool) *QVariant {
	g := newQVariant(QVariant_new8((bool)(b)))
	g.isSubclass = true
	return g
}
...
func NewQVariant9(d float64) *QVariant {
	g := newQVariant(QVariant_new9((double)(d)))
	g.isSubclass = true
	return g
}
...
func NewQVariant10(f float32) *QVariant {
	g := newQVariant(QVariant_new10((float)(f)))
	g.isSubclass = true
	return g
}
...
func NewQVariant11(qchar QChar) *QVariant {
	g := newQVariant(QVariant_new11(qchar.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant12(date QDate) *QVariant {
	g := newQVariant(QVariant_new12(date.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant13(time QTime) *QVariant {
	g := newQVariant(QVariant_new13(time.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant14(bitarray *QBitArray) *QVariant {
	g := newQVariant(QVariant_new14(bitarray.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant15(bytearray []byte) *QVariant {
	...
	g := newQVariant(QVariant_new15(bytearray_alias))
	g.isSubclass = true
	return g
}
...
func NewQVariant16(datetime *QDateTime) *QVariant {
	g := newQVariant(QVariant_new16(datetime.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant17(hash map[string]QVariant) *QVariant {
	...
	g := newQVariant(QVariant_new17(hash_mm))
	g.isSubclass = true
	return g
}
...
func NewQVariant18(jsonArray *QJsonArray) *QVariant {
	g := newQVariant(QVariant_new18(jsonArray.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant19(jsonObject *QJsonObject) *QVariant {
	g := newQVariant(QVariant_new19(jsonObject.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant20(locale *QLocale) *QVariant {
	g := newQVariant(QVariant_new20(locale.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant21(mapVal map[string]QVariant) *QVariant {
	...
	g := newQVariant(QVariant_new21(mapVal_mm))
	g.isSubclass = true
	return g
}
...
func NewQVariant22(re *QRegularExpression) *QVariant {
	g := newQVariant(QVariant_new22(re.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant23(stringVal string) *QVariant {
	...
	g := newQVariant(QVariant_new23(stringVal_ms))
	g.isSubclass = true
	return g
}
...
func NewQVariant24(stringlist []string) *QVariant {
	...
	g := newQVariant(QVariant_new24(stringlist_ma))
	g.isSubclass = true
	return g
}
...
func NewQVariant25(url *QUrl) *QVariant {
	g := newQVariant(QVariant_new25(url.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant26(size QSize) *QVariant {
	g := newQVariant(QVariant_new26(size.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant27(pt QPoint) *QVariant {
	g := newQVariant(QVariant_new27(pt.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariant28(typeVal Type) *QVariant {
	g := newQVariant(QVariant_new28(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQVariant29(typeVal QMetaType, copyVal unsafe.Pointer) *QVariant {
	g := newQVariant(QVariant_new29(typeVal.cPointer(), copyVal))
	g.isSubclass = true
	return g
}
...
func NewQVariantConstPointer(variant QVariant) *QVariantConstPointer {
	g := newQVariantConstPointer(QVariantConstPointer_new(variant.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVariantConstPointer2(param1 *QVariantConstPointer) *QVariantConstPointer {
	g := newQVariantConstPointer(QVariantConstPointer_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
