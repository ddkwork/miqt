...
func NewQSocketNotifier(param1 Type) *QSocketNotifier {
	g := newQSocketNotifier(QSocketNotifier_new(param1))
	g.isSubclass = true
	return g
}
...
func NewQSocketNotifier2(socket uintptr, param2 Type) *QSocketNotifier {
	g := newQSocketNotifier(QSocketNotifier_new2((intptr_t)(socket), param2))
	g.isSubclass = true
	return g
}
...
func NewQSocketNotifier3(param1 Type, parent *QObject) *QSocketNotifier {
	g := newQSocketNotifier(QSocketNotifier_new3(param1, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSocketNotifier4(socket uintptr, param2 Type, parent *QObject) *QSocketNotifier {
	g := newQSocketNotifier(QSocketNotifier_new4((intptr_t)(socket), param2, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSocketDescriptor() *QSocketDescriptor {
	g := newQSocketDescriptor(QSocketDescriptor_new())
	g.isSubclass = true
	return g
}
...
func NewQSocketDescriptor2(desc uintptr) *QSocketDescriptor {
	g := newQSocketDescriptor(QSocketDescriptor_new2((intptr_t)(desc)))
	g.isSubclass = true
	return g
}
...
func NewQSocketDescriptor3(param1 *QSocketDescriptor) *QSocketDescriptor {
	g := newQSocketDescriptor(QSocketDescriptor_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSocketDescriptor4(descriptor DescriptorType) *QSocketDescriptor {
	g := newQSocketDescriptor(QSocketDescriptor_new4(descriptor))
	g.isSubclass = true
	return g
}
