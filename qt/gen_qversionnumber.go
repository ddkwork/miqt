...
g := newQVersionNumber(QVersionNumber_new())
				g.isSubclass = true
				return g
			}
...
g := newQVersionNumber(QVersionNumber_new2(args))
				g.isSubclass = true
				return g
			}
...
g := newQVersionNumber(QVersionNumber_new3((int)(maj)))
				g.isSubclass = true
				return g
			}
...
g := newQVersionNumber(QVersionNumber_new4((int)(maj), (int)(min)))
				g.isSubclass = true
				return g
			}
...
g := newQVersionNumber(QVersionNumber_new5((int)(maj), (int)(min), (int)(mic)))
				g.isSubclass = true
				return g
			}
