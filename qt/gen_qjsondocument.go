...
func NewQJsonDocument() *QJsonDocument {
	g := newQJsonDocument(QJsonDocument_new())
	g.isSubclass = true
	return g
}
...
func NewQJsonDocument2(object *QJsonObject) *QJsonDocument {
	g := newQJsonDocument(QJsonDocument_new2(object.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQJsonDocument3(array *QJsonArray) *QJsonDocument {
	g := newQJsonDocument(QJsonDocument_new3(array.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQJsonDocument4(other *QJsonDocument) *QJsonDocument {
	g := newQJsonDocument(QJsonDocument_new4(other.cPointer()))
	g.isSubclass = true
	return g
}
