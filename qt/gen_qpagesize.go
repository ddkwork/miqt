...
func NewQPageSize2(pageSizeId PageSizeId) *QPageSize {
	g := newQPageSize(QPageSize_new2(pageSizeId))
	g.isSubclass = true
	return g
}
...
func NewQPageSize3(pointSize *QSize) *QPageSize {
	g := newQPageSize(QPageSize_new3(pointSize.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPageSize4(size *QSizeF, units Unit) *QPageSize {
	g := newQPageSize(QPageSize_new4(size.cPointer(), units))
	g.isSubclass = true
	return g
}
...
func NewQPageSize5(other *QPageSize) *QPageSize {
	g := newQPageSize(QPageSize_new5(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPageSize6(pointSize *QSize, name string) *QPageSize {
	...
	g := newQPageSize(QPageSize_new6(pointSize.cPointer(), name_ms))
	g.isSubclass = true
	return g
}
...
func NewQPageSize7(pointSize *QSize, name string, matchPolicy SizeMatchPolicy) *QPageSize {
	...
	name_ms.len = size_t(len(name))
	defer free(unsafe.Pointer(name_ms.data))
	g := newQPageSize(QPageSize_new7(pointSize.cPointer(), name_ms, matchPolicy))
	g.isSubclass = true
	return g
}
...
func NewQPageSize8(size *QSizeF, units Unit, name string) *QPageSize {
	...
	name_ms.len = size_t(len(name))
	defer free(unsafe.Pointer(name_ms.data))
	g := newQPageSize(QPageSize_new8(size.cPointer(), units, name_ms))
	g.isSubclass = true
	return g
}
...
func NewQPageSize9(size *QSizeF, units Unit, name string, matchPolicy SizeMatchPolicy) *QPageSize {
	...
	name_ms.len = size_t(len(name))
	defer free(unsafe.Pointer(name_ms.data))
	g := newQPageSize(QPageSize_new9(size.cPointer(), units, name_ms, matchPolicy))
	g.isSubclass = true
	return g
}
