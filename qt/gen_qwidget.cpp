...
QMetaObject* callback_return_value = miqt_exec_callback_QWidget_MetaObject(const_cast<MiqtVirtualQWidget*>(this), handle__MetaObject);
...
void QWidget_virtbase(QWidget* src
...
void QWidget_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQWidget*>( (QWidget*)(self) )->handle__MetaObject = slot;
}
QMetaObject* QWidget_virtualbase_MetaObject(const void* self) {
	return ( (const MiqtVirtualQWidget*)(self) )->virtualbase_MetaObject();
}
void QWidget_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQWidget*>( (QWidget*)(self) )->handle__Metacast = slot;
}
