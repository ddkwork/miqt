...
func NewQDockWidget(parent *QWidget) *QDockWidget {
	g := newQDockWidget(QDockWidget_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDockWidget2(title string) *QDockWidget {
	...
	g := newQDockWidget(QDockWidget_new2(title_ms))
	g.isSubclass = true
	return g
}
...
func NewQDockWidget3() *QDockWidget {
	g := newQDockWidget(QDockWidget_new3())
	g.isSubclass = true
	return g
}
...
func NewQDockWidget4(title string, parent *QWidget) *QDockWidget {
	...
	title_ms.len = size_t(len(title))
	defer free(unsafe.Pointer(title_ms.data))
	g := newQDockWidget(QDockWidget_new4(title_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDockWidget5(title string, parent *QWidget, flags WindowType) *QDockWidget {
	...
	title_ms.len = size_t(len(title))
	defer free(unsafe.Pointer(title_ms.data))
	g := newQDockWidget(QDockWidget_new5(title_ms, parent.cPointer(), (int)(flags)))
	g.isSubclass = true
	return g
}
...
func NewQDockWidget6(parent *QWidget, flags WindowType) *QDockWidget {
	g := newQDockWidget(QDockWidget_new6(parent.cPointer(), (int)(flags)))
	g.isSubclass = true
	return g
}
