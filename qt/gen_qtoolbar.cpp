...
QMetaObject* callback_return_value = miqt_exec_callback_QToolBar_MetaObject(const_cast<MiqtVirtualQToolBar*>(this), handle__MetaObject);
...
void QToolBar_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQToolBar*>( (QToolBar*)(self) )->handle__MetaObject = slot;
}
...
void QToolBar_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQToolBar*>( (QToolBar*)(self) )->handle__Metacast = slot;
}
