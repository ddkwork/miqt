...
func NewQSplitter(parent *QWidget) *QSplitter {
	g := newQSplitter(QSplitter_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSplitter3(param1 Orientation) *QSplitter {
	g := newQSplitter(QSplitter_new3((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQSplitter4(param1 Orientation, parent *QWidget) *QSplitter {
	g := newQSplitter(QSplitter_new4((int)(param1), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSplitterHandle(o Orientation, parent *QSplitter) *QSplitterHandle {
	g := newQSplitterHandle(QSplitterHandle_new((int)(o), parent.cPointer()))
	g.isSubclass = true
	return g
}
