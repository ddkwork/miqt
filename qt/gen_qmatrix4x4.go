...
func NewQMatrix4x4() *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new())
	g.isSubclass = true
	return g
}
...
func NewQMatrix4x42(param1 Initialization) *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new2((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQMatrix4x43(values *float32) *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new3((*float)(unsafe.Pointer(values))))
	g.isSubclass = true
	return g
}
...
func NewQMatrix4x44(m11 float32, m12 float32, m13 float32, m14 float32, m21 float32, m22 float32, m23 float32, m24 float32, m31 float32, m32 float32, m33 float32, m34 float32, m41 float32, m42 float32, m43 float32, m44 float32) *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new4((float)(m11), (float)(m12), (float)(m13), (float)(m14), (float)(m21), (float)(m22), (float)(m23), (float)(m24), (float)(m31), (float)(m32), (float)(m33), (float)(m34), (float)(m41), (float)(m42), (float)(m43), (float)(m44)))
	g.isSubclass = true
	return g
}
...
func NewQMatrix4x45(values *float32, cols int, rows int) *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new5((*float)(unsafe.Pointer(values)), (int)(cols), (int)(rows)))
	g.isSubclass = true
	return g
}
...
func NewQMatrix4x46(transform *QTransform) *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new6(transform.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMatrix4x47(param1 *QMatrix4x4) *QMatrix4x4 {
	g := newQMatrix4x4(QMatrix4x4_new7(param1.cPointer()))
	g.isSubclass = true
	return g
}
