...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QAbstractItemDelegate_MetaObject(const_cast<MiqtVirtualQAbstractItemDelegate*>(this), handle__MetaObject);
...
void QAbstractItemDelegate_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractItemDelegate*>( (QAbstractItemDelegate*)(self) )->handle__MetaObject = slot;
}
...
void QAbstractItemDelegate_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractItemDelegate*>( (QAbstractItemDelegate*)(self) )->handle__Metacast = slot;
}
