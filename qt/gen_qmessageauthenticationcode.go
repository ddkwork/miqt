...
g := newQMessageAuthenticationCode(QMessageAuthenticationCode_new((int)(method)))
				g.isSubclass = true
				return g
			}
...
g := newQMessageAuthenticationCode(QMessageAuthenticationCode_new2((int)(method), key.cPointer()))
				g.isSubclass = true
				return g
			}
