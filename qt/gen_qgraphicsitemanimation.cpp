...
QMetaObject* callback_return_value = miqt_exec_callback_QGraphicsItemAnimation_MetaObject(const_cast<MiqtVirtualQGraphicsItemAnimation*>(this), handle__MetaObject);
...
void QGraphicsItemAnimation_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsItemAnimation*>( (QGraphicsItemAnimation*)(self) )->handle__MetaObject = slot;
}
...
void QGraphicsItemAnimation_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsItemAnimation*>( (QGraphicsItemAnimation*)(self) )->handle__Metacast = slot;
}
