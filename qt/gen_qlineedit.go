...
func NewQLineEdit(parent *QWidget) *QLineEdit {
	g := newQLineEdit(QLineEdit_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQLineEdit3(param1 string) *QLineEdit {
	...
	g := newQLineEdit(QLineEdit_new3(param1_ms))
	g.isSubclass = true
	return g
}
...
func NewQLineEdit4(param1 string, parent *QWidget) *QLineEdit {
	...
	param1_ms.len = size_t(len(param1))
	defer free(unsafe.Pointer(param1_ms.data))
	g := newQLineEdit(QLineEdit_new4(param1_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
