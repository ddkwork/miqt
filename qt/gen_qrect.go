...
func NewQRect2(topleft *QPoint, bottomright *QPoint) *QRect {
	g := newQRect(QRect_new2(topleft.cPointer(), bottomright.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRect3(topleft *QPoint, size *QSize) *QRect {
	g := newQRect(QRect_new3(topleft.cPointer(), size.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRect4(left int, top int, width int, height int) *QRect {
	g := newQRect(QRect_new4((int)(left), (int)(top), (int)(width), (int)(height)))
	g.isSubclass = true
	return g
}
...
func NewQRect5(param1 *QRect) *QRect {
	g := newQRect(QRect_new5(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRectF2(topleft *QPointF, size *QSizeF) *QRectF {
	g := newQRectF(QRectF_new2(topleft.cPointer(), size.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRectF3(topleft *QPointF, bottomRight *QPointF) *QRectF {
	g := newQRectF(QRectF_new3(topleft.cPointer(), bottomRight.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRectF4(left float64, top float64, width float64, height float64) *QRectF {
	g := newQRectF(QRectF_new4((double)(left), (double)(top), (double)(width), (double)(height)))
	g.isSubclass = true
	return g
}
...
func NewQRectF5(rect *QRect) *QRectF {
	g := newQRectF(QRectF_new5(rect.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRectF6(param1 *QRectF) *QRectF {
	g := newQRectF(QRectF_new6(param1.cPointer()))
	g.isSubclass = true
	return g
}
