...
func NewQItemSelectionRange() *QItemSelectionRange {
	g := newQItemSelectionRange(QItemSelectionRange_new())
	g.isSubclass = true
	return g
}
...
func NewQItemSelectionRange2(topL *QModelIndex, bottomR *QModelIndex) *QItemSelectionRange {
	g := newQItemSelectionRange(QItemSelectionRange_new2(topL.cPointer(), bottomR.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQItemSelectionRange3(index *QModelIndex) *QItemSelectionRange {
	g := newQItemSelectionRange(QItemSelectionRange_new3(index.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQItemSelectionModel() *QItemSelectionModel {
	g := newQItemSelectionModel(QItemSelectionModel_new())
	g.isSubclass = true
	return g
}
...
func NewQItemSelectionModel2(model *QAbstractItemModel, parent *QObject) *QItemSelectionModel {
	g := newQItemSelectionModel(QItemSelectionModel_new2(model.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQItemSelectionModel3(model *QAbstractItemModel) *QItemSelectionModel {
	g := newQItemSelectionModel(QItemSelectionModel_new3(model.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQItemSelection(topLeft *QModelIndex, bottomRight *QModelIndex) *QItemSelection {
	g := newQItemSelection(QItemSelection_new(topLeft.cPointer(), bottomRight.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQItemSelection2() *QItemSelection {
	g := newQItemSelection(QItemSelection_new2())
	g.isSubclass = true
	return g
}
...
func NewQItemSelection3(param1 *QItemSelection) *QItemSelection {
	g := newQItemSelection(QItemSelection_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
