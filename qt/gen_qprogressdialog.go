...
func NewQProgressDialog(parent *QWidget) *QProgressDialog {
	g := newQProgressDialog(QProgressDialog_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQProgressDialog2() *QProgressDialog {
	g := newQProgressDialog(QProgressDialog_new2())
	g.isSubclass = true
	return g
}
...
func NewQProgressDialog3(labelText string, cancelButtonText string, minimum int, maximum int) *QProgressDialog {
	...
	g := newQProgressDialog(QProgressDialog_new3(labelText_ms, cancelButtonText_ms, (int)(minimum), (int)(maximum)))
	g.isSubclass = true
	return g
}
...
func NewQProgressDialog4(parent *QWidget, flags WindowType) *QProgressDialog {
	g := newQProgressDialog(QProgressDialog_new4(parent.cPointer(), (int)(flags)))
	g.isSubclass = true
	return g
}
...
func NewQProgressDialog5(labelText string, cancelButtonText string, minimum int, maximum int, parent *QWidget) *QProgressDialog {
	...
	cancelButtonText_ms.len = size_t(len(cancelButtonText))
	defer free(unsafe.Pointer(cancelButtonText_ms.data))
	g := newQProgressDialog(QProgressDialog_new5(labelText_ms, cancelButtonText_ms, (int)(minimum), (int)(maximum), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQProgressDialog6(labelText string, cancelButtonText string, minimum int, maximum int, parent *QWidget, flags WindowType) *QProgressDialog {
	...
	cancelButtonText_ms.len = size_t(len(cancelButtonText))
	defer free(unsafe.Pointer(cancelButtonText_ms.data))
	g := newQProgressDialog(QProgressDialog_new6(labelText_ms, cancelButtonText_ms, (int)(minimum), (int)(maximum), parent.cPointer(), (int)(flags)))
	g.isSubclass = true
	return g
}
