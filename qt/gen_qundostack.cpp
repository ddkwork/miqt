...
void QUndoCommand_Delete(QUndoCommand* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QUndoCommand*>( self );
	} else {
		delete self;
	}
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QUndoStack_MetaObject(const_cast<MiqtVirtualQUndoStack*>(this), handle__MetaObject);
...
void QUndoStack_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQUndoStack*>( (QUndoStack*)(self) )->handle__MetaObject = slot;
}
...
void QUndoStack_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQUndoStack*>( (QUndoStack*)(self) )->handle__Metacast = slot;
}
