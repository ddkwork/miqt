...
QMetaObject* callback_return_value = miqt_exec_callback_QGraphicsScene_MetaObject(const_cast<MiqtVirtualQGraphicsScene*>(this), handle__MetaObject);
...
void QGraphicsScene_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsScene*>( (QGraphicsScene*)(self) )->handle__MetaObject = slot;
}
...
void QGraphicsScene_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsScene*>( (QGraphicsScene*)(self) )->handle__Metacast = slot;
}
