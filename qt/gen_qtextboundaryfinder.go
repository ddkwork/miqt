...
func NewQTextBoundaryFinder() *QTextBoundaryFinder {
	g := newQTextBoundaryFinder(QTextBoundaryFinder_new())
	g.isSubclass = true
	return g
}
...
func NewQTextBoundaryFinder2(other *QTextBoundaryFinder) *QTextBoundaryFinder {
	g := newQTextBoundaryFinder(QTextBoundaryFinder_new2(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextBoundaryFinder3(typeVal BoundaryType, stringVal string) *QTextBoundaryFinder {
	...
	g := newQTextBoundaryFinder(QTextBoundaryFinder_new3(typeVal, stringVal_ms))
	g.isSubclass = true
	return g
}
...
func NewQTextBoundaryFinder4(typeVal BoundaryType, chars *QChar, length int64) *QTextBoundaryFinder {
	g := newQTextBoundaryFinder(QTextBoundaryFinder_new4(typeVal, chars.cPointer(), (ptrdiff_t)(length)))
	g.isSubclass = true
	return g
}
...
func NewQTextBoundaryFinder5(typeVal BoundaryType, chars *QChar, length int64, buffer *byte) *QTextBoundaryFinder {
	g := newQTextBoundaryFinder(QTextBoundaryFinder_new5(typeVal, chars.cPointer(), (ptrdiff_t)(length), (*uchar)(unsafe.Pointer(buffer))))
	g.isSubclass = true
	return g
}
...
func NewQTextBoundaryFinder6(typeVal BoundaryType, chars *QChar, length int64, buffer *byte, bufferSize int64) *QTextBoundaryFinder {
	g := newQTextBoundaryFinder(QTextBoundaryFinder_new6(typeVal, chars.cPointer(), (ptrdiff_t)(length), (*uchar)(unsafe.Pointer(buffer)), (ptrdiff_t)(bufferSize)))
	g.isSubclass = true
	return g
}
