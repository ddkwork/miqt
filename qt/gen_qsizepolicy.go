...
func NewQSizePolicy() *QSizePolicy {
	g := newQSizePolicy(QSizePolicy_new())
	g.isSubclass = true
	return g
}
...
func NewQSizePolicy2(horizontal Policy, vertical Policy) *QSizePolicy {
	g := newQSizePolicy(QSizePolicy_new2(horizontal, vertical))
	g.isSubclass = true
	return g
}
...
func NewQSizePolicy3(param1 *QSizePolicy) *QSizePolicy {
	g := newQSizePolicy(QSizePolicy_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQSizePolicy4(horizontal Policy, vertical Policy, typeVal ControlType) *QSizePolicy {
	g := newQSizePolicy(QSizePolicy_new4(horizontal, vertical, typeVal))
	g.isSubclass = true
	return g
}
