...
QMetaObject* callback_return_value = miqt_exec_callback_QGraphicsView_MetaObject(const_cast<MiqtVirtualQGraphicsView*>(this), handle__MetaObject);
...
void QGraphicsView_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsView*>( (QGraphicsView*)(self) )->handle__MetaObject = slot;
}
...
void QGraphicsView_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGraphicsView*>( (QGraphicsView*)(self) )->handle__Metacast = slot;
}
