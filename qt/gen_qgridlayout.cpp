...
QMetaObject* callback_return_value = miqt_exec_callback_QGridLayout_MetaObject(const_cast<MiqtVirtualQGridLayout*>(this), handle__MetaObject);
...
void QGridLayout_virtbase(QGridLayout* src
...
void QGridLayout_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGridLayout*>( (QGridLayout*)(self) )->handle__MetaObject = slot;
}
...
void QGridLayout_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQGridLayout*>( (QGridLayout*)(self) )->handle__Metacast = slot;
}
