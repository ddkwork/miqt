...
func NewQPlainTextEdit(parent *QWidget) *QPlainTextEdit {
	g := newQPlainTextEdit(QPlainTextEdit_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPlainTextEdit2() *QPlainTextEdit {
	g := newQPlainTextEdit(QPlainTextEdit_new2())
	g.isSubclass = true
	return g
}
...
func NewQPlainTextEdit3(text string) *QPlainTextEdit {
	...
	g := newQPlainTextEdit(QPlainTextEdit_new3(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQPlainTextEdit4(text string, parent *QWidget) *QPlainTextEdit {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQPlainTextEdit(QPlainTextEdit_new4(text_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPlainTextDocumentLayout(document *QTextDocument) *QPlainTextDocumentLayout {
	g := newQPlainTextDocumentLayout(QPlainTextDocumentLayout_new(document.cPointer()))
	g.isSubclass = true
	return g
}
