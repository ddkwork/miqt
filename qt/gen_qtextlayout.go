...
func NewQTextInlineObject() *QTextInlineObject {
	g := newQTextInlineObject(QTextInlineObject_new())
	g.isSubclass = true
	return g
}
...
func NewQTextLayout() *QTextLayout {
	g := newQTextLayout(QTextLayout_new())
	g.isSubclass = true
	return g
}
...
func NewQTextLayout2(text string) *QTextLayout {
	...
	g := newQTextLayout(QTextLayout_new2(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQTextLayout3(text string, font *QFont) *QTextLayout {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQTextLayout(QTextLayout_new3(text_ms, font.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextLayout4(b *QTextBlock) *QTextLayout {
	g := newQTextLayout(QTextLayout_new4(b.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextLayout5(text string, font *QFont, paintdevice *QPaintDevice) *QTextLayout {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQTextLayout(QTextLayout_new5(text_ms, font.cPointer(), paintdevice.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextLayout__FormatRange() *QTextLayout__FormatRange {
	g := newQTextLayout__FormatRange(QTextLayout__FormatRange_new())
	g.isSubclass = true
	return g
}
