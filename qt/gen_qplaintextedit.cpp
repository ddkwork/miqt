...
QMetaObject* callback_return_value = miqt_exec_callback_QPlainTextEdit_MetaObject(const_cast<MiqtVirtualQPlainTextEdit*>(this), handle__MetaObject);
...
void QPlainTextEdit_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQPlainTextEdit*>( (QPlainTextEdit*)(self) )->handle__MetaObject = slot;
}
...
void QPlainTextEdit_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQPlainTextEdit*>( (QPlainTextEdit*)(self) )->handle__Metacast = slot;
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QPlainTextDocumentLayout_MetaObject(const_cast<MiqtVirtualQPlainTextDocumentLayout*>(this), handle__MetaObject);
...
void QPlainTextDocumentLayout_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQPlainTextDocumentLayout*>( (QPlainTextDocumentLayout*)(self) )->handle__MetaObject = slot;
}
...
void QPlainTextDocumentLayout_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQPlainTextDocumentLayout*>( (QPlainTextDocumentLayout*)(self) )->handle__Metacast = slot;
}
