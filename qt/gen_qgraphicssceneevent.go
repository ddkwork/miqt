...
func NewQGraphicsSceneEvent(typeVal Type) *QGraphicsSceneEvent {
	g := newQGraphicsSceneEvent(QGraphicsSceneEvent_new(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneMouseEvent() *QGraphicsSceneMouseEvent {
	g := newQGraphicsSceneMouseEvent(QGraphicsSceneMouseEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneMouseEvent2(typeVal Type) *QGraphicsSceneMouseEvent {
	g := newQGraphicsSceneMouseEvent(QGraphicsSceneMouseEvent_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneWheelEvent() *QGraphicsSceneWheelEvent {
	g := newQGraphicsSceneWheelEvent(QGraphicsSceneWheelEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneWheelEvent2(typeVal Type) *QGraphicsSceneWheelEvent {
	g := newQGraphicsSceneWheelEvent(QGraphicsSceneWheelEvent_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneContextMenuEvent() *QGraphicsSceneContextMenuEvent {
	g := newQGraphicsSceneContextMenuEvent(QGraphicsSceneContextMenuEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneContextMenuEvent2(typeVal Type) *QGraphicsSceneContextMenuEvent {
	g := newQGraphicsSceneContextMenuEvent(QGraphicsSceneContextMenuEvent_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneHoverEvent() *QGraphicsSceneHoverEvent {
	g := newQGraphicsSceneHoverEvent(QGraphicsSceneHoverEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneHoverEvent2(typeVal Type) *QGraphicsSceneHoverEvent {
	g := newQGraphicsSceneHoverEvent(QGraphicsSceneHoverEvent_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneHelpEvent() *QGraphicsSceneHelpEvent {
	g := newQGraphicsSceneHelpEvent(QGraphicsSceneHelpEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneHelpEvent2(typeVal Type) *QGraphicsSceneHelpEvent {
	g := newQGraphicsSceneHelpEvent(QGraphicsSceneHelpEvent_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneDragDropEvent() *QGraphicsSceneDragDropEvent {
	g := newQGraphicsSceneDragDropEvent(QGraphicsSceneDragDropEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneDragDropEvent2(typeVal Type) *QGraphicsSceneDragDropEvent {
	g := newQGraphicsSceneDragDropEvent(QGraphicsSceneDragDropEvent_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneResizeEvent() *QGraphicsSceneResizeEvent {
	g := newQGraphicsSceneResizeEvent(QGraphicsSceneResizeEvent_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsSceneMoveEvent() *QGraphicsSceneMoveEvent {
	g := newQGraphicsSceneMoveEvent(QGraphicsSceneMoveEvent_new())
	g.isSubclass = true
	return g
}
