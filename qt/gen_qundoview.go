...
func NewQUndoView(parent *QWidget) *QUndoView {
	g := newQUndoView(QUndoView_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQUndoView3(stack *QUndoStack) *QUndoView {
	g := newQUndoView(QUndoView_new3(stack.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQUndoView4(group *QUndoGroup) *QUndoView {
	g := newQUndoView(QUndoView_new4(group.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQUndoView5(stack *QUndoStack, parent *QWidget) *QUndoView {
	g := newQUndoView(QUndoView_new5(stack.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQUndoView6(group *QUndoGroup, parent *QWidget) *QUndoView {
	g := newQUndoView(QUndoView_new6(group.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
