...
func NewQTextOption() *QTextOption {
	g := newQTextOption(QTextOption_new())
	g.isSubclass = true
	return g
}
...
func NewQTextOption2(alignment AlignmentFlag) *QTextOption {
	g := newQTextOption(QTextOption_new2((int)(alignment)))
	g.isSubclass = true
	return g
}
...
func NewQTextOption3(o *QTextOption) *QTextOption {
	g := newQTextOption(QTextOption_new3(o.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextOption__Tab() *QTextOption__Tab {
	g := newQTextOption__Tab(QTextOption__Tab_new())
	g.isSubclass = true
	return g
}
...
func NewQTextOption__Tab2(pos float64, tabType TabType) *QTextOption__Tab {
	g := newQTextOption__Tab(QTextOption__Tab_new2((double)(pos), tabType))
	g.isSubclass = true
	return g
}
...
func NewQTextOption__Tab3(pos float64, tabType TabType, delim QChar) *QTextOption__Tab {
	g := newQTextOption__Tab(QTextOption__Tab_new3((double)(pos), tabType, delim.cPointer()))
	g.isSubclass = true
	return g
}
