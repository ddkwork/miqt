...
func NewQEventPoint() *QEventPoint {
	g := newQEventPoint(QEventPoint_new())
	g.isSubclass = true
	return g
}
...
func NewQEventPoint2(pointId int, state State, scenePosition *QPointF, globalPosition *QPointF) *QEventPoint {
	g := newQEventPoint(QEventPoint_new2((int)(pointId), state, scenePosition.cPointer(), globalPosition.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQEventPoint3(other *QEventPoint) *QEventPoint {
	g := newQEventPoint(QEventPoint_new3(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQEventPoint4(id int) *QEventPoint {
	g := newQEventPoint(QEventPoint_new4((int)(id)))
	g.isSubclass = true
	return g
}
...
func NewQEventPoint5(id int, device *QPointingDevice) *QEventPoint {
	g := newQEventPoint(QEventPoint_new5((int)(id), device.cPointer()))
	g.isSubclass = true
	return g
}
