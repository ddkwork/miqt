...
QMetaObject* callback_return_value = miqt_exec_callback_QTreeView_MetaObject(const_cast<MiqtVirtualQTreeView*>(this), handle__MetaObject);
...
void QTreeView_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQTreeView*>( (QTreeView*)(self) )->handle__MetaObject = slot;
}
...
void QTreeView_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQTreeView*>( (QTreeView*)(self) )->handle__Metacast = slot;
}
