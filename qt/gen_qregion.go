...
g := newQRegion(QRegion_new2((int)(x), (int)(y), (int)(w), (int)(h)))
				g.isSubclass = true
				return g
			}
...
g := newQRegion(QRegion_new3(r.cPointer()))
				g.isSubclass = true
				return g
			}
...
g := newQRegion(QRegion_new4(region.cPointer()))
				g.isSubclass = true
				return g
			}
...
g := newQRegion(QRegion_new5(bitmap.cPointer()))
				g.isSubclass = true
				return g
			}
...
g := newQRegion(QRegion_new6((int)(x), (int)(y), (int)(w), (int)(h), t))
				g.isSubclass = true
				return g
			}
...
g := newQRegion(QRegion_new7(r.cPointer(), t))
				g.isSubclass = true
				return g
			}
