...
func NewQModelRoleData(role int) *QModelRoleData {
	g := newQModelRoleData(QModelRoleData_new((int)(role)))
	g.isSubclass = true
	return g
}
...
func NewQModelRoleDataSpan() *QModelRoleDataSpan {
	g := newQModelRoleDataSpan(QModelRoleDataSpan_new())
	g.isSubclass = true
	return g
}
...
func NewQModelRoleDataSpan2(modelRoleData *QModelRoleData) *QModelRoleDataSpan {
	g := newQModelRoleDataSpan(QModelRoleDataSpan_new2(modelRoleData.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQModelRoleDataSpan3(modelRoleData *QModelRoleData, lenVal int64) *QModelRoleDataSpan {
	g := newQModelRoleDataSpan(QModelRoleDataSpan_new3(modelRoleData.cPointer(), (ptrdiff_t)(lenVal)))
	g.isSubclass = true
	return g
}
...
func NewQModelRoleDataSpan4(param1 *QModelRoleDataSpan) *QModelRoleDataSpan {
	g := newQModelRoleDataSpan(QModelRoleDataSpan_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQModelIndex() *QModelIndex {
	g := newQModelIndex(QModelIndex_new())
	g.isSubclass = true
	return g
}
...
func NewQModelIndex2(param1 *QModelIndex) *QModelIndex {
	g := newQModelIndex(QModelIndex_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPersistentModelIndex() *QPersistentModelIndex {
	g := newQPersistentModelIndex(QPersistentModelIndex_new())
	g.isSubclass = true
	return g
}
...
func NewQPersistentModelIndex2(index *QModelIndex) *QPersistentModelIndex {
	g := newQPersistentModelIndex(QPersistentModelIndex_new2(index.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPersistentModelIndex3(other *QPersistentModelIndex) *QPersistentModelIndex {
	g := newQPersistentModelIndex(QPersistentModelIndex_new3(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQAbstractItemModel() *QAbstractItemModel {
	g := newQAbstractItemModel(QAbstractItemModel_new())
	g.isSubclass = true
	return g
}
...
func NewQAbstractItemModel2(parent *QObject) *QAbstractItemModel {
	g := newQAbstractItemModel(QAbstractItemModel_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQAbstractTableModel() *QAbstractTableModel {
	g := newQAbstractTableModel(QAbstractTableModel_new())
	g.isSubclass = true
	return g
}
...
func NewQAbstractTableModel2(parent *QObject) *QAbstractTableModel {
	g := newQAbstractTableModel(QAbstractTableModel_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQAbstractListModel() *QAbstractListModel {
	g := newQAbstractListModel(QAbstractListModel_new())
	g.isSubclass = true
	return g
}
...
func NewQAbstractListModel2(parent *QObject) *QAbstractListModel {
	g := newQAbstractListModel(QAbstractListModel_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
