...
func NewQFontMetrics(param1 *QFont) *QFontMetrics {
	g := newQFontMetrics(QFontMetrics_new(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFontMetrics2(font *QFont, pd *QPaintDevice) *QFontMetrics {
	g := newQFontMetrics(QFontMetrics_new2(font.cPointer(), pd.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFontMetrics3(param1 *QFontMetrics) *QFontMetrics {
	g := newQFontMetrics(QFontMetrics_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFontMetricsF(font *QFont) *QFontMetricsF {
	g := newQFontMetricsF(QFontMetricsF_new(font.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFontMetricsF2(font *QFont, pd *QPaintDevice) *QFontMetricsF {
	g := newQFontMetricsF(QFontMetricsF_new2(font.cPointer(), pd.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFontMetricsF3(param1 *QFontMetrics) *QFontMetricsF {
	g := newQFontMetricsF(QFontMetricsF_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFontMetricsF4(param1 *QFontMetricsF) *QFontMetricsF {
	g := newQFontMetricsF(QFontMetricsF_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
