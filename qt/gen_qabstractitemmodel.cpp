...
QMetaObject* callback_return_value = miqt_exec_callback_QAbstractItemModel_MetaObject(const_cast<MiqtVirtualQAbstractItemModel*>(this), handle__MetaObject);
...
void QAbstractItemModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractItemModel*>( (QAbstractItemModel*)(self) )->handle__MetaObject = slot;
}
...
void QAbstractItemModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractItemModel*>( (QAbstractItemModel*)(self) )->handle__Metacast = slot;
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QAbstractTableModel_MetaObject(const_cast<MiqtVirtualQAbstractTableModel*>(this), handle__MetaObject);
...
void QAbstractTableModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractTableModel*>( (QAbstractTableModel*)(self) )->handle__MetaObject = slot;
}
...
void QAbstractTableModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractTableModel*>( (QAbstractTableModel*)(self) )->handle__Metacast = slot;
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QAbstractListModel_MetaObject(const_cast<MiqtVirtualQAbstractListModel*>(this), handle__MetaObject);
...
void QAbstractListModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractListModel*>( (QAbstractListModel*)(self) )->handle__MetaObject = slot;
}
...
void QAbstractListModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractListModel*>( (QAbstractListModel*)(self) )->handle__Metacast = slot;
}
