...
func NewQVector2D2(param1 Initialization) *QVector2D {
	g := newQVector2D(QVector2D_new2((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQVector2D3(xpos float32, ypos float32) *QVector2D {
	g := newQVector2D(QVector2D_new3((float)(xpos), (float)(ypos)))
	g.isSubclass = true
	return g
}
...
func NewQVector2D4(point QPoint) *QVector2D {
	g := newQVector2D(QVector2D_new4(point.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector2D5(point QPointF) *QVector2D {
	g := newQVector2D(QVector2D_new5(point.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector2D6(vector QVector3D) *QVector2D {
	g := newQVector2D(QVector2D_new6(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector2D7(vector QVector4D) *QVector2D {
	g := newQVector2D(QVector2D_new7(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector2D8(param1 *QVector2D) *QVector2D {
	g := newQVector2D(QVector2D_new8(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector3D2(param1 Initialization) *QVector3D {
	g := newQVector3D(QVector3D_new2((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQVector3D3(xpos float32, ypos float32, zpos float32) *QVector3D {
	g := newQVector3D(QVector3D_new3((float)(xpos), (float)(ypos), (float)(zpos)))
	g.isSubclass = true
	return g
}
...
func NewQVector3D4(point QPoint) *QVector3D {
	g := newQVector3D(QVector3D_new4(point.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector3D5(point QPointF) *QVector3D {
	g := newQVector3D(QVector3D_new5(point.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector3D6(vector QVector2D) *QVector3D {
	g := newQVector3D(QVector3D_new6(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector3D7(vector QVector2D, zpos float32) *QVector3D {
	g := newQVector3D(QVector3D_new7(vector.cPointer(), (float)(zpos)))
	g.isSubclass = true
	return g
}
...
func NewQVector3D8(vector QVector4D) *QVector3D {
	g := newQVector3D(QVector3D_new8(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector3D9(param1 *QVector3D) *QVector3D {
	g := newQVector3D(QVector3D_new9(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector4D2(param1 Initialization) *QVector4D {
	g := newQVector4D(QVector4D_new2((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQVector4D3(xpos float32, ypos float32, zpos float32, wpos float32) *QVector4D {
	g := newQVector4D(QVector4D_new3((float)(xpos), (float)(ypos), (float)(zpos), (float)(wpos)))
	g.isSubclass = true
	return g
}
...
func NewQVector4D4(point QPoint) *QVector4D {
	g := newQVector4D(QVector4D_new4(point.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector4D5(point QPointF) *QVector4D {
	g := newQVector4D(QVector4D_new5(point.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector4D6(vector QVector2D) *QVector4D {
	g := newQVector4D(QVector4D_new6(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector4D7(vector QVector2D, zpos float32, wpos float32) *QVector4D {
	g := newQVector4D(QVector4D_new7(vector.cPointer(), (float)(zpos), (float)(wpos)))
	g.isSubclass = true
	return g
}
...
func NewQVector4D8(vector QVector3D) *QVector4D {
	g := newQVector4D(QVector4D_new8(vector.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQVector4D9(vector QVector3D, wpos float32) *QVector4D {
	g := newQVector4D(QVector4D_new9(vector.cPointer(), (float)(wpos)))
	g.isSubclass = true
	return g
}
...
func NewQVector4D10(param1 *QVector4D) *QVector4D {
	g := newQVector4D(QVector4D_new10(param1.cPointer()))
	g.isSubclass = true
	return g
}
