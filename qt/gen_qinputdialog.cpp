...
QMetaObject* callback_return_value = miqt_exec_callback_QInputDialog_MetaObject(const_cast<MiqtVirtualQInputDialog*>(this), handle__MetaObject);
...
void QInputDialog_virtbase(QInputDialog* src
...
void QInputDialog_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQInputDialog*>( (QInputDialog*)(self) )->handle__MetaObject = slot;
}
...
void QInputDialog_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQInputDialog*>( (QInputDialog*)(self) )->handle__Metacast = slot;
}
