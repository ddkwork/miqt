...
func NewQXmlStreamAttribute() *QXmlStreamAttribute {
	g := newQXmlStreamAttribute(QXmlStreamAttribute_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamAttribute2(qualifiedName string, value string) *QXmlStreamAttribute {
	...
	g := newQXmlStreamAttribute(QXmlStreamAttribute_new2(qualifiedName_ms, value_ms))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamAttribute3(namespaceUri string, name string, value string) *QXmlStreamAttribute {
	...
	value_ms.len = size_t(len(value))
	defer free(unsafe.Pointer(value_ms.data))
	g := newQXmlStreamAttribute(QXmlStreamAttribute_new3(namespaceUri_ms, name_ms, value_ms))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamAttribute4(param1 *QXmlStreamAttribute) *QXmlStreamAttribute {
	g := newQXmlStreamAttribute(QXmlStreamAttribute_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamNamespaceDeclaration() *QXmlStreamNamespaceDeclaration {
	g := newQXmlStreamNamespaceDeclaration(QXmlStreamNamespaceDeclaration_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamNamespaceDeclaration2(prefix string, namespaceUri string) *QXmlStreamNamespaceDeclaration {
	...
	namespaceUri_ms.len = size_t(len(namespaceUri))
	defer free(unsafe.Pointer(namespaceUri_ms.data))
	g := newQXmlStreamNamespaceDeclaration(QXmlStreamNamespaceDeclaration_new2(prefix_ms, namespaceUri_ms))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamNamespaceDeclaration3(param1 *QXmlStreamNamespaceDeclaration) *QXmlStreamNamespaceDeclaration {
	g := newQXmlStreamNamespaceDeclaration(QXmlStreamNamespaceDeclaration_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamNotationDeclaration() *QXmlStreamNotationDeclaration {
	g := newQXmlStreamNotationDeclaration(QXmlStreamNotationDeclaration_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamNotationDeclaration2(param1 *QXmlStreamNotationDeclaration) *QXmlStreamNotationDeclaration {
	g := newQXmlStreamNotationDeclaration(QXmlStreamNotationDeclaration_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamEntityDeclaration() *QXmlStreamEntityDeclaration {
	g := newQXmlStreamEntityDeclaration(QXmlStreamEntityDeclaration_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamEntityDeclaration2(param1 *QXmlStreamEntityDeclaration) *QXmlStreamEntityDeclaration {
	g := newQXmlStreamEntityDeclaration(QXmlStreamEntityDeclaration_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamEntityResolver() *QXmlStreamEntityResolver {
	g := newQXmlStreamEntityResolver(QXmlStreamEntityResolver_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamReader() *QXmlStreamReader {
	g := newQXmlStreamReader(QXmlStreamReader_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamReader2(device *QIODevice) *QXmlStreamReader {
	g := newQXmlStreamReader(QXmlStreamReader_new2(device.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamReader3(data QAnyStringView) *QXmlStreamReader {
	g := newQXmlStreamReader(QXmlStreamReader_new3(data.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamWriter() *QXmlStreamWriter {
	g := newQXmlStreamWriter(QXmlStreamWriter_new())
	g.isSubclass = true
	return g
}
...
func NewQXmlStreamWriter2(device *QIODevice) *QXmlStreamWriter {
	g := newQXmlStreamWriter(QXmlStreamWriter_new2(device.cPointer()))
	g.isSubclass = true
	return g
}
