...
g := newQMessageLogContext(QMessageLogContext_new())
				g.isSubclass = true
				return g
			}
...
g := newQMessageLogContext(QMessageLogContext_new2(fileName_Cstring, (int)(lineNumber), functionName_Cstring, categoryName_Cstring))
				g.isSubclass = true
				return g
			}
...
g := newQMessageLogger(QMessageLogger_new())
				g.isSubclass = true
				return g
			}
...
g := newQMessageLogger(QMessageLogger_new2(file_Cstring, (int)(line), function_Cstring))
				g.isSubclass = true
				return g
			}
...
g := newQMessageLogger(QMessageLogger_new3(file_Cstring, (int)(line), function_Cstring, category_Cstring))
				g.isSubclass = true
				return g
			}
