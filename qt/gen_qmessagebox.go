...
func NewQMessageBox(parent *QWidget) *QMessageBox {
	g := newQMessageBox(QMessageBox_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox2() *QMessageBox {
	g := newQMessageBox(QMessageBox_new2())
	g.isSubclass = true
	return g
}
...
func NewQMessageBox3(icon Icon, title string, text string) *QMessageBox {
	...
	g := newQMessageBox(QMessageBox_new3(icon, title_ms, text_ms))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox4(title string, text string, icon Icon, button0 int, button1 int, button2 int) *QMessageBox {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQMessageBox(QMessageBox_new4(title_ms, text_ms, icon, (int)(button0), (int)(button1), (int)(button2)))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox5(icon Icon, title string, text string, buttons StandardButtons) *QMessageBox {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQMessageBox(QMessageBox_new5(icon, title_ms, text_ms, buttons))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox6(icon Icon, title string, text string, buttons StandardButtons, parent *QWidget) *QMessageBox {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQMessageBox(QMessageBox_new6(icon, title_ms, text_ms, buttons, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox7(icon Icon, title string, text string, buttons StandardButtons, parent *QWidget, flags WindowType) *QMessageBox {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQMessageBox(QMessageBox_new7(icon, title_ms, text_ms, buttons, parent.cPointer(), (int)(flags)))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox8(title string, text string, icon Icon, button0 int, button1 int, button2 int, parent *QWidget) *QMessageBox {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQMessageBox(QMessageBox_new8(title_ms, text_ms, icon, (int)(button0), (int)(button1), (int)(button2), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMessageBox9(title string, text string, icon Icon, button0 int, button1 int, button2 int, parent *QWidget, f WindowType) *QMessageBox {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQMessageBox(QMessageBox_new9(title_ms, text_ms, icon, (int)(button0), (int)(button1), (int)(button2), parent.cPointer(), (int)(f)))
	g.isSubclass = true
	return g
}
