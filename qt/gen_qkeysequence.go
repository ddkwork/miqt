...
func NewQKeySequence() *QKeySequence {
	g := newQKeySequence(QKeySequence_new())
	g.isSubclass = true
	return g
}
...
func NewQKeySequence2(key string) *QKeySequence {
	...
	g := newQKeySequence(QKeySequence_new2(key_ms))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence3(k1 int) *QKeySequence {
	g := newQKeySequence(QKeySequence_new3((int)(k1)))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence4(k1 QKeyCombination) *QKeySequence {
	g := newQKeySequence(QKeySequence_new4(k1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence5(ks *QKeySequence) *QKeySequence {
	g := newQKeySequence(QKeySequence_new5(ks.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence6(key StandardKey) *QKeySequence {
	g := newQKeySequence(QKeySequence_new6(key))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence7(key string, format SequenceFormat) *QKeySequence {
	...
	key_ms.len = size_t(len(key))
	defer free(unsafe.Pointer(key_ms.data))
	g := newQKeySequence(QKeySequence_new7(key_ms, format))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence8(k1 int, k2 int) *QKeySequence {
	g := newQKeySequence(QKeySequence_new8((int)(k1), (int)(k2)))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence9(k1 int, k2 int, k3 int) *QKeySequence {
	g := newQKeySequence(QKeySequence_new9((int)(k1), (int)(k2), (int)(k3)))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence10(k1 int, k2 int, k3 int, k4 int) *QKeySequence {
	g := newQKeySequence(QKeySequence_new10((int)(k1), (int)(k2), (int)(k3), (int)(k4)))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence11(k1 QKeyCombination, k2 QKeyCombination) *QKeySequence {
	g := newQKeySequence(QKeySequence_new11(k1.cPointer(), k2.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence12(k1 QKeyCombination, k2 QKeyCombination, k3 QKeyCombination) *QKeySequence {
	g := newQKeySequence(QKeySequence_new12(k1.cPointer(), k2.cPointer(), k3.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeySequence13(k1 QKeyCombination, k2 QKeyCombination, k3 QKeyCombination, k4 QKeyCombination) *QKeySequence {
	g := newQKeySequence(QKeySequence_new13(k1.cPointer(), k2.cPointer(), k3.cPointer(), k4.cPointer()))
	g.isSubclass = true
	return g
}
