...
func NewQStandardItem() *QStandardItem {
	g := newQStandardItem(QStandardItem_new())
	g.isSubclass = true
	return g
}
...
func NewQStandardItem2(text string) *QStandardItem {
	...
	g := newQStandardItem(QStandardItem_new2(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQStandardItem3(icon *QIcon, text string) *QStandardItem {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQStandardItem(QStandardItem_new3(icon.cPointer(), text_ms))
	g.isSubclass = true
	return g
}
...
func NewQStandardItem4(rows int) *QStandardItem {
	g := newQStandardItem(QStandardItem_new4((int)(rows)))
	g.isSubclass = true
	return g
}
...
func NewQStandardItem5(rows int, columns int) *QStandardItem {
	g := newQStandardItem(QStandardItem_new5((int)(rows), (int)(columns)))
	g.isSubclass = true
	return g
}
...
func NewQStandardItemModel() *QStandardItemModel {
	g := newQStandardItemModel(QStandardItemModel_new())
	g.isSubclass = true
	return g
}
...
func NewQStandardItemModel2(rows int, columns int) *QStandardItemModel {
	g := newQStandardItemModel(QStandardItemModel_new2((int)(rows), (int)(columns)))
	g.isSubclass = true
	return g
}
...
func NewQStandardItemModel3(parent *QObject) *QStandardItemModel {
	g := newQStandardItemModel(QStandardItemModel_new3(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQStandardItemModel4(rows int, columns int, parent *QObject) *QStandardItemModel {
	g := newQStandardItemModel(QStandardItemModel_new4((int)(rows), (int)(columns), parent.cPointer()))
	g.isSubclass = true
	return g
}
