...
func (this *QStyle) callVirtualBase_MetaObject() *QMetaObject {
	return newQMetaObject(QStyle_virtualbase_MetaObject(unsafe.Pointer(this.h)))
}
...
func (this *QStyle) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	...
	QStyle_override_virtual_MetaObject(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QStyle_MetaObject
func miqt_exec_callback_QStyle_MetaObject(self QStyle, cb intptr_t) *QMetaObject {
...
func (this *QStyle) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(QStyle_virtualbase_Metacast(unsafe.Pointer(this.h), param1_Cstring))
}
...
func (this *QStyle) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	...
	QStyle_override_virtual_Metacast(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QStyle_Metacast
func miqt_exec_callback_QStyle_Metacast(self QStyle, cb intptr_t, param1 *const_char) unsafe.Pointer {
