...
func NewQFont2(family string) *QFont {
	...
	g := newQFont(QFont_new2(family_ms))
	g.isSubclass = true
	return g
}
...
func NewQFont3(families []string) *QFont {
	...
	g := newQFont(QFont_new3(families_ma))
	g.isSubclass = true
	return g
}
...
func NewQFont4(font *QFont, pd *QPaintDevice) *QFont {
	g := newQFont(QFont_new4(font.cPointer(), pd.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFont5(font *QFont) *QFont {
	g := newQFont(QFont_new5(font.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQFont6(family string, pointSize int) *QFont {
	...
	family_ms.len = size_t(len(family))
	defer free(unsafe.Pointer(family_ms.data))
	g := newQFont(QFont_new6(family_ms, (int)(pointSize)))
	g.isSubclass = true
	return g
}
...
func NewQFont7(family string, pointSize int, weight int) *QFont {
	...
	family_ms.len = size_t(len(family))
	defer free(unsafe.Pointer(family_ms.data))
	g := newQFont(QFont_new7(family_ms, (int)(pointSize), (int)(weight)))
	g.isSubclass = true
	return g
}
...
func NewQFont8(family string, pointSize int, weight int, italic bool) *QFont {
	...
	family_ms.len = size_t(len(family))
	defer free(unsafe.Pointer(family_ms.data))
	g := newQFont(QFont_new8(family_ms, (int)(pointSize), (int)(weight), (bool)(italic)))
	g.isSubclass = true
	return g
}
...
func NewQFont9(families []string, pointSize int) *QFont {
	...
	families_ma := struct_miqt_array{len: size_t(len(families)), data: unsafe.Pointer(families_CArray)}
	g := newQFont(QFont_new9(families_ma, (int)(pointSize)))
	g.isSubclass = true
	return g
}
...
func NewQFont10(families []string, pointSize int, weight int) *QFont {
	...
	families_ma := struct_miqt_array{len: size_t(len(families)), data: unsafe.Pointer(families_CArray)}
	g := newQFont(QFont_new10(families_ma, (int)(pointSize), (int)(weight)))
	g.isSubclass = true
	return g
}
...
func NewQFont11(families []string, pointSize int, weight int, italic bool) *QFont {
	...
	families_ma := struct_miqt_array{len: size_t(len(families)), data: unsafe.Pointer(families_CArray)}
	g := newQFont(QFont_new11(families_ma, (int)(pointSize), (int)(weight), (bool)(italic)))
	g.isSubclass = true
	return g
}
...
func NewQFont__Tag() *QFont__Tag {
	g := newQFont__Tag(QFont__Tag_new())
	g.isSubclass = true
	return g
}
...
func NewQFont__Tag2(param1 *Tag) *QFont__Tag {
	g := newQFont__Tag(QFont__Tag_new2(param1))
	g.isSubclass = true
	return g
}
