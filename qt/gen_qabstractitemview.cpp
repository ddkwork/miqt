...
QMetaObject* callback_return_value = miqt_exec_callback_QAbstractItemView_MetaObject(const_cast<MiqtVirtualQAbstractItemView*>(this), handle__MetaObject);
...
void QAbstractItemView_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractItemView*>( (QAbstractItemView*)(self) )->handle__MetaObject = slot;
}
...
void QAbstractItemView_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQAbstractItemView*>( (QAbstractItemView*)(self) )->handle__Metacast = slot;
}
