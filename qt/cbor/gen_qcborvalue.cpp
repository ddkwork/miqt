...
struct miqt_string QCborValue_ToCbor1(const QCborValue* self, EncodingOptions opt) {
...
struct miqt_string QCborValue_ToDiagnosticNotation1(const QCborValue* self, DiagnosticNotationOptions opts) {
...
void QCborValueRef_virtbase(QCborValueRef* src
, QCborValueConstRef** outptr_QCborValueConstRef
) {
