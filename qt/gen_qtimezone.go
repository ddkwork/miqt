...
func NewQTimeZone2(spec Initialization) *QTimeZone {
	g := newQTimeZone(QTimeZone_new2(spec))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone3(offsetSeconds int) *QTimeZone {
	g := newQTimeZone(QTimeZone_new3((int)(offsetSeconds)))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone4(ianaId []byte) *QTimeZone {
	...
	g := newQTimeZone(QTimeZone_new4(ianaId_alias))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone5(zoneId []byte, offsetSeconds int, name string, abbreviation string) *QTimeZone {
	...
	g := newQTimeZone(QTimeZone_new5(zoneId_alias, (int)(offsetSeconds), name_ms, abbreviation_ms))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone6(other *QTimeZone) *QTimeZone {
	g := newQTimeZone(QTimeZone_new6(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone7(zoneId []byte, offsetSeconds int, name string, abbreviation string, territory Country) *QTimeZone {
	...
	abbreviation_ms.len = size_t(len(abbreviation))
	defer free(unsafe.Pointer(abbreviation_ms.data))
	g := newQTimeZone(QTimeZone_new7(zoneId_alias, (int)(offsetSeconds), name_ms, abbreviation_ms, territory))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone8(zoneId []byte, offsetSeconds int, name string, abbreviation string, territory Country, comment string) *QTimeZone {
	...
	g := newQTimeZone(QTimeZone_new8(zoneId_alias, (int)(offsetSeconds), name_ms, abbreviation_ms, territory, comment_ms))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone__OffsetData(param1 *OffsetData) *QTimeZone__OffsetData {
	g := newQTimeZone__OffsetData(QTimeZone__OffsetData_new(param1))
	g.isSubclass = true
	return g
}
...
func NewQTimeZone__OffsetData2() *QTimeZone__OffsetData {
	g := newQTimeZone__OffsetData(QTimeZone__OffsetData_new2())
	g.isSubclass = true
	return g
}
