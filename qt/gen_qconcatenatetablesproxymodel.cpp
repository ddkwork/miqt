...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QConcatenateTablesProxyModel_MetaObject(const_cast<MiqtVirtualQConcatenateTablesProxyModel*>(this), handle__MetaObject);
...
void QConcatenateTablesProxyModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQConcatenateTablesProxyModel*>( (QConcatenateTablesProxyModel*)(self) )->handle__MetaObject = slot;
}
...
void QConcatenateTablesProxyModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQConcatenateTablesProxyModel*>( (QConcatenateTablesProxyModel*)(self) )->handle__Metacast = slot;
}
