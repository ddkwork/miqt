...
func NewQDeadlineTimer() *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new())
	g.isSubclass = true
	return g
}
...
func NewQDeadlineTimer2(type_ TimerType) *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new2((int)(type_)))
	g.isSubclass = true
	return g
}
...
func NewQDeadlineTimer3(param1 ForeverConstant) *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new3(param1))
	g.isSubclass = true
	return g
}
...
func NewQDeadlineTimer4(msecs int64) *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new4((longlong)(msecs)))
	g.isSubclass = true
	return g
}
...
func NewQDeadlineTimer5(param1 *QDeadlineTimer) *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new5(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDeadlineTimer6(param1 ForeverConstant, type_ TimerType) *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new6(param1, (int)(type_)))
	g.isSubclass = true
	return g
}
...
func NewQDeadlineTimer7(msecs int64, typeVal TimerType) *QDeadlineTimer {
	g := newQDeadlineTimer(QDeadlineTimer_new7((longlong)(msecs), (int)(typeVal)))
	g.isSubclass = true
	return g
}
