...
func NewQTextDocumentWriter2(device *QIODevice, format []byte) *QTextDocumentWriter {
	...
	ret := newQTextDocumentWriter(QTextDocumentWriter_new2(device.cPointer(), format_alias))
	ret.isSubclass = true
	return ret
}
...
func NewQTextDocumentWriter3(fileName string) *QTextDocumentWriter {
	...
	ret := newQTextDocumentWriter(QTextDocumentWriter_new3(fileName_ms))
	ret.isSubclass = true
	return ret
}
...
func NewQTextDocumentWriter4(fileName string, format []byte) *QTextDocumentWriter {
	...
	ret := newQTextDocumentWriter(QTextDocumentWriter_new4(fileName_ms, format_alias))
	ret.isSubclass = true
	return ret
}
