...
func NewQTransposeProxyModel() *QTransposeProxyModel {
	...
	ret := newQTransposeProxyModel(QTransposeProxyModel_new())
	ret.isSubclass = true
	return ret
}
...
func NewQTransposeProxyModel2(parent *QObject) *QTransposeProxyModel {
	...
	ret := newQTransposeProxyModel(QTransposeProxyModel_new2(parent.cPointer()))
	ret.isSubclass = true
	return ret
}
...
func (this *QTransposeProxyModel) callVirtualBase_SetSourceModel(newSourceModel *QAbstractItemModel) {
	...
	QTransposeProxyModel_virtualbase_SetSourceModel(unsafe.Pointer(this.h), newSourceModel.cPointer())
...
func (this *QTransposeProxyModel) OnSetSourceModel(slot func(super func(newSourceModel *QAbstractItemModel), newSourceModel *QAbstractItemModel)) {
	...
	QTransposeProxyModel_override_virtual_SetSourceModel(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_SetSourceModel
func miqt_exec_callback_QTransposeProxyModel_SetSourceModel(self QTransposeProxyModel, cb intptr_t, newSourceModel *QAbstractItemModel) {
...
func (this *QTransposeProxyModel) callVirtualBase_RowCount(parent *QModelIndex) int {
	...
	return (int)(QTransposeProxyModel_virtualbase_RowCount(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnRowCount(slot func(super func(parent *QModelIndex) int, parent *QModelIndex) int) {
	...
	QTransposeProxyModel_override_virtual_RowCount(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_RowCount
func miqt_exec_callback_QTransposeProxyModel_RowCount(self QTransposeProxyModel, cb intptr_t, parent *QModelIndex) int {
...
func (this *QTransposeProxyModel) callVirtualBase_ColumnCount(parent *QModelIndex) int {
	...
	return (int)(QTransposeProxyModel_virtualbase_ColumnCount(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnColumnCount(slot func(super func(parent *QModelIndex) int, parent *QModelIndex) int) {
	...
	QTransposeProxyModel_override_virtual_ColumnCount(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_ColumnCount
func miqt_exec_callback_QTransposeProxyModel_ColumnCount(self QTransposeProxyModel, cb intptr_t, parent *QModelIndex) int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(parent *QModelIndex) int, parent *QModelIndex) int)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_HeaderData(section int, orientation Orientation, role int) *QVariant {
	...
	_goptr := newQVariant(QTransposeProxyModel_virtualbase_HeaderData(unsafe.Pointer(this.h), (int)(section), (int)(orientation), (int)(role)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnHeaderData(slot func(super func(section int, orientation Orientation, role int) *QVariant, section int, orientation Orientation, role int) *QVariant) {
	...
	QTransposeProxyModel_override_virtual_HeaderData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_HeaderData
func miqt_exec_callback_QTransposeProxyModel_HeaderData(self QTransposeProxyModel, cb intptr_t, section int, orientation int, role int) *QVariant {
...
func (this *QTransposeProxyModel) callVirtualBase_SetHeaderData(section int, orientation Orientation, value *QVariant, role int) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_SetHeaderData(unsafe.Pointer(this.h), (int)(section), (int)(orientation), value.cPointer(), (int)(role)))
...
func (this *QTransposeProxyModel) OnSetHeaderData(slot func(super func(section int, orientation Orientation, value *QVariant, role int) bool, section int, orientation Orientation, value *QVariant, role int) bool) {
	...
	QTransposeProxyModel_override_virtual_SetHeaderData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_SetHeaderData
func miqt_exec_callback_QTransposeProxyModel_SetHeaderData(self QTransposeProxyModel, cb intptr_t, section int, orientation int, value *QVariant, role int) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_SetItemData(index *QModelIndex, roles map[int]QVariant) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_SetItemData(unsafe.Pointer(this.h), index.cPointer(), roles_mm))
...
func (this *QTransposeProxyModel) OnSetItemData(slot func(super func(index *QModelIndex, roles map[int]QVariant) bool, index *QModelIndex, roles map[int]QVariant) bool) {
	...
	QTransposeProxyModel_override_virtual_SetItemData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_SetItemData
func miqt_exec_callback_QTransposeProxyModel_SetItemData(self QTransposeProxyModel, cb intptr_t, index *QModelIndex, roles struct_miqt_map) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_Span(index *QModelIndex) *QSize {
	...
	_goptr := newQSize(QTransposeProxyModel_virtualbase_Span(unsafe.Pointer(this.h), index.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnSpan(slot func(super func(index *QModelIndex) *QSize, index *QModelIndex) *QSize) {
	...
	QTransposeProxyModel_override_virtual_Span(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Span
func miqt_exec_callback_QTransposeProxyModel_Span(self QTransposeProxyModel, cb intptr_t, index *QModelIndex) *QSize {
...
func (this *QTransposeProxyModel) callVirtualBase_ItemData(index *QModelIndex) map[int]QVariant {
	...
	var _mm struct_miqt_map = QTransposeProxyModel_virtualbase_ItemData(unsafe.Pointer(this.h), index.cPointer())
	_ret := make(map[int]QVariant, int(_mm.len))
	_Keys := (*[0xffff]int)(unsafe.Pointer(_mm.keys))
	_Values := (*[0xffff]*QVariant)(unsafe.Pointer(_mm.values))
	for i := 0; i < int(_mm.len); i++ {
...
func (this *QTransposeProxyModel) OnItemData(slot func(super func(index *QModelIndex) map[int]QVariant, index *QModelIndex) map[int]QVariant) {
	...
	QTransposeProxyModel_override_virtual_ItemData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_ItemData
func miqt_exec_callback_QTransposeProxyModel_ItemData(self QTransposeProxyModel, cb intptr_t, index *QModelIndex) struct_miqt_map {
...
func (this *QTransposeProxyModel) callVirtualBase_MapFromSource(sourceIndex *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QTransposeProxyModel_virtualbase_MapFromSource(unsafe.Pointer(this.h), sourceIndex.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnMapFromSource(slot func(super func(sourceIndex *QModelIndex) *QModelIndex, sourceIndex *QModelIndex) *QModelIndex) {
	...
	QTransposeProxyModel_override_virtual_MapFromSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MapFromSource
func miqt_exec_callback_QTransposeProxyModel_MapFromSource(self QTransposeProxyModel, cb intptr_t, sourceIndex *QModelIndex) *QModelIndex {
...
func (this *QTransposeProxyModel) callVirtualBase_MapToSource(proxyIndex *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QTransposeProxyModel_virtualbase_MapToSource(unsafe.Pointer(this.h), proxyIndex.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnMapToSource(slot func(super func(proxyIndex *QModelIndex) *QModelIndex, proxyIndex *QModelIndex) *QModelIndex) {
	...
	QTransposeProxyModel_override_virtual_MapToSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MapToSource
func miqt_exec_callback_QTransposeProxyModel_MapToSource(self QTransposeProxyModel, cb intptr_t, proxyIndex *QModelIndex) *QModelIndex {
...
func (this *QTransposeProxyModel) callVirtualBase_Parent(index *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QTransposeProxyModel_virtualbase_Parent(unsafe.Pointer(this.h), index.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnParent(slot func(super func(index *QModelIndex) *QModelIndex, index *QModelIndex) *QModelIndex) {
	...
	QTransposeProxyModel_override_virtual_Parent(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Parent
func miqt_exec_callback_QTransposeProxyModel_Parent(self QTransposeProxyModel, cb intptr_t, index *QModelIndex) *QModelIndex {
...
func (this *QTransposeProxyModel) callVirtualBase_Index(row int, column int, parent *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QTransposeProxyModel_virtualbase_Index(unsafe.Pointer(this.h), (int)(row), (int)(column), parent.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnIndex(slot func(super func(row int, column int, parent *QModelIndex) *QModelIndex, row int, column int, parent *QModelIndex) *QModelIndex) {
	...
	QTransposeProxyModel_override_virtual_Index(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Index
func miqt_exec_callback_QTransposeProxyModel_Index(self QTransposeProxyModel, cb intptr_t, row int, column int, parent *QModelIndex) *QModelIndex {
...
func (this *QTransposeProxyModel) callVirtualBase_InsertRows(row int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_InsertRows(unsafe.Pointer(this.h), (int)(row), (int)(count), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnInsertRows(slot func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_InsertRows(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_InsertRows
func miqt_exec_callback_QTransposeProxyModel_InsertRows(self QTransposeProxyModel, cb intptr_t, row int, count int, parent *QModelIndex) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_RemoveRows(row int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_RemoveRows(unsafe.Pointer(this.h), (int)(row), (int)(count), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnRemoveRows(slot func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_RemoveRows(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_RemoveRows
func miqt_exec_callback_QTransposeProxyModel_RemoveRows(self QTransposeProxyModel, cb intptr_t, row int, count int, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_MoveRows(sourceParent *QModelIndex, sourceRow int, count int, destinationParent *QModelIndex, destinationChild int) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_MoveRows(unsafe.Pointer(this.h), sourceParent.cPointer(), (int)(sourceRow), (int)(count), destinationParent.cPointer(), (int)(destinationChild)))
...
func (this *QTransposeProxyModel) OnMoveRows(slot func(super func(sourceParent *QModelIndex, sourceRow int, count int, destinationParent *QModelIndex, destinationChild int) bool, sourceParent *QModelIndex, sourceRow int, count int, destinationParent *QModelIndex, destinationChild int) bool) {
	...
	QTransposeProxyModel_override_virtual_MoveRows(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MoveRows
func miqt_exec_callback_QTransposeProxyModel_MoveRows(self QTransposeProxyModel, cb intptr_t, sourceParent *QModelIndex, sourceRow int, count int, destinationParent *QModelIndex, destinationChild int) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_InsertColumns(column int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_InsertColumns(unsafe.Pointer(this.h), (int)(column), (int)(count), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnInsertColumns(slot func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_InsertColumns(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_InsertColumns
func miqt_exec_callback_QTransposeProxyModel_InsertColumns(self QTransposeProxyModel, cb intptr_t, column int, count int, parent *QModelIndex) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_RemoveColumns(column int, count int, parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_RemoveColumns(unsafe.Pointer(this.h), (int)(column), (int)(count), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnRemoveColumns(slot func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_RemoveColumns(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_RemoveColumns
func miqt_exec_callback_QTransposeProxyModel_RemoveColumns(self QTransposeProxyModel, cb intptr_t, column int, count int, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_MoveColumns(sourceParent *QModelIndex, sourceColumn int, count int, destinationParent *QModelIndex, destinationChild int) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_MoveColumns(unsafe.Pointer(this.h), sourceParent.cPointer(), (int)(sourceColumn), (int)(count), destinationParent.cPointer(), (int)(destinationChild)))
...
func (this *QTransposeProxyModel) OnMoveColumns(slot func(super func(sourceParent *QModelIndex, sourceColumn int, count int, destinationParent *QModelIndex, destinationChild int) bool, sourceParent *QModelIndex, sourceColumn int, count int, destinationParent *QModelIndex, destinationChild int) bool) {
	...
	QTransposeProxyModel_override_virtual_MoveColumns(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MoveColumns
func miqt_exec_callback_QTransposeProxyModel_MoveColumns(self QTransposeProxyModel, cb intptr_t, sourceParent *QModelIndex, sourceColumn int, count int, destinationParent *QModelIndex, destinationChild int) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_Sort(column int, order SortOrder) {
	...
	QTransposeProxyModel_virtualbase_Sort(unsafe.Pointer(this.h), (int)(column), (int)(order))
...
func (this *QTransposeProxyModel) OnSort(slot func(super func(column int, order SortOrder), column int, order SortOrder)) {
	...
	QTransposeProxyModel_override_virtual_Sort(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Sort
func miqt_exec_callback_QTransposeProxyModel_Sort(self QTransposeProxyModel, cb intptr_t, column int, order int) {
...
func (this *QTransposeProxyModel) callVirtualBase_MapSelectionToSource(selection *QItemSelection) *QItemSelection {
	...
	_goptr := newQItemSelection(QTransposeProxyModel_virtualbase_MapSelectionToSource(unsafe.Pointer(this.h), selection.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnMapSelectionToSource(slot func(super func(selection *QItemSelection) *QItemSelection, selection *QItemSelection) *QItemSelection) {
	...
	QTransposeProxyModel_override_virtual_MapSelectionToSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MapSelectionToSource
func miqt_exec_callback_QTransposeProxyModel_MapSelectionToSource(self QTransposeProxyModel, cb intptr_t, selection *QItemSelection) *QItemSelection {
...
func (this *QTransposeProxyModel) callVirtualBase_MapSelectionFromSource(selection *QItemSelection) *QItemSelection {
	...
	_goptr := newQItemSelection(QTransposeProxyModel_virtualbase_MapSelectionFromSource(unsafe.Pointer(this.h), selection.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnMapSelectionFromSource(slot func(super func(selection *QItemSelection) *QItemSelection, selection *QItemSelection) *QItemSelection) {
	...
	QTransposeProxyModel_override_virtual_MapSelectionFromSource(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MapSelectionFromSource
func miqt_exec_callback_QTransposeProxyModel_MapSelectionFromSource(self QTransposeProxyModel, cb intptr_t, selection *QItemSelection) *QItemSelection {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(selection *QItemSelection) *QItemSelection, selection *QItemSelection) *QItemSelection)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_Submit() bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_Submit(unsafe.Pointer(this.h)))
...
func (this *QTransposeProxyModel) OnSubmit(slot func(super func() bool) bool) {
	...
	QTransposeProxyModel_override_virtual_Submit(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Submit
func miqt_exec_callback_QTransposeProxyModel_Submit(self QTransposeProxyModel, cb intptr_t) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_Revert() {
	...
	QTransposeProxyModel_virtualbase_Revert(unsafe.Pointer(this.h))
...
func (this *QTransposeProxyModel) OnRevert(slot func(super func())) {
	...
	QTransposeProxyModel_override_virtual_Revert(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Revert
func miqt_exec_callback_QTransposeProxyModel_Revert(self QTransposeProxyModel, cb intptr_t) {
...
func (this *QTransposeProxyModel) callVirtualBase_Data(proxyIndex *QModelIndex, role int) *QVariant {
	...
	_goptr := newQVariant(QTransposeProxyModel_virtualbase_Data(unsafe.Pointer(this.h), proxyIndex.cPointer(), (int)(role)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnData(slot func(super func(proxyIndex *QModelIndex, role int) *QVariant, proxyIndex *QModelIndex, role int) *QVariant) {
	...
	QTransposeProxyModel_override_virtual_Data(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Data
func miqt_exec_callback_QTransposeProxyModel_Data(self QTransposeProxyModel, cb intptr_t, proxyIndex *QModelIndex, role int) *QVariant {
...
func (this *QTransposeProxyModel) callVirtualBase_Flags(index *QModelIndex) ItemFlag {
	...
	return (ItemFlag)(QTransposeProxyModel_virtualbase_Flags(unsafe.Pointer(this.h), index.cPointer()))
...
func (this *QTransposeProxyModel) OnFlags(slot func(super func(index *QModelIndex) ItemFlag, index *QModelIndex) ItemFlag) {
	...
	QTransposeProxyModel_override_virtual_Flags(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Flags
func miqt_exec_callback_QTransposeProxyModel_Flags(self QTransposeProxyModel, cb intptr_t, index *QModelIndex) int {
...
func (this *QTransposeProxyModel) callVirtualBase_SetData(index *QModelIndex, value *QVariant, role int) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_SetData(unsafe.Pointer(this.h), index.cPointer(), value.cPointer(), (int)(role)))
...
func (this *QTransposeProxyModel) OnSetData(slot func(super func(index *QModelIndex, value *QVariant, role int) bool, index *QModelIndex, value *QVariant, role int) bool) {
	...
	QTransposeProxyModel_override_virtual_SetData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_SetData
func miqt_exec_callback_QTransposeProxyModel_SetData(self QTransposeProxyModel, cb intptr_t, index *QModelIndex, value *QVariant, role int) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_ClearItemData(index *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_ClearItemData(unsafe.Pointer(this.h), index.cPointer()))
...
func (this *QTransposeProxyModel) OnClearItemData(slot func(super func(index *QModelIndex) bool, index *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_ClearItemData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_ClearItemData
func miqt_exec_callback_QTransposeProxyModel_ClearItemData(self QTransposeProxyModel, cb intptr_t, index *QModelIndex) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_Buddy(index *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QTransposeProxyModel_virtualbase_Buddy(unsafe.Pointer(this.h), index.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnBuddy(slot func(super func(index *QModelIndex) *QModelIndex, index *QModelIndex) *QModelIndex) {
	...
	QTransposeProxyModel_override_virtual_Buddy(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Buddy
func miqt_exec_callback_QTransposeProxyModel_Buddy(self QTransposeProxyModel, cb intptr_t, index *QModelIndex) *QModelIndex {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(index *QModelIndex) *QModelIndex, index *QModelIndex) *QModelIndex)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_CanFetchMore(parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_CanFetchMore(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnCanFetchMore(slot func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_CanFetchMore(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_CanFetchMore
func miqt_exec_callback_QTransposeProxyModel_CanFetchMore(self QTransposeProxyModel, cb intptr_t, parent *QModelIndex) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_FetchMore(parent *QModelIndex) {
	...
	QTransposeProxyModel_virtualbase_FetchMore(unsafe.Pointer(this.h), parent.cPointer())
...
func (this *QTransposeProxyModel) OnFetchMore(slot func(super func(parent *QModelIndex), parent *QModelIndex)) {
	...
	QTransposeProxyModel_override_virtual_FetchMore(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_FetchMore
func miqt_exec_callback_QTransposeProxyModel_FetchMore(self QTransposeProxyModel, cb intptr_t, parent *QModelIndex) {
...
func (this *QTransposeProxyModel) callVirtualBase_HasChildren(parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_HasChildren(unsafe.Pointer(this.h), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnHasChildren(slot func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_HasChildren(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_HasChildren
func miqt_exec_callback_QTransposeProxyModel_HasChildren(self QTransposeProxyModel, cb intptr_t, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_Sibling(row int, column int, idx *QModelIndex) *QModelIndex {
	...
	_goptr := newQModelIndex(QTransposeProxyModel_virtualbase_Sibling(unsafe.Pointer(this.h), (int)(row), (int)(column), idx.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QTransposeProxyModel) OnSibling(slot func(super func(row int, column int, idx *QModelIndex) *QModelIndex, row int, column int, idx *QModelIndex) *QModelIndex) {
	...
	QTransposeProxyModel_override_virtual_Sibling(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_Sibling
func miqt_exec_callback_QTransposeProxyModel_Sibling(self QTransposeProxyModel, cb intptr_t, row int, column int, idx *QModelIndex) *QModelIndex {
...
func (this *QTransposeProxyModel) callVirtualBase_MimeData(indexes []QModelIndex) *QMimeData {
	...
	return newQMimeData(QTransposeProxyModel_virtualbase_MimeData(unsafe.Pointer(this.h), indexes_ma))
...
func (this *QTransposeProxyModel) OnMimeData(slot func(super func(indexes []QModelIndex) *QMimeData, indexes []QModelIndex) *QMimeData) {
	...
	QTransposeProxyModel_override_virtual_MimeData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MimeData
func miqt_exec_callback_QTransposeProxyModel_MimeData(self QTransposeProxyModel, cb intptr_t, indexes struct_miqt_array) *QMimeData {
...
func (this *QTransposeProxyModel) callVirtualBase_CanDropMimeData(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_CanDropMimeData(unsafe.Pointer(this.h), data.cPointer(), (int)(action), (int)(row), (int)(column), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnCanDropMimeData(slot func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_CanDropMimeData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_CanDropMimeData
func miqt_exec_callback_QTransposeProxyModel_CanDropMimeData(self QTransposeProxyModel, cb intptr_t, data *QMimeData, action int, row int, column int, parent *QModelIndex) bool {
...
func (this *QTransposeProxyModel) callVirtualBase_DropMimeData(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool {
	...
	return (bool)(QTransposeProxyModel_virtualbase_DropMimeData(unsafe.Pointer(this.h), data.cPointer(), (int)(action), (int)(row), (int)(column), parent.cPointer()))
...
func (this *QTransposeProxyModel) OnDropMimeData(slot func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool) {
	...
	QTransposeProxyModel_override_virtual_DropMimeData(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_DropMimeData
func miqt_exec_callback_QTransposeProxyModel_DropMimeData(self QTransposeProxyModel, cb intptr_t, data *QMimeData, action int, row int, column int, parent *QModelIndex) bool {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_MimeTypes() []string {
	...
	var _ma struct_miqt_array = QTransposeProxyModel_virtualbase_MimeTypes(unsafe.Pointer(this.h))
...
func (this *QTransposeProxyModel) OnMimeTypes(slot func(super func() []string) []string) {
	...
	QTransposeProxyModel_override_virtual_MimeTypes(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_MimeTypes
func miqt_exec_callback_QTransposeProxyModel_MimeTypes(self QTransposeProxyModel, cb intptr_t) struct_miqt_array {
...
func (this *QTransposeProxyModel) callVirtualBase_SupportedDragActions() DropAction {
	...
	return (DropAction)(QTransposeProxyModel_virtualbase_SupportedDragActions(unsafe.Pointer(this.h)))
...
func (this *QTransposeProxyModel) OnSupportedDragActions(slot func(super func() DropAction) DropAction) {
	...
	QTransposeProxyModel_override_virtual_SupportedDragActions(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_SupportedDragActions
func miqt_exec_callback_QTransposeProxyModel_SupportedDragActions(self QTransposeProxyModel, cb intptr_t) int {
...
func (this *QTransposeProxyModel) callVirtualBase_SupportedDropActions() DropAction {
	...
	return (DropAction)(QTransposeProxyModel_virtualbase_SupportedDropActions(unsafe.Pointer(this.h)))
...
func (this *QTransposeProxyModel) OnSupportedDropActions(slot func(super func() DropAction) DropAction) {
	...
	QTransposeProxyModel_override_virtual_SupportedDropActions(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_SupportedDropActions
func miqt_exec_callback_QTransposeProxyModel_SupportedDropActions(self QTransposeProxyModel, cb intptr_t) int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() DropAction) DropAction)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QTransposeProxyModel) callVirtualBase_RoleNames() map[int][]byte {
	...
	var _mm struct_miqt_map = QTransposeProxyModel_virtualbase_RoleNames(unsafe.Pointer(this.h))
...
func (this *QTransposeProxyModel) OnRoleNames(slot func(super func() map[int][]byte) map[int][]byte) {
	...
	QTransposeProxyModel_override_virtual_RoleNames(unsafe.Pointer(this.h), intptr_t(cgo.NewHandle(slot)))
}

//export miqt_exec_callback_QTransposeProxyModel_RoleNames
func miqt_exec_callback_QTransposeProxyModel_RoleNames(self QTransposeProxyModel, cb intptr_t) struct_miqt_map {
