...
func NewQBrush2(bs BrushStyle) *QBrush {
	g := newQBrush(QBrush_new2((int)(bs)))
	g.isSubclass = true
	return g
}
...
func NewQBrush3(color *QColor) *QBrush {
	g := newQBrush(QBrush_new3(color.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush4(color GlobalColor) *QBrush {
	g := newQBrush(QBrush_new4((int)(color)))
	g.isSubclass = true
	return g
}
...
func NewQBrush5(color *QColor, pixmap *QPixmap) *QBrush {
	g := newQBrush(QBrush_new5(color.cPointer(), pixmap.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush6(color GlobalColor, pixmap *QPixmap) *QBrush {
	g := newQBrush(QBrush_new6((int)(color), pixmap.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush7(pixmap *QPixmap) *QBrush {
	g := newQBrush(QBrush_new7(pixmap.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush8(image *QImage) *QBrush {
	g := newQBrush(QBrush_new8(image.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush9(brush *QBrush) *QBrush {
	g := newQBrush(QBrush_new9(brush.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush10(gradient *QGradient) *QBrush {
	g := newQBrush(QBrush_new10(gradient.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQBrush11(color *QColor, bs BrushStyle) *QBrush {
	g := newQBrush(QBrush_new11(color.cPointer(), (int)(bs)))
	g.isSubclass = true
	return g
}
...
func NewQBrush12(color GlobalColor, bs BrushStyle) *QBrush {
	g := newQBrush(QBrush_new12((int)(color), (int)(bs)))
	g.isSubclass = true
	return g
}
...
func NewQBrushData(param1 *QBrushData) *QBrushData {
	g := newQBrushData(QBrushData_new(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGradient2(param1 Preset) *QGradient {
	g := newQGradient(QGradient_new2(param1))
	g.isSubclass = true
	return g
}
...
func NewQGradient3(param1 *QGradient) *QGradient {
	g := newQGradient(QGradient_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQLinearGradient() *QLinearGradient {
	g := newQLinearGradient(QLinearGradient_new())
	g.isSubclass = true
	return g
}
...
func NewQLinearGradient2(start *QPointF, finalStop *QPointF) *QLinearGradient {
	g := newQLinearGradient(QLinearGradient_new2(start.cPointer(), finalStop.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQLinearGradient3(xStart float64, yStart float64, xFinalStop float64, yFinalStop float64) *QLinearGradient {
	g := newQLinearGradient(QLinearGradient_new3((double)(xStart), (double)(yStart), (double)(xFinalStop), (double)(yFinalStop)))
	g.isSubclass = true
	return g
}
...
func NewQLinearGradient4(param1 *QLinearGradient) *QLinearGradient {
	g := newQLinearGradient(QLinearGradient_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient() *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new())
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient2(center *QPointF, radius float64, focalPoint *QPointF) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new2(center.cPointer(), (double)(radius), focalPoint.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient3(cx float64, cy float64, radius float64, fx float64, fy float64) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new3((double)(cx), (double)(cy), (double)(radius), (double)(fx), (double)(fy)))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient4(center *QPointF, radius float64) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new4(center.cPointer(), (double)(radius)))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient5(cx float64, cy float64, radius float64) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new5((double)(cx), (double)(cy), (double)(radius)))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient6(center *QPointF, centerRadius float64, focalPoint *QPointF, focalRadius float64) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new6(center.cPointer(), (double)(centerRadius), focalPoint.cPointer(), (double)(focalRadius)))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient7(cx float64, cy float64, centerRadius float64, fx float64, fy float64, focalRadius float64) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new7((double)(cx), (double)(cy), (double)(centerRadius), (double)(fx), (double)(fy), (double)(focalRadius)))
	g.isSubclass = true
	return g
}
...
func NewQRadialGradient8(param1 *QRadialGradient) *QRadialGradient {
	g := newQRadialGradient(QRadialGradient_new8(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQConicalGradient() *QConicalGradient {
	g := newQConicalGradient(QConicalGradient_new())
	g.isSubclass = true
	return g
}
...
func NewQConicalGradient2(center *QPointF, startAngle float64) *QConicalGradient {
	g := newQConicalGradient(QConicalGradient_new2(center.cPointer(), (double)(startAngle)))
	g.isSubclass = true
	return g
}
...
func NewQConicalGradient3(cx float64, cy float64, startAngle float64) *QConicalGradient {
	g := newQConicalGradient(QConicalGradient_new3((double)(cx), (double)(cy), (double)(startAngle)))
	g.isSubclass = true
	return g
}
...
func NewQConicalGradient4(param1 *QConicalGradient) *QConicalGradient {
	g := newQConicalGradient(QConicalGradient_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGradient__QGradientData(param1 *QGradientData) *QGradient__QGradientData {
	g := newQGradient__QGradientData(QGradient__QGradientData_new(param1))
	g.isSubclass = true
	return g
}
