...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QLayout_MetaObject(const_cast<MiqtVirtualQLayout*>(this), handle__MetaObject);
...
void QLayout_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQLayout*>( (QLayout*)(self) )->handle__MetaObject = slot;
}
...
void QLayout_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQLayout*>( (QLayout*)(self) )->handle__Metacast = slot;
}
