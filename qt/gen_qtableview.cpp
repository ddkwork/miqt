...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QTableView_MetaObject(const_cast<MiqtVirtualQTableView*>(this), handle__MetaObject);
...
void QTableView_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQTableView*>( (QTableView*)(self) )->handle__MetaObject = slot;
}
...
void QTableView_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQTableView*>( (QTableView*)(self) )->handle__Metacast = slot;
}
