...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QHeaderView_MetaObject(const_cast<MiqtVirtualQHeaderView*>(this), handle__MetaObject);
...
void QHeaderView_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQHeaderView*>( (QHeaderView*)(self) )->handle__MetaObject = slot;
}
...
void QHeaderView_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQHeaderView*>( (QHeaderView*)(self) )->handle__Metacast = slot;
}
