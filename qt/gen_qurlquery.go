...
func NewQUrlQuery2(url *QUrl) *QUrlQuery {
	g := newQUrlQuery(QUrlQuery_new2(url.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQUrlQuery3(queryString string) *QUrlQuery {
	...
	g := newQUrlQuery(QUrlQuery_new3(queryString_ms))
	g.isSubclass = true
	return g
}
...
func NewQUrlQuery4(other *QUrlQuery) *QUrlQuery {
	g := newQUrlQuery(QUrlQuery_new4(other.cPointer()))
	g.isSubclass = true
	return g
}
