...
void QListWidgetItem_Delete(QListWidgetItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QListWidgetItem*>( self );
	} else {
		delete self;
	}
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QListWidget_MetaObject(const_cast<MiqtVirtualQListWidget*>(this), handle__MetaObject);
...
void QListWidget_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQListWidget*>( (QListWidget*)(self) )->handle__MetaObject = slot;
}
...
void QListWidget_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQListWidget*>( (QListWidget*)(self) )->handle__Metacast = slot;
}
