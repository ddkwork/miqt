...
func NewQLatin1String() *QLatin1String {
	g := newQLatin1String(QLatin1String_new())
	g.isSubclass = true
	return g
}
...
func NewQLatin1String2(s string) *QLatin1String {
	...
	g := newQLatin1String(QLatin1String_new2(s_Cstring))
	g.isSubclass = true
	return g
}
...
func NewQLatin1String3(f string, l string) *QLatin1String {
	...
	g := newQLatin1String(QLatin1String_new3(f_Cstring, l_Cstring))
	g.isSubclass = true
	return g
}
...
func NewQLatin1String4(s string, sz int64) *QLatin1String {
	s_Cstring := CString(s)
	defer free(unsafe.Pointer(s_Cstring))
	g := newQLatin1String(QLatin1String_new4(s_Cstring, (ptrdiff_t)(sz)))
	g.isSubclass = true
	return g
}
...
func NewQLatin1String5(s []byte) *QLatin1String {
	...
	g := newQLatin1String(QLatin1String_new5(s_alias))
	g.isSubclass = true
	return g
}
...
func NewQLatin1String6(s QByteArrayView) *QLatin1String {
	g := newQLatin1String(QLatin1String_new6(s.cPointer()))
	g.isSubclass = true
	return g
}
