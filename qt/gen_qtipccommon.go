...
func NewQNativeIpcKey() *QNativeIpcKey {
	g := newQNativeIpcKey(QNativeIpcKey_new())
	g.isSubclass = true
	return g
}
...
func NewQNativeIpcKey2(typeVal Type) *QNativeIpcKey {
	g := newQNativeIpcKey(QNativeIpcKey_new2(typeVal))
	g.isSubclass = true
	return g
}
...
func NewQNativeIpcKey3(k string) *QNativeIpcKey {
	...
	g := newQNativeIpcKey(QNativeIpcKey_new3(k_ms))
	g.isSubclass = true
	return g
}
...
func NewQNativeIpcKey4(other *QNativeIpcKey) *QNativeIpcKey {
	g := newQNativeIpcKey(QNativeIpcKey_new4(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQNativeIpcKey5(k string, typeVal Type) *QNativeIpcKey {
	...
	k_ms.len = size_t(len(k))
	defer free(unsafe.Pointer(k_ms.data))
	g := newQNativeIpcKey(QNativeIpcKey_new5(k_ms, typeVal))
	g.isSubclass = true
	return g
}
