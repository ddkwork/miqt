...
func NewQMetaContainer() *QMetaContainer {
	g := newQMetaContainer(QMetaContainer_new())
	g.isSubclass = true
	return g
}
...
func NewQMetaContainer2(param1 *QMetaContainer) *QMetaContainer {
	g := newQMetaContainer(QMetaContainer_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMetaSequence() *QMetaSequence {
	g := newQMetaSequence(QMetaSequence_new())
	g.isSubclass = true
	return g
}
...
func NewQMetaAssociation() *QMetaAssociation {
	g := newQMetaAssociation(QMetaAssociation_new())
	g.isSubclass = true
	return g
}
