...
QMetaObject* callback_return_value = miqt_exec_callback_QIODevice_MetaObject(const_cast<MiqtVirtualQIODevice*>(this), handle__MetaObject);
...
void QIODevice_virtbase(QIODevice* src
...
void QIODevice_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQIODevice*>( (QIODevice*)(self) )->handle__MetaObject = slot;
}
...
void QIODevice_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQIODevice*>( (QIODevice*)(self) )->handle__Metacast = slot;
}
