...
QMetaObject* callback_return_value = miqt_exec_callback_QSpatialSound_MetaObject(const_cast<MiqtVirtualQSpatialSound*>(this), handle__MetaObject);
...
void QSpatialSound_virtbase(QSpatialSound* src
...
void QSpatialSound_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQSpatialSound*>( (QSpatialSound*)(self) )->handle__MetaObject = slot;
}
...
void QSpatialSound_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQSpatialSound*>( (QSpatialSound*)(self) )->handle__Metacast = slot;
}
