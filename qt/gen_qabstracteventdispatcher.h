...
extern __declspec(dllexport) 
void QAbstractEventDispatcher_virtbase(QAbstractEventDispatcher* src
...
extern __declspec(dllexport) 
void QAbstractEventDispatcherV2_virtbase(QAbstractEventDispatcherV2* src
, QAbstractEventDispatcher** outptr_QAbstractEventDispatcher
);
extern __declspec(dllexport) 
