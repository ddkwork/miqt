...
void QStandardItem_Delete(QStandardItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QStandardItem*>( self );
	} else {
		delete self;
	}
}
...
QMetaObject* callback_return_value = miqt_exec_callback_QStandardItemModel_MetaObject(const_cast<MiqtVirtualQStandardItemModel*>(this), handle__MetaObject);
...
void QStandardItemModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQStandardItemModel*>( (QStandardItemModel*)(self) )->handle__MetaObject = slot;
}
...
void QStandardItemModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQStandardItemModel*>( (QStandardItemModel*)(self) )->handle__Metacast = slot;
}
