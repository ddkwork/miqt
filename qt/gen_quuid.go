...
g := newQUuid(QUuid_new2((uint)(l), (uint16_t)(w1), (uint16_t)(w2), (uchar)(b1), (uchar)(b2), (uchar)(b3), (uchar)(b4), (uchar)(b5), (uchar)(b6), (uchar)(b7), (uchar)(b8)))
				g.isSubclass = true
				return g
			}
...
g := newQUuid(QUuid_new4(stringVal.cPointer()))
				g.isSubclass = true
				return g
			}
...
g := newQUuid(QUuid_new6(param1.cPointer()))
				g.isSubclass = true
				return g
			}
...
g := newQUuid(QUuid_new7(id128, (int)(order)))
				g.isSubclass = true
				return g
			}
...
g := newQUuid__Id128Bytes(QUuid__Id128Bytes_new())
				g.isSubclass = true
				return g
			}
...
g := newQUuid__Id128Bytes(QUuid__Id128Bytes_new2(param1))
				g.isSubclass = true
				return g
			}
