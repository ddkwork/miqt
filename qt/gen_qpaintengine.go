...
func NewQTextItem2(param1 *QTextItem) *QTextItem {
	g := newQTextItem(QTextItem_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPaintEngine() *QPaintEngine {
	g := newQPaintEngine(QPaintEngine_new())
	g.isSubclass = true
	return g
}
...
func NewQPaintEngine2(features PaintEngineFeatures) *QPaintEngine {
	g := newQPaintEngine(QPaintEngine_new2(features))
	g.isSubclass = true
	return g
}
