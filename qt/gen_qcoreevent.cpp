...
public:
	...
	MiqtVirtualQEvent(Type typeVal): QEvent(typeVal) {};
...
QEvent* QEvent_new(Type typeVal) {
	return new MiqtVirtualQEvent(typeVal);
}
...
QTimerEvent* QTimerEvent_new2(int timerId) {
	return new MiqtVirtualQTimerEvent(static_cast<Qt::TimerId>(timerId));
}
...
public:
	...
	MiqtVirtualQChildEvent(Type typeVal, QObject* child): QChildEvent(typeVal, child) {};
...
QChildEvent* QChildEvent_new(Type typeVal, QObject* child) {
	return new MiqtVirtualQChildEvent(typeVal, child);
}
