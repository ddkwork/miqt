...
func NewQWizard(parent *QWidget) *QWizard {
	g := newQWizard(QWizard_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQWizard3(parent *QWidget, flags WindowType) *QWizard {
	g := newQWizard(QWizard_new3(parent.cPointer(), (int)(flags)))
	g.isSubclass = true
	return g
}
...
func NewQWizardPage(parent *QWidget) *QWizardPage {
	g := newQWizardPage(QWizardPage_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQWizardPage2() *QWizardPage {
	g := newQWizardPage(QWizardPage_new2())
	g.isSubclass = true
	return g
}
