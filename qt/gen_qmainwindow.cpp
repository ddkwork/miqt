...
QMetaObject* callback_return_value = miqt_exec_callback_QMainWindow_MetaObject(const_cast<MiqtVirtualQMainWindow*>(this), handle__MetaObject);
...
void QMainWindow_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQMainWindow*>( (QMainWindow*)(self) )->handle__MetaObject = slot;
}
...
void QMainWindow_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQMainWindow*>( (QMainWindow*)(self) )->handle__Metacast = slot;
}
