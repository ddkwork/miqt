...
func NewQGraphicsView(parent *QWidget) *QGraphicsView {
	g := newQGraphicsView(QGraphicsView_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsView2() *QGraphicsView {
	g := newQGraphicsView(QGraphicsView_new2())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsView3(scene *QGraphicsScene) *QGraphicsView {
	g := newQGraphicsView(QGraphicsView_new3(scene.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsView4(scene *QGraphicsScene, parent *QWidget) *QGraphicsView {
	g := newQGraphicsView(QGraphicsView_new4(scene.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
