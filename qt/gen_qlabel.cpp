...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QLabel_MetaObject(const_cast<MiqtVirtualQLabel*>(this), handle__MetaObject);
...
void QLabel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQLabel*>( (QLabel*)(self) )->handle__MetaObject = slot;
}
...
void QLabel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQLabel*>( (QLabel*)(self) )->handle__Metacast = slot;
}
