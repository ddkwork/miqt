...
func NewQPluginLoader() *QPluginLoader {
	g := newQPluginLoader(QPluginLoader_new())
	g.isSubclass = true
	return g
}
...
func NewQPluginLoader2(fileName string) *QPluginLoader {
	...
	g := newQPluginLoader(QPluginLoader_new2(fileName_ms))
	g.isSubclass = true
	return g
}
...
func NewQPluginLoader3(parent *QObject) *QPluginLoader {
	g := newQPluginLoader(QPluginLoader_new3(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQPluginLoader4(fileName string, parent *QObject) *QPluginLoader {
	...
	fileName_ms.len = size_t(len(fileName))
	defer free(unsafe.Pointer(fileName_ms.data))
	g := newQPluginLoader(QPluginLoader_new4(fileName_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
