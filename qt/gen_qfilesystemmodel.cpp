...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QFileSystemModel_MetaObject(const_cast<MiqtVirtualQFileSystemModel*>(this), handle__MetaObject);
...
void QFileSystemModel_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQFileSystemModel*>( (QFileSystemModel*)(self) )->handle__MetaObject = slot;
}
...
void QFileSystemModel_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQFileSystemModel*>( (QFileSystemModel*)(self) )->handle__Metacast = slot;
}
