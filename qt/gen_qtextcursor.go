...
func NewQTextCursor() *QTextCursor {
	g := newQTextCursor(QTextCursor_new())
	g.isSubclass = true
	return g
}
...
func NewQTextCursor2(document *QTextDocument) *QTextCursor {
	g := newQTextCursor(QTextCursor_new2(document.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextCursor3(frame *QTextFrame) *QTextCursor {
	g := newQTextCursor(QTextCursor_new3(frame.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextCursor4(block *QTextBlock) *QTextCursor {
	g := newQTextCursor(QTextCursor_new4(block.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextCursor5(cursor *QTextCursor) *QTextCursor {
	g := newQTextCursor(QTextCursor_new5(cursor.cPointer()))
	g.isSubclass = true
	return g
}
