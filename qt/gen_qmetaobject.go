...
func NewQMetaMethod() *QMetaMethod {
	g := newQMetaMethod(QMetaMethod_new())
	g.isSubclass = true
	return g
}
...
func NewQMetaMethod2(param1 *QMetaMethod) *QMetaMethod {
	g := newQMetaMethod(QMetaMethod_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMetaEnum2(param1 *QMetaEnum) *QMetaEnum {
	g := newQMetaEnum(QMetaEnum_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMetaProperty() *QMetaProperty {
	g := newQMetaProperty(QMetaProperty_new())
	g.isSubclass = true
	return g
}
...
func NewQMetaClassInfo() *QMetaClassInfo {
	g := newQMetaClassInfo(QMetaClassInfo_new())
	g.isSubclass = true
	return g
}
...
func NewQMetaClassInfo2(param1 *QMetaClassInfo) *QMetaClassInfo {
	g := newQMetaClassInfo(QMetaClassInfo_new2(param1.cPointer()))
	g.isSubclass = true
	return g
}
