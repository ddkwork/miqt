...
func NewQNetworkDatagram2(data []byte) *QNetworkDatagram {
	...
	ret := newQNetworkDatagram(QNetworkDatagram_new2(data_alias))
	ret.isSubclass = true
	return ret
}
...
func NewQNetworkDatagram4(data []byte, destinationAddress *QHostAddress) *QNetworkDatagram {
	...
	ret := newQNetworkDatagram(QNetworkDatagram_new4(data_alias, destinationAddress.cPointer()))
	ret.isSubclass = true
	return ret
}
...
func NewQNetworkDatagram5(data []byte, destinationAddress *QHostAddress, port uint16) *QNetworkDatagram {
	...
	ret := newQNetworkDatagram(QNetworkDatagram_new5(data_alias, destinationAddress.cPointer(), (uint16_t)(port)))
	ret.isSubclass = true
	return ret
}
