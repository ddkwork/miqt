...
QMetaObject* callback_return_value = miqt_exec_callback_QDnsLookup_MetaObject(const_cast<MiqtVirtualQDnsLookup*>(this), handle__MetaObject);
...
void QDnsLookup_virtbase(QDnsLookup* src
...
void QDnsLookup_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQDnsLookup*>( (QDnsLookup*)(self) )->handle__MetaObject = slot;
}
...
void QDnsLookup_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQDnsLookup*>( (QDnsLookup*)(self) )->handle__Metacast = slot;
}
