...
void QGraphicsSceneEvent_virtbase(QGraphicsSceneEvent* src
...
QGraphicsSceneMouseEvent* QGraphicsSceneMouseEvent_new2(Type typeVal) {
return new QGraphicsSceneMouseEvent(typeVal);
}
void QGraphicsSceneMouseEvent_virtbase(QGraphicsSceneMouseEvent* src
...
QGraphicsSceneWheelEvent* QGraphicsSceneWheelEvent_new2(Type typeVal) {
return new QGraphicsSceneWheelEvent(typeVal);
}
void QGraphicsSceneWheelEvent_virtbase(QGraphicsSceneWheelEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
...
QGraphicsSceneContextMenuEvent* QGraphicsSceneContextMenuEvent_new2(Type typeVal) {
return new QGraphicsSceneContextMenuEvent(typeVal);
}
void QGraphicsSceneContextMenuEvent_virtbase(QGraphicsSceneContextMenuEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
...
QGraphicsSceneHoverEvent* QGraphicsSceneHoverEvent_new2(Type typeVal) {
return new QGraphicsSceneHoverEvent(typeVal);
}
void QGraphicsSceneHoverEvent_virtbase(QGraphicsSceneHoverEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
...
QGraphicsSceneHelpEvent* QGraphicsSceneHelpEvent_new2(Type typeVal) {
return new QGraphicsSceneHelpEvent(typeVal);
}
void QGraphicsSceneHelpEvent_virtbase(QGraphicsSceneHelpEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
...
QGraphicsSceneDragDropEvent* QGraphicsSceneDragDropEvent_new2(Type typeVal) {
return new QGraphicsSceneDragDropEvent(typeVal);
}
void QGraphicsSceneDragDropEvent_virtbase(QGraphicsSceneDragDropEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
...
void QGraphicsSceneResizeEvent_virtbase(QGraphicsSceneResizeEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
...
void QGraphicsSceneMoveEvent_virtbase(QGraphicsSceneMoveEvent* src
, QGraphicsSceneEvent** outptr_QGraphicsSceneEvent
) {
*outptr_QGraphicsSceneEvent = static_cast<QGraphicsSceneEvent*>(src);
}
