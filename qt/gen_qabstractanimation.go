...
func NewQAbstractAnimation() *QAbstractAnimation {
	g := newQAbstractAnimation(QAbstractAnimation_new())
	g.isSubclass = true
	return g
}
...
func NewQAbstractAnimation2(parent *QObject) *QAbstractAnimation {
	g := newQAbstractAnimation(QAbstractAnimation_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQAnimationDriver() *QAnimationDriver {
	g := newQAnimationDriver(QAnimationDriver_new())
	g.isSubclass = true
	return g
}
...
func NewQAnimationDriver2(parent *QObject) *QAnimationDriver {
	g := newQAnimationDriver(QAnimationDriver_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
