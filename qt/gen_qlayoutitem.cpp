...
QLayoutItem* QLayoutItem_new() {
	return new QLayoutItem();
}

QLayoutItem* QLayoutItem_new2(QLayoutItem* param1) {
	return new QLayoutItem(*param1);
}

QLayoutItem* QLayoutItem_new3(int alignment) {
	return new QLayoutItem(static_cast<Qt::Alignment>(alignment));
}
...
void QSpacerItem_Delete(QSpacerItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QSpacerItem*>( self );
	} else {
		delete self;
	}
}
...
void QWidgetItem_Delete(QWidgetItem* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QWidgetItem*>( self );
	} else {
		delete self;
	}
}
...
void QWidgetItemV2_Delete(QWidgetItemV2* self, bool isSubclass) {
	if (isSubclass) {
		delete dynamic_cast<QWidgetItemV2*>( self );
	} else {
		delete self;
	}
}
