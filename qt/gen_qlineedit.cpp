...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QLineEdit_MetaObject(const_cast<MiqtVirtualQLineEdit*>(this), handle__MetaObject);
...
void QLineEdit_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQLineEdit*>( (QLineEdit*)(self) )->handle__MetaObject = slot;
}
...
void QLineEdit_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQLineEdit*>( (QLineEdit*)(self) )->handle__Metacast = slot;
}
