...
func NewQCommandLinkButton(parent *QWidget) *QCommandLinkButton {
	g := newQCommandLinkButton(QCommandLinkButton_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQCommandLinkButton2() *QCommandLinkButton {
	g := newQCommandLinkButton(QCommandLinkButton_new2())
	g.isSubclass = true
	return g
}
...
func NewQCommandLinkButton3(text string) *QCommandLinkButton {
	...
	g := newQCommandLinkButton(QCommandLinkButton_new3(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQCommandLinkButton4(text string, description string) *QCommandLinkButton {
	...
	g := newQCommandLinkButton(QCommandLinkButton_new4(text_ms, description_ms))
	g.isSubclass = true
	return g
}
...
func NewQCommandLinkButton5(text string, parent *QWidget) *QCommandLinkButton {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQCommandLinkButton(QCommandLinkButton_new5(text_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQCommandLinkButton6(text string, description string, parent *QWidget) *QCommandLinkButton {
	...
	description_ms.len = size_t(len(description))
	defer free(unsafe.Pointer(description_ms.data))
	g := newQCommandLinkButton(QCommandLinkButton_new6(text_ms, description_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
