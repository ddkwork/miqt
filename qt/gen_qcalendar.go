...
func NewQCalendar2(system System) *QCalendar {
	g := newQCalendar(QCalendar_new2(system))
	g.isSubclass = true
	return g
}
...
func NewQCalendar3(name QAnyStringView) *QCalendar {
	g := newQCalendar(QCalendar_new3(name.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQCalendar4(id SystemId) *QCalendar {
	g := newQCalendar(QCalendar_new4(id))
	g.isSubclass = true
	return g
}
...
func NewQCalendar__YearMonthDay() *QCalendar__YearMonthDay {
	g := newQCalendar__YearMonthDay(QCalendar__YearMonthDay_new())
	g.isSubclass = true
	return g
}
...
func NewQCalendar__YearMonthDay2(y int) *QCalendar__YearMonthDay {
	g := newQCalendar__YearMonthDay(QCalendar__YearMonthDay_new2((int)(y)))
	g.isSubclass = true
	return g
}
...
func NewQCalendar__YearMonthDay3(y int, m int) *QCalendar__YearMonthDay {
	g := newQCalendar__YearMonthDay(QCalendar__YearMonthDay_new3((int)(y), (int)(m)))
	g.isSubclass = true
	return g
}
...
func NewQCalendar__YearMonthDay4(y int, m int, d int) *QCalendar__YearMonthDay {
	g := newQCalendar__YearMonthDay(QCalendar__YearMonthDay_new4((int)(y), (int)(m), (int)(d)))
	g.isSubclass = true
	return g
}
...
func NewQCalendar__SystemId() *QCalendar__SystemId {
	g := newQCalendar__SystemId(QCalendar__SystemId_new())
	g.isSubclass = true
	return g
}
