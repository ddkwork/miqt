...
func NewQLabel(parent *QWidget) *QLabel {
	g := newQLabel(QLabel_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQLabel3(text string) *QLabel {
	...
	g := newQLabel(QLabel_new3(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQLabel4(parent *QWidget, f WindowType) *QLabel {
	g := newQLabel(QLabel_new4(parent.cPointer(), (int)(f)))
	g.isSubclass = true
	return g
}
...
func NewQLabel5(text string, parent *QWidget) *QLabel {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQLabel(QLabel_new5(text_ms, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQLabel6(text string, parent *QWidget, f WindowType) *QLabel {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQLabel(QLabel_new6(text_ms, parent.cPointer(), (int)(f)))
	g.isSubclass = true
	return g
}
