...
func NewQStackedLayout(parent *QWidget) *QStackedLayout {
	g := newQStackedLayout(QStackedLayout_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQStackedLayout2() *QStackedLayout {
	g := newQStackedLayout(QStackedLayout_new2())
	g.isSubclass = true
	return g
}
...
func NewQStackedLayout3(parentLayout *QLayout) *QStackedLayout {
	g := newQStackedLayout(QStackedLayout_new3(parentLayout.cPointer()))
	g.isSubclass = true
	return g
}
