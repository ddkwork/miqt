...
func NewQValidator() *QValidator {
	g := newQValidator(QValidator_new())
	g.isSubclass = true
	return g
}
...
func NewQValidator2(parent *QObject) *QValidator {
	g := newQValidator(QValidator_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQIntValidator() *QIntValidator {
	g := newQIntValidator(QIntValidator_new())
	g.isSubclass = true
	return g
}
...
func NewQIntValidator2(bottom int, top int) *QIntValidator {
	g := newQIntValidator(QIntValidator_new2((int)(bottom), (int)(top)))
	g.isSubclass = true
	return g
}
...
func NewQIntValidator3(parent *QObject) *QIntValidator {
	g := newQIntValidator(QIntValidator_new3(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQIntValidator4(bottom int, top int, parent *QObject) *QIntValidator {
	g := newQIntValidator(QIntValidator_new4((int)(bottom), (int)(top), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDoubleValidator() *QDoubleValidator {
	g := newQDoubleValidator(QDoubleValidator_new())
	g.isSubclass = true
	return g
}
...
func NewQDoubleValidator2(bottom float64, top float64, decimals int) *QDoubleValidator {
	g := newQDoubleValidator(QDoubleValidator_new2((double)(bottom), (double)(top), (int)(decimals)))
	g.isSubclass = true
	return g
}
...
func NewQDoubleValidator3(parent *QObject) *QDoubleValidator {
	g := newQDoubleValidator(QDoubleValidator_new3(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQDoubleValidator4(bottom float64, top float64, decimals int, parent *QObject) *QDoubleValidator {
	g := newQDoubleValidator(QDoubleValidator_new4((double)(bottom), (double)(top), (int)(decimals), parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionValidator() *QRegularExpressionValidator {
	g := newQRegularExpressionValidator(QRegularExpressionValidator_new())
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionValidator2(re *QRegularExpression) *QRegularExpressionValidator {
	g := newQRegularExpressionValidator(QRegularExpressionValidator_new2(re.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionValidator3(parent *QObject) *QRegularExpressionValidator {
	g := newQRegularExpressionValidator(QRegularExpressionValidator_new3(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQRegularExpressionValidator4(re *QRegularExpression, parent *QObject) *QRegularExpressionValidator {
	g := newQRegularExpressionValidator(QRegularExpressionValidator_new4(re.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
