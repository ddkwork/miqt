...
func NewQDirListing(path string) *QDirListing {
	...
	ret := newQDirListing(QDirListing_new(path_ms))
	ret.isSubclass = true
	return ret
}
...
func NewQDirListing2(path string, nameFilters []string) *QDirListing {
	...
	ret := newQDirListing(QDirListing_new2(path_ms, nameFilters_ma))
	ret.isSubclass = true
	return ret
}
...
func NewQDirListing3(path string, flags IteratorFlags) *QDirListing {
	...
	ret := newQDirListing(QDirListing_new3(path_ms, flags))
	ret.isSubclass = true
	return ret
}
...
func NewQDirListing4(path string, nameFilters []string, flags IteratorFlags) *QDirListing {
	...
	ret := newQDirListing(QDirListing_new4(path_ms, nameFilters_ma, flags))
	ret.isSubclass = true
	return ret
}
