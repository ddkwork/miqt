...
QMetaObject* callback_return_value = miqt_exec_callback_QTextBrowser_MetaObject(const_cast<MiqtVirtualQTextBrowser*>(this), handle__MetaObject);
...
void QTextBrowser_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQTextBrowser*>( (QTextBrowser*)(self) )->handle__MetaObject = slot;
}
...
void QTextBrowser_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQTextBrowser*>( (QTextBrowser*)(self) )->handle__Metacast = slot;
}
