...
func NewQAnyStringView() *QAnyStringView {
	g := newQAnyStringView(QAnyStringView_new())
	g.isSubclass = true
	return g
}
...
func NewQAnyStringView2(str []byte) *QAnyStringView {
	...
	g := newQAnyStringView(QAnyStringView_new2(str_alias))
	g.isSubclass = true
	return g
}
...
func NewQAnyStringView3(str string) *QAnyStringView {
	...
	g := newQAnyStringView(QAnyStringView_new3(str_ms))
	g.isSubclass = true
	return g
}
...
func NewQAnyStringView4(param1 *QAnyStringView) *QAnyStringView {
	g := newQAnyStringView(QAnyStringView_new4(param1.cPointer()))
	g.isSubclass = true
	return g
}
