...
func NewQGraphicsWidget() *QGraphicsWidget {
	g := newQGraphicsWidget(QGraphicsWidget_new())
	g.isSubclass = true
	return g
}
...
func NewQGraphicsWidget2(parent *QGraphicsItem) *QGraphicsWidget {
	g := newQGraphicsWidget(QGraphicsWidget_new2(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQGraphicsWidget3(parent *QGraphicsItem, wFlags WindowType) *QGraphicsWidget {
	g := newQGraphicsWidget(QGraphicsWidget_new3(parent.cPointer(), (int)(wFlags)))
	g.isSubclass = true
	return g
}
