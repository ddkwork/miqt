...
func NewQTransform(param1 Initialization) *QTransform {
	g := newQTransform(QTransform_new((int)(param1)))
	g.isSubclass = true
	return g
}
...
func NewQTransform2() *QTransform {
	g := newQTransform(QTransform_new2())
	g.isSubclass = true
	return g
}
...
func NewQTransform3(h11 float64, h12 float64, h13 float64, h21 float64, h22 float64, h23 float64, h31 float64, h32 float64, h33 float64) *QTransform {
	g := newQTransform(QTransform_new3((double)(h11), (double)(h12), (double)(h13), (double)(h21), (double)(h22), (double)(h23), (double)(h31), (double)(h32), (double)(h33)))
	g.isSubclass = true
	return g
}
...
func NewQTransform4(h11 float64, h12 float64, h21 float64, h22 float64, dx float64, dy float64) *QTransform {
	g := newQTransform(QTransform_new4((double)(h11), (double)(h12), (double)(h21), (double)(h22), (double)(dx), (double)(dy)))
	g.isSubclass = true
	return g
}
...
func NewQTransform5(other *QTransform) *QTransform {
	g := newQTransform(QTransform_new5(other.cPointer()))
	g.isSubclass = true
	return g
}
