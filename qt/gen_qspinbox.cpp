...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QSpinBox_MetaObject(const_cast<MiqtVirtualQSpinBox*>(this), handle__MetaObject);
...
void QSpinBox_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQSpinBox*>( (QSpinBox*)(self) )->handle__MetaObject = slot;
}
...
void QSpinBox_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQSpinBox*>( (QSpinBox*)(self) )->handle__Metacast = slot;
}
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QDoubleSpinBox_MetaObject(const_cast<MiqtVirtualQDoubleSpinBox*>(this), handle__MetaObject);
...
void QDoubleSpinBox_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQDoubleSpinBox*>( (QDoubleSpinBox*)(self) )->handle__MetaObject = slot;
}
...
void QDoubleSpinBox_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQDoubleSpinBox*>( (QDoubleSpinBox*)(self) )->handle__Metacast = slot;
}
