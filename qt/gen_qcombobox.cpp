...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QComboBox_MetaObject(const_cast<MiqtVirtualQComboBox*>(this), handle__MetaObject);
...
void QComboBox_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQComboBox*>( (QComboBox*)(self) )->handle__MetaObject = slot;
}
...
void QComboBox_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQComboBox*>( (QComboBox*)(self) )->handle__Metacast = slot;
}
