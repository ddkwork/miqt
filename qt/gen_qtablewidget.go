...
func NewQTableWidgetSelectionRange() *QTableWidgetSelectionRange {
	g := newQTableWidgetSelectionRange(QTableWidgetSelectionRange_new())
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetSelectionRange2(top int, left int, bottom int, right int) *QTableWidgetSelectionRange {
	g := newQTableWidgetSelectionRange(QTableWidgetSelectionRange_new2((int)(top), (int)(left), (int)(bottom), (int)(right)))
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem() *QTableWidgetItem {
	g := newQTableWidgetItem(QTableWidgetItem_new())
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem2(text string) *QTableWidgetItem {
	...
	g := newQTableWidgetItem(QTableWidgetItem_new2(text_ms))
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem3(icon *QIcon, text string) *QTableWidgetItem {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQTableWidgetItem(QTableWidgetItem_new3(icon.cPointer(), text_ms))
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem4(other *QTableWidgetItem) *QTableWidgetItem {
	g := newQTableWidgetItem(QTableWidgetItem_new4(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem5(typeVal int) *QTableWidgetItem {
	g := newQTableWidgetItem(QTableWidgetItem_new5((int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem6(text string, typeVal int) *QTableWidgetItem {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQTableWidgetItem(QTableWidgetItem_new6(text_ms, (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTableWidgetItem7(icon *QIcon, text string, typeVal int) *QTableWidgetItem {
	...
	text_ms.len = size_t(len(text))
	defer free(unsafe.Pointer(text_ms.data))
	g := newQTableWidgetItem(QTableWidgetItem_new7(icon.cPointer(), text_ms, (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTableWidget(parent *QWidget) *QTableWidget {
	g := newQTableWidget(QTableWidget_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTableWidget2() *QTableWidget {
	g := newQTableWidget(QTableWidget_new2())
	g.isSubclass = true
	return g
}
...
func NewQTableWidget3(rows int, columns int) *QTableWidget {
	g := newQTableWidget(QTableWidget_new3((int)(rows), (int)(columns)))
	g.isSubclass = true
	return g
}
...
func NewQTableWidget4(rows int, columns int, parent *QWidget) *QTableWidget {
	g := newQTableWidget(QTableWidget_new4((int)(rows), (int)(columns), parent.cPointer()))
	g.isSubclass = true
	return g
}
