...
func NewQKeySequenceEdit(parent *QWidget) *QKeySequenceEdit {
	g := newQKeySequenceEdit(QKeySequenceEdit_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeySequenceEdit2() *QKeySequenceEdit {
	g := newQKeySequenceEdit(QKeySequenceEdit_new2())
	g.isSubclass = true
	return g
}
...
func NewQKeySequenceEdit3(keySequence *QKeySequence) *QKeySequenceEdit {
	g := newQKeySequenceEdit(QKeySequenceEdit_new3(keySequence.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQKeySequenceEdit4(keySequence *QKeySequence, parent *QWidget) *QKeySequenceEdit {
	g := newQKeySequenceEdit(QKeySequenceEdit_new4(keySequence.cPointer(), parent.cPointer()))
	g.isSubclass = true
	return g
}
