...
func NewQTreeWidgetItem() *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new())
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem2(strings []string) *QTreeWidgetItem {
	...
	g := newQTreeWidgetItem(QTreeWidgetItem_new2(strings_ma))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem3(treeview *QTreeWidget) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new3(treeview.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem4(treeview *QTreeWidget, strings []string) *QTreeWidgetItem {
	...
	strings_ma := struct_miqt_array{len: size_t(len(strings)), data: unsafe.Pointer(strings_CArray)}
	g := newQTreeWidgetItem(QTreeWidgetItem_new4(treeview.cPointer(), strings_ma))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem5(treeview *QTreeWidget, after *QTreeWidgetItem) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new5(treeview.cPointer(), after.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem6(parent *QTreeWidgetItem) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new6(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem7(parent *QTreeWidgetItem, strings []string) *QTreeWidgetItem {
	...
	strings_ma := struct_miqt_array{len: size_t(len(strings)), data: unsafe.Pointer(strings_CArray)}
	g := newQTreeWidgetItem(QTreeWidgetItem_new7(parent.cPointer(), strings_ma))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem8(parent *QTreeWidgetItem, after *QTreeWidgetItem) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new8(parent.cPointer(), after.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem9(other *QTreeWidgetItem) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new9(other.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem10(typeVal int) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new10((int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem11(strings []string, typeVal int) *QTreeWidgetItem {
	...
	strings_ma := struct_miqt_array{len: size_t(len(strings)), data: unsafe.Pointer(strings_CArray)}
	g := newQTreeWidgetItem(QTreeWidgetItem_new11(strings_ma, (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem12(treeview *QTreeWidget, typeVal int) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new12(treeview.cPointer(), (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem13(treeview *QTreeWidget, strings []string, typeVal int) *QTreeWidgetItem {
	...
	strings_ma := struct_miqt_array{len: size_t(len(strings)), data: unsafe.Pointer(strings_CArray)}
	g := newQTreeWidgetItem(QTreeWidgetItem_new13(treeview.cPointer(), strings_ma, (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem14(treeview *QTreeWidget, after *QTreeWidgetItem, typeVal int) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new14(treeview.cPointer(), after.cPointer(), (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem15(parent *QTreeWidgetItem, typeVal int) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new15(parent.cPointer(), (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem16(parent *QTreeWidgetItem, strings []string, typeVal int) *QTreeWidgetItem {
	...
	strings_ma := struct_miqt_array{len: size_t(len(strings)), data: unsafe.Pointer(strings_CArray)}
	g := newQTreeWidgetItem(QTreeWidgetItem_new16(parent.cPointer(), strings_ma, (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidgetItem17(parent *QTreeWidgetItem, after *QTreeWidgetItem, typeVal int) *QTreeWidgetItem {
	g := newQTreeWidgetItem(QTreeWidgetItem_new17(parent.cPointer(), after.cPointer(), (int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidget(parent *QWidget) *QTreeWidget {
	g := newQTreeWidget(QTreeWidget_new(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTreeWidget2() *QTreeWidget {
	g := newQTreeWidget(QTreeWidget_new2())
	g.isSubclass = true
	return g
}
