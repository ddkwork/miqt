...
func NewQTextLength() *QTextLength {
	g := newQTextLength(QTextLength_new())
	g.isSubclass = true
	return g
}
...
func NewQTextLength2(typeVal Type, value float64) *QTextLength {
	g := newQTextLength(QTextLength_new2(typeVal, (double)(value)))
	g.isSubclass = true
	return g
}
...
func NewQTextLength3(param1 *QTextLength) *QTextLength {
	g := newQTextLength(QTextLength_new3(param1.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextFormat() *QTextFormat {
	g := newQTextFormat(QTextFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextFormat2(typeVal int) *QTextFormat {
	g := newQTextFormat(QTextFormat_new2((int)(typeVal)))
	g.isSubclass = true
	return g
}
...
func NewQTextFormat3(rhs *QTextFormat) *QTextFormat {
	g := newQTextFormat(QTextFormat_new3(rhs.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextCharFormat() *QTextCharFormat {
	g := newQTextCharFormat(QTextCharFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextBlockFormat() *QTextBlockFormat {
	g := newQTextBlockFormat(QTextBlockFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextListFormat() *QTextListFormat {
	g := newQTextListFormat(QTextListFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextImageFormat() *QTextImageFormat {
	g := newQTextImageFormat(QTextImageFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextFrameFormat() *QTextFrameFormat {
	g := newQTextFrameFormat(QTextFrameFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextTableFormat() *QTextTableFormat {
	g := newQTextTableFormat(QTextTableFormat_new())
	g.isSubclass = true
	return g
}
...
func NewQTextTableCellFormat() *QTextTableCellFormat {
	g := newQTextTableCellFormat(QTextTableCellFormat_new())
	g.isSubclass = true
	return g
}
