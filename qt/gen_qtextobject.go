...
func NewQTextFrame(doc *QTextDocument) *QTextFrame {
	g := newQTextFrame(QTextFrame_new(doc.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextBlock() *QTextBlock {
	g := newQTextBlock(QTextBlock_new())
	g.isSubclass = true
	return g
}
...
func NewQTextBlock2(o *QTextBlock) *QTextBlock {
	g := newQTextBlock(QTextBlock_new2(o.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextFragment() *QTextFragment {
	g := newQTextFragment(QTextFragment_new())
	g.isSubclass = true
	return g
}
...
func NewQTextFragment2(o *QTextFragment) *QTextFragment {
	g := newQTextFragment(QTextFragment_new2(o.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQTextFrame__iterator() *QTextFrame__iterator {
	g := newQTextFrame__iterator(QTextFrame__iterator_new())
	g.isSubclass = true
	return g
}
...
func NewQTextFrame__iterator2(param1 *iterator) *QTextFrame__iterator {
	g := newQTextFrame__iterator(QTextFrame__iterator_new2(param1))
	g.isSubclass = true
	return g
}
...
func NewQTextBlock__iterator() *QTextBlock__iterator {
	g := newQTextBlock__iterator(QTextBlock__iterator_new())
	g.isSubclass = true
	return g
}
...
func NewQTextBlock__iterator2(param1 *iterator) *QTextBlock__iterator {
	g := newQTextBlock__iterator(QTextBlock__iterator_new2(param1))
	g.isSubclass = true
	return g
}
