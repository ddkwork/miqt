...
g := newQImage(QImage_new2(size.cPointer(), format))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new3((int)(width), (int)(height), format))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new4((*uchar)(unsafe.Pointer(data)), (int)(width), (int)(height), format))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new5((*uchar)(unsafe.Pointer(data)), (int)(width), (int)(height), format))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new6((*uchar)(unsafe.Pointer(data)), (int)(width), (int)(height), (ptrdiff_t)(bytesPerLine), format))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new7((*uchar)(unsafe.Pointer(data)), (int)(width), (int)(height), (ptrdiff_t)(bytesPerLine), format))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new8(fileName_ms))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new9(param1.cPointer()))
				g.isSubclass = true
				return g
			}
...
g := newQImage(QImage_new10(fileName_ms, format_Cstring))
				g.isSubclass = true
				return g
			}
