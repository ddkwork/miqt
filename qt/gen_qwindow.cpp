...
QMetaObject* callback_return_value = miqt_exec_callback_QWindow_MetaObject(const_cast<MiqtVirtualQWindow*>(this), handle__MetaObject);
...
void QWindow_virtbase(QWindow* src
...
void QWindow_override_virtual_MetaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQWindow*>( (QWindow*)(self) )->handle__MetaObject = slot;
}
QMetaObject* QWindow_virtualbase_MetaObject(const void* self) {
	return ( (const MiqtVirtualQWindow*)(self) )->virtualbase_MetaObject();
}
void QWindow_override_virtual_Metacast(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQWindow*>( (QWindow*)(self) )->handle__Metacast = slot;
}
