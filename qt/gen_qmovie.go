...
func NewQMovie2(device *QIODevice) *QMovie {
	g := newQMovie(QMovie_new2(device.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMovie3(fileName string) *QMovie {
	...
	g := newQMovie(QMovie_new3(fileName_ms))
	g.isSubclass = true
	return g
}
...
func NewQMovie4(parent *QObject) *QMovie {
	g := newQMovie(QMovie_new4(parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMovie5(device *QIODevice, format []byte) *QMovie {
	...
	g := newQMovie(QMovie_new5(device.cPointer(), format_alias))
	g.isSubclass = true
	return g
}
...
func NewQMovie6(device *QIODevice, format []byte, parent *QObject) *QMovie {
	...
	format_alias.data = (char)(unsafe.Pointer(&format[0]))
	format_alias.len = size_t(len(format))
	g := newQMovie(QMovie_new6(device.cPointer(), format_alias, parent.cPointer()))
	g.isSubclass = true
	return g
}
...
func NewQMovie7(fileName string, format []byte) *QMovie {
	...
	format_alias.data = (char)(unsafe.Pointer(&format[0]))
	format_alias.len = size_t(len(format))
	g := newQMovie(QMovie_new7(fileName_ms, format_alias))
	g.isSubclass = true
	return g
}
...
func NewQMovie8(fileName string, format []byte, parent *QObject) *QMovie {
	...
	format_alias.data = (char)(unsafe.Pointer(&format[0]))
	format_alias.len = size_t(len(format))
	g := newQMovie(QMovie_new8(fileName_ms, format_alias, parent.cPointer()))
	g.isSubclass = true
	return g
}
