FROM stateoftheartio/qt6:6.8-android-aqt
...
RUN mkdir -p /opt/Qt/6.8.0/android_arm64_v8a/lib/pkgconfig/ && \
	cp /opt/Qt/6.8.0/gcc_64/lib/pkgconfig/*.pc /opt/Qt/6.8.0/android_arm64_v8a/lib/pkgconfig/ && \
	find /opt/Qt/6.8.0/android_arm64_v8a/lib/pkgconfig/ -type f -exec sed -i -re 's~gcc_64~android_arm64_v8a~' {} \; && \
	find /opt/Qt/6.8.0/android_arm64_v8a/lib/pkgconfig/ -type f -exec sed -i -re 's~-l(Q[^ ]+)~-l\1_arm64-v8a~' {} \;
...
ENV PKG_CONFIG_PATH=/opt/Qt/6.8.0/android_arm64_v8a/lib/pkgconfig
