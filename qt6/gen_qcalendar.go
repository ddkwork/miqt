...
type QCalendar__SystemId struct {
	h          *C.QCalendar__SystemId
	isSubclass bool
}

func (this *QCalendar__SystemId) cPointer() *C.QCalendar__SystemId {
	if this == nil {
		return nil
	}
	return this.h
...
func (this *QCalendar__SystemId) UnsafePointer() unsafe.Pointer {
	if this == nil {
		return nil
	}
	return unsafe.Pointer(this.h)
...
// newQCalendar__SystemId constructs the type using only CGO pointers.
func newQCalendar__SystemId(h *C.QCalendar__SystemId) *QCalendar__SystemId {
	if h == nil {
		return nil
	}
...
func (this *QCalendar__SystemId) Index() uint64 {
	return (uint64)(C.QCalendar__SystemId_Index(this.h))
}

func (this *QCalendar__SystemId) IsValid() bool {
	return (bool)(C.QCalendar__SystemId_IsValid(this.h))
}
...
// GoGC adds a Go Finalizer to this pointer, so that it will be deleted
// from C++ memory once it is unreachable from Go memory.
func (this *QCalendar__SystemId) GoGC() {
	runtime.SetFinalizer(this, func(this *QCalendar__SystemId) {
		this.Delete()
		runtime.KeepAlive(this.h)
	})
}
